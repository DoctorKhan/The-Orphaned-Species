...
**EARTH / HEAVEN / PANSPERMIA — LOCKED 2026-07-15:** Earth is an intentional planetary life-process expressed through geology, magnetism, water, atmosphere, biology, evolution, and the living web. Heaven is the energetic and informational influence of planets, stars, and ultimately extraterrestrial intelligences—the external life and technology that seed and pressure Earth. Panspermia is literal: life and life-technology arrive from beyond Earth and are received, adapted, and recombined by Earth's biology. Humanity is the bridge species; the Nephilot/elven line is an earlier or parallel bridge. The Tree of Knowledge and the Drift belong to this interaction. The intended resolution is technological intelligence that understands life-technology without exterminating fellow beings; agency still permits coexistence, domination, or extinction. **Earth as Tier 0 — rev. 2026-07-28:** Earth is formally its own agent in the cosmology, prior to and independent of the serpents (Tier 1) — the medium and ley-line network are Earth's own body, which the serpents exploit but never owned; Earth's long-run pressure (geomagnetic cycling, climate, evolution) reads through the same structural-self-correction logic as Koyaanisqatsi, not moral rescue or villainy. Full taxonomy: `00_MASTER_TIMELINE.md` § *Tier 0 — the Ground*. **Relation to ultimate thesis (2026-07-30):** Books I–IV treat Earth/Heaven as the real field of play. V–VI may reveal that this field, from the Player view, is itself training artifice — without erasing Earth's agency *inside* the training set or converting Tier 0 into a cartoon simulation gag in the civic volumes.

**DEEP-TIME IN THE NOVELS — LOCKED 2026-07-30:** The Master Timeline is larger than Books I–IV. Novels embody it through **residue density** (~one fossil every 1–2 chapters: object, place, practice, saying, bureaucratic form, bodily reaction) and one **ancient face** per volume — not Phase lectures. Full craft lock: `50_The_Orphaned_Species/17_reveal_order_and_reader_impact.md` § *Deep-time residue density*.
...
privacy, ceremony, and attestation. In Book III, Eli and Rowan fall in love
through wartime political work and acknowledge it while he holds command. They
do not have sex or formalize a household until his authority ends; a kiss may
follow the handover. In Book IV they consummate the existing love and decide
whether to try for a child. Rowan's independent desire for motherhood predates
Eli. She separately chooses him as co-parent and decides when to pursue
conception. Pregnancy, court pressure, the
...
and transfer Turning, toward established South American and Pacific nodes. Costa
...
routes open. These functions—not scenery—explain why the Turning survives the
...
Knotter but a novice at clandestine recovery, wants to treat arrival at the
next threshold as completion. Rowan answers with
...
The renewed Wren/Rowan romance is explicit, reciprocal, and negotiated. It begins through changed conduct rather than crisis-kissing: Wren follows Rowan's person-first limit; Rowan sees Wren accept the correction without turning it into a route that keeps the refusal manageable for everyone except the person who said it. Tenderness returns through ordinary acts, then an acknowledged kiss or night together chosen without emergency pressure. Wren discloses her developing bond with Eli before asking Rowan for renewed intimacy; Rowan sets terms and remains free to refuse. Eli and Rowan are not competing claimants, but Eli initially **feels rejected and deprioritized** when their old bodily fluency returns. His fear is not simply that Wren will have another lover; it is that he was provisional—a relationship formed while she was separated from the person who truly knew her. Wren does not cure this by ending or diminishing Rowan. She chooses Eli positively and specifically, naming and enacting what belongs uniquely to their bond and giving it consequential attention without declaring permanent rank. Eli learns that the bonds are not interchangeable: Wren/Rowan is a romance of formative recognition, shared Weaver grammar, recovered trust, and embodied history; Wren/Eli is a romance of present-tense discovery, emotional naming, grounding, and a future made deliberately together. Feeling specially chosen makes him secure enough not to experience Rowan's different intimacy as rejection. During Book III, Eli and Rowan fall in love through wartime work. They tell each other and Wren while Eli still commands, then refuse sexual or domestic access until his handover. Priority may change with circumstance, but no bond becomes a permanent hierarchy or grants authority over another. Rowan survives, keeps her own network and right to leave, and never becomes an accessory who blesses the “main” couple.
...
**PELANGI MODERNIZATION / CLIMATE / AI — LOCKED 2026-07-16; robotics scarcity LOCKED 2026-07-26:** A hereditary king and royal house control major island land through trusts, concessions, and development rights. The king wants Pelangi Reach to become a sovereign technology and climate-research hub capable of competing with Meridian City. Data centers, biotech, desalination, cooling, flood prediction, vertical farming, finance, and high-end housing arrive alongside seawalls, pumps, shade systems, and water rationing. **Humanoid robotics is pitched more than built** — Meridian and bloc capitals hoard what exists; Pelangi keeps **patched quadruped leftovers** from the failed megaproject (`23` § *Robotics lock*). Higher tides, saltwater intrusion, extreme heat, monsoon failure, storm surge, coral loss, fish migration, and routine evacuation shape ordinary life by the 2040s. The technology saves lives but consumes water, raises land values, displaces residents, and protects high-value districts first.
...
AI is embedded infrastructure rather than a single superintelligence. After the late-2020s AI overbuild and burst, expensive general models become regulated state/corporate systems while specialized models manage ports, weather, water, logistics, health triage, translation, education, surveillance, synthetic media, autonomous vehicles, and drones. **Embodied robotics — especially humanoid — did not scale:** war, supply-chain fracture, and the global baby bust left too little industrial workforce to build and maintain robot fleets; **planners had also mistaken embodied automation for software** — treating metal bodies as if they could proliferate without the continuous **entropy bill** death technology always pays (`22`, `23` § *Robotics lock*). Software automation substituted where bodies would have gone. Humanoid units concentrate in **Meridian City / the Stack** and other power centers as **status proof**. Pelangi institutions require human challenge and local accountability; Meridian uses AI to make people legible through risk scores, translation, medical classification, facial/gait recognition, crowd control, policing, supply allocation, and identity continuity. The conflict is not technology versus tradition but who owns the model, who may challenge it, and what knowledge it erases. A farmer's principle is: **the model is useful; it is not the rain.**
...
**Sex-differential acute mortality / Weaver female majority — LOCKED:** the same
real-world observation that men died from COVID at much higher rates is the
in-series explanation for the Weapon's acute phase killing men harder than
women: same respiratory-severity pathway, same male-skewed outcome. That
leaves more surviving women after Phase 1, which is one causal layer behind
the Weavers' female majority and the threshold-house networks that inherited
keeping. Do not make this a biology of female supremacy; it is a demographic
consequence of male-skewed mortality compounded by sorting, front posts,
and war losses. The result is cultural: women kept the corridors, records,
and care infrastructure; men were routed into expendable posts or discarded.
...
- **Costume (load-bearing):** Book I begins as a real Mandate loose-end hunt around
  Rasel; Charkha uses Mandate biosecurity paper, Stack-adjacent badges, Custodian
  cover, and white-coat procedure to conceal its parallel hunt for Maren. The
  father trail is true, which makes the mother-trail costume convincing. This is
  not a total false flag that erases Mandate guilt.
- **Book I (Eli's belief):** *they're after me because I'm Rasel's boy* (Mandate). He does **not** yet see a second leash. **Do not name Charkha on-page in Book I**.
- **Late Book I crack:** seams in the costume — *somebody else's leash*, wrong badge, *the other one* — without an apex name.
- **Book II knife:** apparatus **named Charkha** — **they wore the Mandate's face; they got your mother; you've been running their map.**
...
**Why the surface stays frictionless — LOCKED 2026-07-30.** Meridian's penalties for any legal infraction are severe and applied fast, not selectively theatrical — this, not exotic security, is why the Stack's soft procedure (palm/face terminals, clinical hospitality) can stay soft: almost nobody tests it twice. **Everything must be in order** — papers, credentials, sponsor lines, wage tickets — because the cost of anything being out of order is severe, which is why checkpoint scenes, Wren's paper-checking, and Eli's wage ticket carry real narrative weight rather than reading as bureaucratic texture. It also explains the near-total absence of ordinary theft or black-market culture around high-value secured state assets (see `59_younger_dryas_nucleation_lock.md` § *Why nobody has already stolen it*, re: the Cube's research annex): the legal route is closed to everyone, and the only way in is a genuine human-relationship exception — standing, trust, a network someone actually built — never a technical workaround.
...
**METROLOGY TEMPLES — ANCIENT MEASUREMENT COMMONS, LATER CO-OPTED — LOCKED 2026-08-09:** postwar civic accounting shifted from taxing raw energy to taxing **exergy destruction** and **algorithmic disorder**. The physical layer measures the useful work potential destroyed across a perimeter boundary — not total energy, which is conserved, but the ordered gradient that a system consumes and cannot restore. The information layer measures the change in **Kolmogorov complexity** ($\Delta K$) between inputs and outputs: the shortest possible program required to describe the state of a flow. Predictable, rhythmic waste compresses cheaply and costs little; turbulent, chemically erratic, thermally spiking waste is incompressible and expensive. These systems did not originate with any one bloc. They are fragments of an older **cross-bloc keeper and scientific lineage** that operated charged-ground measurement across teahouses, stone circles, ruin sites, and pilgrimage routes — long before the Turning, before the blocs, before the registry. The **Metrology Temples** are the institutions that now own, calibrate, and adjudicate the compression algorithms — but they inherited, not invented. The Mandate's Stack intake corridors, body registers, and proximity-tier systems are the most fully co-opted secular surface of this older civic ritual: precision stripped of consent, independent replication, and withdrawal rights. The teahouse pilgrimage network runs the reciprocal circuit closer to its original form: consent-bound measurement, territory-owns-the-map, the measurer answerable to the measured. The Free Ports run bootleg or hacked compression stacks that make chaotic repair yards, gray-market flows, and improvised harbors look mathematically “ordered” to their own sensors. The Continental Union turns the same measurement logic into quarantine and exclusion, classifying threshold onset as contagion rather than contact. The deeper conflict is therefore not which bloc invented measurement, but which bloc remembers that measurement is supposed to serve the measured — and which has made the measured serve the measure. Full craft: `50_teahouse_pilgrimage.md` § *Health and recovery measurements*; `22_life_technology_and_two_trees_spine.md` § *Rasel's information-theory thread*; `18_adventure_engine_and_scene_bank.md` § *Göbekli registry side / interpreter trench*; `charkha-craft-lock.md` § *Secret-Society Layer*.

**CHERRY LANE / THE CHERRY CUBE — LOCKED:** Meridian City has almost no ordinary trees, making **Cherry Lane** exceptional: a carefully managed ceremonial oasis of mature cherry trees, water, shade, and controlled but living gardens preserved from the city's earlier plan. The cherries are grafted, irrigated, monitored, pruned, and climate-managed for the humid Straits, with bloom cycles timed by the city's horticultural systems; they remain biologically alive, so disease, fruit, roots, and unscheduled change can still break through the management. Cherry Lane leads toward **the Cherry Cube**, a transparent glass consumer-technology temple and seat of concentrated commercial/state power where devices, upgrades, identity services, repairs, and network access are displayed as frictionless care. Residents call the route **the Lane** and the destination **the Cube**. Falling blossoms and root systems confront the Cube's promise of permanence and total control. **Book III payoff (proposed 2026-07-29):** the Cube quietly shelters a research annex holding a recovered fragment of the Younger Dryas craft — not referenced on-page before Book III. Full note: `59_younger_dryas_nucleation_lock.md` § *Book III payoff*. **One of three worldwide — LOCKED 2026-07-30:** the Cherry Cube's fragment is the "heaviest piece," not the only one — two more survive under bloc-cubes in the Continental Union (white, site open) and the Free Ports Coalition (blue, at Delphi), deliberately never reunited. Full framework: `50_The_Orphaned_Species/95_glossary.md` § *The Three Cubes*.

## 1. THE TIMELINE (hard canon)

> **Pacing note — LOCKED 2026-07-30.** The world is not peaceful in 2026 and does not need a fresh "war breaks out" trigger — it is already inside the early phase of what later gets *retroactively named* World War III, the same way historians still argue whether WWII began in 1931, 1937, or 1939 because it was recognized as one war only after regional conflicts merged. Year-pins below are for chapter-dating consistency, not new plot content.

- **~2001–2028:** "Neverending conflict" in the Middle East. The US is financially and politically exhausted by it. Elsewhere, already-simmering pressure: an unresolved Russia/Ukraine-adjacent border war, Taiwan Strait tension, and Red Sea/regional shipping disruptions all continue in parallel through this whole window — the "before" is already hot, not calm.
- **Late-2020s AI overbuild and burst:** The AI boom overbuilds and overpromises on cheap energy and rare-earth supply chains, financed through a closed loop of vendor deals: chipmakers invest in the labs that buy their chips, the labs lease capacity back from cloud providers who invested in the chipmakers, and the same dollars get counted as revenue at every stop without new cash ever entering the loop. When the oil shock lands, the loop has nothing to absorb it — the labs can't pay for capacity, the chipmakers can't collect, and the credit built on the arrangement locks up with it: banks stop extending each other credit, capital that used to chase real opportunity retreats into the safest instruments it can find, and the contraction never fully reverses. Paper wealth, jobs, and public confidence fail together with the physical economy. This is economic collapse, not AGI takeover.
- **~2027 — Depression (the collapse that precedes the election):** Triggered by the **Strait of Hormuz being blocked** and the resulting **oil embargo** (not vague "restriction") — itself an escalation of the already-running Middle East conflict, not a bolt from the blue — which bursts the overbuilt AI economy and collapses paper wealth, jobs, and public confidence together with the physical economy. It hollows the established order — not caused by any later program. **The insiders who see the embargo coming and dump ahead of the public are not a new class that Devolution creates — they are the same people who, a decade later, buy or earn a seat on the continuity roster** (`95_glossary.md` § *Insider trading and asset dumping*; § *State-directed capital*). The Party legalizes the pattern in 2033; it does not invent it.
...
- **~2029–2033 (that term):** Programs soften the rot but don't fix it; the parallel pressures (Middle East, Russia/Ukraine-adjacent border war, Taiwan Strait, shipping-lane disruption) keep escalating and interlinking rather than resolving.
- **~2033 — next term:** The **Continentalist Party of the Americas** rises out of continued desperation and **legitimately wins**. State-directed capital + digital ledger + party apparatus (the "China model," shown through specifics, never asserted as a label). The ledger is sold as the fix for the credit network that seized in 2027 and never came back — trust replaced by enforcement, not repaired.
- **Mid-2030s (~2034–2035):** The Middle East war escalates to **World War III** — recognized in hindsight as the point the already-running regional conflicts (Middle East, Russia/Ukraine-adjacent, Taiwan Strait) formally merged into one global war, not a single new outbreak.
- **~2035–2037 — WWIII acute phase:** Cornered nations released the Fever (see §2). **Former Russia**, already strained by decades of border war and now caught in the widening conflict, collapses internally under combined conventional warfare and the Fever Years pandemic — **not nuclear exchange** (§1b; `99_open_questions.md` § *nuclear restraint* — the same no-clean-attribution logic that keeps the present-day psion war non-nuclear applies retroactively to WWIII itself, one consistent rule for the whole timeline, not two different ones). Its Arctic coast survives as fragmented remnant territory (§1a-iii).
- **~2037 — Armed-reopening partition (LOCKED):** after WWIII's single hottest phase, unstable armistices and fragmented ceasefires harden into **three blocs** (see §1a). There is no comprehensive peace: proxy fighting, blockades, drone attacks, maritime seizures, and deniable operations continue. Street shortenings: *the Union*, *the Mandate*, *the Coalition* / *the Ports*.
- **The Turning (~2037–2040) — LOCKED 2026-07-24:** civilizational turn — WWIII acute + **Fever Years** outbreak + armistice + puberty **Threshold** + **inverted order** (house men / Thread men / **Extras**) + Weavers' **Weaving-in** + **scientist claiming** (post-armistice cold war: all scientists ledgered/assigned by bloc). The first pre-puberty-infected cohort reaching adolescence on roughly the same biological clock is what compresses a generation's worth of social reorganization into this narrow window — a forced, not organic, timeline. Street: *after the Turning*, *the Fever Years*, *the Threshold*, *claimed*. Glossary: `95`; `40_concepts.md` § the Turning.
...
- **~2040+ — present:** Uneven, scarred, functioning — reopening harbors, the Boreal Route maturing as background pressure (§1a-iii). **The recovery is K-shaped on purpose, not by accident:** ports, bulk freight, desal, cement, ship repair, and selected plants rebuild at the fast pace of postwar Japan/West Germany — real quay capacity, real headline growth. The mid-stream stack that prints new controllers, magnets, leading-edge silicon, and throwaway airframes does not follow that curve (`50_The_Orphaned_Species/65_replacement_seizure.md`). Ordinary economic mobility stays flatter still; for anyone off the continuity roster it reads more like Japan's own lost decades — flat wages, deferred milestones, safety hoarded over risk — because the credit trust that broke in 2027 was replaced by enforcement, not repaired. Kitchens run. Spare-parts drawers do not refill.
...
|---|---|---|---|
| **Americas** | **The Continental Union** | Continentalist Party of the Americas — state-directed capital, digital ledger, party apparatus, carrier registry. Legitimately won power after the depression; holds the continent together through the war and after. **Book III fracture diagnosis — LOCKED 2026-07-31:** already an **anocracy** (hybrid: civic/electoral costume + Continuity authoritarian capacity); Mandate shock hits the dangerous middle — see `33` § *Anocracy / Union fracture*; `90` § *Anocracy*. | *the Union*, *Continental* |
...
| **Third pole** | **The Free Ports Coalition** | Reopened harbors, special economic zones, and remnant states that fit under neither giant — Strait ports, SE Asian gray zones, **Pacific and Caribbean archipelagos**, uneven European remnants. Improvised quarantine, bribes, forged papers, accountable refuges like Pelangi Reach. **Islands join because they require harbors** — no self-sufficient palace economy at sea. | *the Coalition*, *the Ports* |
...
- **Island archipelagos — LOCKED 2026-07-25:** harbor-dependent islands and island chains **join the Coalition** after the Turning — not Union registry blocs, not Mandate corridors. Many follow the same logic (Pacific, Caribbean, Mediterranean remnants). **Hawaiʻi** acceded to the Coalition but remains **contested** (see §1a-i). An island without a port is vulnerable; an island with a port needs gray law, trade lanes, and threshold-house culture more than continental centralization.
...
### 1a-i. Hawaiʻi — contested Coalition member *(LOCKED 2026-07-25)*

- **Breakaway, then accession — jurisdiction disputed.** During WWIII armistice chaos the island governments slipped Continental Union control; the Union never re-established its registry or party apparatus on the archipelago. **By 2040 Hawaiʻi functions as a Free Ports Coalition member** — Coalition port law, gray trade, threshold-house networks, Native Hawaiian-led stewardship at Pearl Harbor. **But sovereignty is contested**, not settled.
- **Who contests it:**
  - **Continental Union** — legacy maps, registry claims, periodic checkpoint disputes, propaganda (*the Breakaway*); offers **military basing** in Book III (refused on-page).
  - **Eastern Mandate** — Pacific patrols, biosecurity pretext, corridor leverage; wants port access without owning the archipelago.
  - **Local stewardship** — Coalition membership as **practical harbor necessity**, not submission to any continental center.
- **Why islands join the Coalition:** archipelagos **require harbors** — food, fuel, medicine, repair, and people move by sea. Coalition port law beats continental registry depth; contest means **every arrival is negotiable**, not that Hawaiʻi is Union territory.
- **Spine locks:**
  - Vol III **Big Island refuge** = stewardship **invites the network to use, not own** — hosts coordination/refuge, **never capital or HQ**, **refuses militarization** while war pressure mounts.
  - Eli can stand on Coalition-recognized soil; his papers may still trigger Union dispute at a bad checkpoint.
  - Pelangi Reach and Hawaiʻi = **connected maritime refuges** in the same bloc — both **tolerated/contested**, not serene.

### SOCIETIES, LINEAGES, AND COVERT NETWORKS BEYOND THE FACTIONS — LOCKED 2026-08-10

The world’s real structure is not three blocs. The blocs are the visible surface. Beneath and across them operate ancient keeper lineages, covert teams, measurement commons, and kinship orders that predate the Turning, outlasted earlier empires, and survived the Fever Years without owning territory. The index below classifies every group that has appeared or been referenced in canon as of this lock. On-page, characters discover these networks one contact at a time; the reader assembles the full map gradually. **Never lecture the full taxonomy at once.**

### 1. State blocs and their institutions
Visible, sovereign-level. Listed here only because every secret network runs against or inside them.

- **Continental Union** — Devolution, FCD-1, COGCON/Reserve, containment wards, Fractured program, Heather Cube, Haoma, registry.
- **Eastern Mandate** — Metrology Temples (inherited), Stack/Stack intake corridors, Cherry Cube, proximity tiers, Custodian biosecurity, Commissioner Ma’s industrial offer.
- **Free Ports Coalition** — threshold houses, keeper chain, Delphi/Laurel Cube, gray ports, Albion, Pacific/Caribbean archipelagos.

### 2. Ancient cross-bloc keeper and measurement lineages
Hidden, pre-Turning, cross all three blocs. These are the societies the user means by “secret societies beyond the factions.” They are not factions themselves — they are the infrastructure factions fight over.
...
- **European stone-circle keepers** — Pömmelte → Rollright → Men-an-Tol → Stonehenge line. Talking stones, utterance stones, dark-line custom.
- **Babaji’s keeper cell** — Pelangi Reach refuge, triggered the Mandate squeeze. Rasel’s friend; gave Eli work, not wallet.
- **Thai cooperative / stilt-house keepers** — Sanxingdui-pointing measurements, keeper song, seasonal practice.
- **Pelangi Reach “mafia”** — local guardian crew, not criminal; Babaji’s chosen-kin household turned underground cell after the squeeze.
...
### 4. Gender-order and kinship structures
...
- **Flights** — Book V seasonal traveling groups among young practitioners.
...
- **Dragons / dragon-remnant** — native Earth marine reptilian lineage. Competing cosmology: a minority reading holds they are domesticated theropods shaped by a crashed crew that stayed and hybridized with local stock; in that gloss they retain cryostasis-capable eggs, voltage/fire discharge, and telepathic/empathic projection via the anti-entropic medium. The Silurians are a separate species from the Tier-1 serpents and from the later Anunnaki/gods; they are not divine and do not mix with the god-lineages. Another minority reading reframes the dragon line as a two-stage creation: Tiamat created Leviathan first as an amphibious prototype, then dragons as the perfected terrestrial form; Leviathan lived in shallow seas and coastal swamps, retaining pressure tolerance, electrocyte discharge, and cryostasis-capable eggs. A further minority reading holds that Silurians specialized in engineering biological machines because reproduction is cheaper than fabrication: the Silurian contribution was self-replicating biological machinery—cryostasis-capable eggs, voltage/fire organs, telepathic/empathic projection—built so the lineage would reproduce rather than require new construction. All three are competing cosmologies only; canonical read remains Earth-native Abzu refinement.

---

**On-page rule:** reveal these networks through the doors Eli walks through, the hands that help him, the papers Wren checks, the cords Rowan ties, the songs Somchai knows. The full taxonomy is an author map, not a character speech.


- **Formal bloc:** **Free Ports Coalition — European remnant sector.** **Not** Continental Union (Americas only). **Not** Eastern Mandate territory. The **British Isles successor state is called Albion** — official name, street name, passport polity. **Britain / British** = **legacy only** (pre-Turning maps, Anglo registry habit, old extraction files, Mandate/Union documents that never updated).
- **Name logic — LOCKED 2026-07-25 (rev.):** the **monarchy did not survive** the Turning — no crown, no regency with live authority after WWIII settlement chaos. Successor councils and keeper networks **reclaimed the old Celtic name Albion** (what Greek and Roman sources called the island) instead of **Britain**, the crown name. Civic renaming, not mysticism — though it rhymes with the deeper keeper chain: **Alba** (the people) → **Albion** (refuge, then polity) → *elf* (folklore compression). Present 2040: **Albion** = country and charged-ground terrain (Rollright, Men-an-Tol, Anglesey, Stonehenge, Avebury); Book II climax is **inside the polity**, contested and instrumented (`England ambush`, psion teams at the boundary).
- **On-page reveal — LOCKED:** Book II **Ch 7** — conversation at first Albion checkpoint/intake: Eli says *Britain* or *British* from habit (mother's legacy files). **Rowan** or a local clerk answers plain: no monarchy anymore; they took the **old name** back. The deeper Alba/elf rhyme (Rollright keeper) lands in the same chapter.
- **Passports:** **Albion passport** on current paperwork (**Maren Holt**, Eli **Holt**). Extraction-era and Anglo corridor files may still read **British** — same Rasel/**Russell** register: wrong-era label, not a second country.
- **Collapse strategy (author):** fourth Bronze Age survival mode — **inland keeper antifragility** (non-palace communities that outlast burn layers by memory, ritual, distributed skill). Malacca/Pelangi = **maritime Phoenician** register; Albion = **inland keeper** register. Same Coalition, different grammar.
- **Charkha overlay:** Albion institutions (health, immigration, academia, museums) are **Charkha-penetrated**. **Albion / legacy British passport → Charkha claiming chain** (Maren lock). Mei: *not the Mandate's chain, the other one.*
- **Threshold model:** Coalition **threshold houses** and keeper networks — **not** Union containment wards. Western Europe ~16% acute die-off; puberty cohort managed harbor-to-harbor and house-to-house.
- **On-page:** narration and living speech say **Albion**; **British** only when a **file, clerk, or old mouth** gets the era wrong. Book II: Eli learns **Holt** as matrilineal Alba custom; the **ground** converges before he understands the tether.

### 1a-iii. The Arctic remnant coast / the Boreal Route — Coalition northern sector *(LOCKED 2026-07-30)*

- **Former Russia does not survive as a unified state.** Its interior is devastated by WWIII's hottest phase and the Fever Years outbreak — no Kremlin-equivalent, no registry bloc, no continental center. What remains functionally relevant is its **Arctic coast**, newly valuable as the ice recedes. **Not Eastern Mandate** (Mandate is East-Asian-aligned by definition, §1a) and **not Continental Union** (Americas only). Its scattered port cities and icebreaker/route-control assets join the **Free Ports Coalition** the same way Hawaiʻi and Albion did — gray-zone remnant authorities, not a unified power, run harbor-to-harbor rather than from one capital.
- **The Boreal Route** — street/official name for the thawing northern shipping corridor, functioning by 2040 much as the real-world Northern Sea Route began functioning in the mid-2020s: a genuine, growing alternative to the southern Suez/Malacca passage, still short-season, still insurance-expensive, still nobody's settled highway, but bending the trend line the way it did in reality.
- **Eastern Mandate's real motive:** heavy investment and diplomatic pressure for Boreal Route access — not conquest, a hedge. A bloc whose economy runs through Malacca knows exactly what "a chokepoint a hostile navy could close in an afternoon" means, and wants a second door. This is the Mandate's own legible self-interest, not a new faction.
- **Continental Union's stake:** a brittle, underfunded Arctic claim via Alaska — present, contested, "waking up under-equipped," consistent with the Union's already-locked hollow-tree brittleness (`23_2040_present_frame.md` § *Continental Union*).
- **Craft function — the control case:** this is the *ordinary* geopolitical story, fully explained by trade economics, sitting right next to Malacca's extraordinary one. The Boreal Route's rise is exactly what it looks like — no hidden layer. That contrast is what makes it worth having on-page at all: a reader who clocks the real-world trend has an earned, unstated reason to wonder why Malacca is still contested this fiercely when its conventional logic should be declining (`59_younger_dryas_nucleation_lock.md` § *Two corridors, one hidden*).
- **On-page weight:** background pressure only — news-crawl texture, checkpoint chatter, a shipping-manifest detail — never a set-piece location and never explained as a scheme. Nobody in-world treats it as sudden; it's the same slow-trend, nobody-notices-living-through-it quality the real transition has.
...
- **Modern Psion War:** a covert theater nested inside the world war after states confirm psionic signatures. National programs, the Charkha, contracted teams such as the Custodians, independents, mercenaries, and liberation cells fight over carriers, charged grounds, records, and amplifier access.
...
- **The Fever imitates and destabilizes an existing gate.** Research into natural carriers helps its designers identify regulatory pathways that can lower the receiver threshold across a much larger population. It does not manufacture the non-local field, souls, or psionic potential.
- **Two routes now coexist:** natural carriers can awaken without the Fever; Fever-bearers can be forced toward partial, unstable, or later full access. Neither route guarantees ability, wisdom, stability, or survival.
- **Eli's gift is not outbreak-made.** He was born around 2018, inherited natural carrier biology through Maren, and experienced pre-outbreak adolescent threshold symptoms. The later outbreak changes the world around him and may aggravate or expose his signature; it is not his origin. His Fever scar creates no power.
...
- **Eli's transit to Pelangi Reach (Routes B + C, locked).** Born around 2018, long before the acute outbreak. After extraction **passport-split** capture, **keeper foster parents** raise him on the **worker track** — Bangla/culture maintained; **visuo-spatial talent hidden** under capacity claiming. Ch 1: learns both taken alive; **recovers father Book I, finds and releases mother Book II.** Stateless through regional carrier network → port gray-economy → **Babaji** → Pelangi **Foundry facilities** (platform wage). Outbreak refuge becomes adult life, not birthplace.
- **Eli and the acute payload:** he survives the outbreak-era crisis; exact infection status need not be stated on-page. Whatever exposure occurred, it did not give him his capacity. His ancestry does not make survival automatic because the Fever sorts haplotypes statistically, not by identity.
- This haplotype affects **disease severity / expression**, NOT initial infection — keep wording honest.
- **The leak (plot device):** frequency is never 100%/0%. Even in Bangladesh ~half survived; in the US admixture scatters the marker. The sparing is **statistical, not clean** — Fever mis-sorts the population. The Continentalist Party governs a mis-sorted America.

### Phase 2 — Latent / Heritable
- The Fever integrates into many survivors as a provirus, lies quiet or partially expressed, and can pass to offspring when it lands in germline cells.
- It **lowers or disrupts access to receiver biology already latent in humanity**. It does not create the receiver or the field.
- **Puberty is the strongest gate** (see §3), especially for children infected before adolescents and later provirus-bearing descendants. Adult activation is possible under illness, stress, charged-ground exposure, or deliberate induction, but is less predictable (real floor: Hsp90 as an "evolutionary capacitor" that buffers cryptic variation until stress overwhelms it — Rutherford & Lindquist 1998; see `90` §5E).
...
- the Fever sits behind a **synthetic promoter carrying BOTH estrogen-response and androgen-response elements**, so it triggers in girls and boys alike.
...
- The trigger timing, DMT trip, and DMT flood are **science-anchored speculation**. The **actual awakened abilities are fiction** — the species' "dark matter," rarely accessible through natural carriers before the Fever and forced into mass expression afterward.
- **the Fever is a near-future forced door to the cosmic layer** — see §9. Natural carriers had opened that door before the weapon; the Fever makes access widespread, unstable, and politically visible. What either route tunes into (the field / Grid / the dead) is the deep mythos of `00_MASTER_TIMELINE.md` and `39_psion_biology.md`.
...
- Germline-integrating Fever payload — Burt/Esvelt/National Academies cited as background; **human deployment hypothetical**.
...
- Borjigin et al., _PNAS_ 2013 + Timmermann et al., _Frontiers in Psychology_ 2018 — dying-brain gamma surge and DMT/near-death-experience phenomenological overlap; real floor for the Malacca breach and its rhyme with the puberty DMT trips (`90` §5D).
- Rutherford & Lindquist, _Nature_ 1998 — Hsp90 as an evolutionary capacitor; real floor for adult (non-puberty) activation under stress (`90` §5E).
- Huerta-Sánchez et al., _Nature_ 2014 — Denisovan-introgressed EPAS1, real hybrid-inheritance altitude adaptation in Tibetans; optional floor for Nephilot/High-Place hybrid-trait material (`90` §5F).
- A. D. Craig, _Nature Reviews Neuroscience_ 2009 — interoception model; real floor for Eli's somatic-reading ability, "reception and diagnostic reading, not healing" (`90_book_i_research_notes.md` Ch 1).
- Endogenous retroviruses / syncytin genes — fossil retroviral DNA domesticated into placental biology; optional, lower-priority precedent that a germline-integrating construct can become generative rather than only parasitic (`90` §5G).
