...
**THE RECLAMATION — DISTRICT LOCKED 2026-07-16:** Pelangi Reach contains a salvaged/created land district called **the Reclamation**, built from a failed development project on reclaimed coast. The Reclamation carries the former Forest City functions: Forest Foundry, data and repair facilities, worker housing, refugee intake, experimental infrastructure, gardens, harbor logistics, and the fragile refuge Eli calls home. It is not the whole island. Old Pelangi contains villages, water systems, temples, farms, fishing communities, and craft districts; the Royal Tech Corridor contains newer campuses and high-end development; the outer coast carries storm barriers, fishing settlements, floating infrastructure, and the greatest climate exposure. The old island is asked to preserve the new land while the new land is asked to justify changing the old island.
...
**MERIDIAN CITY — CITY SETTING LOCKED 2026-07-16:** Meridian City is the Eastern Mandate's high-surveillance Straits city, a modern Tower of Babel in reverse: many languages and communities are translated into standardized records, risk codes, and interoperable systems without being truly understood. Its official identity is Meridian City; residents often call the vertical city **the Stack**. It contains real competence, safety, food, beauty, and multilingual life; its danger is translation without relationship, where every person becomes legible to the system before being known by another person.

**BENGALI WORKER NETWORK — LOCKED:** Meridian City is not navigable to outsiders by map alone. Its maintenance levels, construction shafts, food routes, service lifts, ferry schedules, cooling tunnels, and informal checkpoints are understood through a distributed Bengali worker network: construction crews, cleaners, cooks, nurses, mechanics, porters, drivers, and dock workers from varied regions, classes, dialects, generations, religions, and political positions. Eli's Bengali lets him enter conversations and recognize the network's signals, but no one person knows the whole maze and no one helps without exposure, lost wages, or danger. Across the Meridian sequence, workers provide partial routes, shelter, warnings, tools, and corrections; they are characters with their own loyalties, not an omniscient ethnic guide or plot device.
...
**Geography rules:**
- **Pelangi Reach** (Johor, Malaysia) sits in **Coalition gray space** — outside Continental Union jurisdiction and not Mandate territory. It is formally Coalition gray space, economically dependent on Mandate-linked Meridian City, and politically tolerated until the staged attack. Its half-built resort/special-economic-zone shell becomes a functioning tech-and-refuge hub.
- **Melaka** = Coalition port city under uneven reopening; Mandate and Union patrols both press the strait.
...
- **Eli's transit to Pelangi Reach (Routes B + C, locked).** Born around 2018, long before the acute outbreak. After the attack kills Arif and removes Maren, he is raised **stateless** through the regional carrier network. His natural adolescent threshold is incomplete and pre-outbreak; later he drifts through the port gray-economy until **Babaji** places him at **Pelangi Reach**: facilities work at the **Forest Foundry (the Foundry)** compound, platform wage, no inheritance. The outbreak refuge becomes part of his adult life, not his birthplace or psionic origin.
...
- Frame voice: compressed, omniscient historical blurb. **Consistent past tense** throughout ("These were their stories," not "are/their").
- "we/our" collective is allowed but must stay past-tense.
...
- **Layer map (near-future → cosmic):**
  ...
  - **Pelangi Reach itself = a carrier refuge** established by an eccentric keeper ("Babaji," the old man on the island — distinct from the real-world "Balaji" network-state figure the registries hunt; the name-collision is deliberate cover); its guardians (the "mafia" Eli meets) form a local underground cell. **Arif Rahman was Babaji's friend** — gardener who helped plant the island; when the net broke he asked Babaji to find Eli **work, not money**. Eli's cover against the Continentalist Party registry is **Arif's boy on a wage ticket**, not a mistaken heir — see MS antique-car / tea scene (interstitial before Ch Two).
  ...
  - **Journey spine (locked stops):** Pelangi Reach (refuge, Babaji's cell) → blocked northward corridor → Meridian City (Mandate-linked transit, atomized processing, archive) → north by sea through the Straits → Melaka (chandlery door, the witness, Maren's packet, the sevenfold surge) → Pai, N. Thailand (jungle lodge run by **Khun Dang**, ex-biker-gang founder; teaches Eli *Hotel California* on guitar as a cover/discipline beat — playing quiet hides a loud receiver) → north toward the old grid / the seven charged grounds. Each stop is a refuge cell; the guitar is a carry-forward motif.
