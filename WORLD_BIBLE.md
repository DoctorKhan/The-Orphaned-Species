...
> **SERIES IS FOUR VOLUMES — see `SERIES_STRUCTURE.md` at the repo root.** A same-day 2026-07-29 experiment briefly split Book I and renumbered later volumes; that split was reversed. Book I is again the full 13-chapter Breach→Thailand→Sanxingdui volume. Book II = Descent; Book III = Living World; Book IV = Court of Threads.
