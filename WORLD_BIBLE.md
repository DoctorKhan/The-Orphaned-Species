...
> **SERIES IS NOW FIVE VOLUMES — see `SERIES_STRUCTURE.md` at the repo root before trusting any volume/book number below.** Restructured 2026-07-29: the old 13-chapter Book I split into Book I (Ch 1–3) and a new Book II (Ch 1–10, ex-Ch 4–13). Every volume after that shifted up one (old II→III, old III→IV, old IV→V). This file has not been fully converted to the new numbers yet — translate any "Book II/III/IV" reference below using the map in `SERIES_STRUCTURE.md` rather than assuming it's stale or wrong.
...
**FIVE-VOLUME ENDGAME / BOOK V COURT — updated 2026-07-29 (renumbered; originally locked 2026-07-28 as four volumes, see `SERIES_STRUCTURE.md`):** The series is
now a five-volume arc. Book IV ends after Eli has accepted and exercised bounded
...
Book V is a women-led court-intrigue volume, principally through Rowan and Wren.
Its power grammar is access, placement, messages, household recognition, medical
privacy, ceremony, and attestation. Book IV plants only deniable Rowan/Eli
attraction inside political trust; they have no sex and no romance in that
volume. In Book V they consciously recognize attraction and have consensual sex
...
Book V. During Rowan's labor, Eli activates the prepared transfer; the Weavers
