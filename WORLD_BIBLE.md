...
- **Island archipelagos — LOCKED 2026-07-25:** harbor-dependent islands and island chains **join the Coalition** after the Hinge — not Union registry blocs, not Mandate corridors. Many follow the same logic (Pacific, Caribbean, Mediterranean remnants). **Hawaiʻi** acceded to the Coalition but remains **contested** (see §1a-i). An island without a port is vulnerable; an island with a port needs gray law, trade lanes, and threshold-house culture more than continental centralization.
...
The world’s real structure is not three blocs. The blocs are the visible surface. Beneath and across them operate ancient keeper lineages, covert teams, measurement commons, and kinship orders that predate the Hinge, outlasted earlier empires, and survived the Fever Years without owning territory. The index below classifies every group that has appeared or been referenced in canon as of this lock. On-page, characters discover these networks one contact at a time; the reader assembles the full map gradually. **Never lecture the full taxonomy at once.**
...
Hidden, pre-Hinge, cross all three blocs. These are the societies the user means by “secret societies beyond the factions.” They are not factions themselves — they are the infrastructure factions fight over.
