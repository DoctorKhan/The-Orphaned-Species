...
- **Isolation + caretaker structure emerges from the mechanism:** kids must be hidden and kept through the episode window; someone must feed them, protect them, prevent them wandering into a checkpoint mid-vision. "Those who take care of them" = a known role (witness / keeper). The PPA registry WANTS to observe episodes to catalog abilities → hiding a kid through their trips is resistance. (Maps onto MS: health workers "watching for activation.")
