...
- **On-page reveal — LOCKED:** Book II **Ch 5** — conversation at first Albion checkpoint/intake: Eli says *Britain* or *British* from habit (mother's legacy files). **Rowan** or a local clerk answers plain: no monarchy anymore; they took the **old name** back. One exchange; deeper Alba/elf rhyme lands **Ch 6** (Rollright keeper), not here.
