> **Promoted from repo legacy mirror — 2026-07-29.** Alternate opening from thin repo `40_`. Books actives in `src/10_part/` remain governing; merge useful sections by hand.
