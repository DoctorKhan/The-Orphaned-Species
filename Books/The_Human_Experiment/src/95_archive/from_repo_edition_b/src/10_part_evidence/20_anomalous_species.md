> **Archived from repo edition B — 2026-07-29.** Quarries only; not in Books active TOC. Complements / may overlap promoted chapters.
...
Within this functional mythology, the *Homo heidelbergensis* lineage was the chosen vessel for intervention. The science-facing anchor is a proposed severe bottleneck roughly **930,000 to 813,000 years ago**, inferred from genomic modeling, that may have reduced the ancestral breeding population to about **1,280 individuals** for more than 100,000 years. The cautious reading is climate stress, fragmentation, and refuge survival during the Early-to-Middle Pleistocene transition. The mythological reading is sharper: a natural-looking crisis became the perfect crucible for genetic engineering.
...
Our most ancient myths whisper of this moment: a god's blood mixed with clay to create the *Adamu*; a divine intelligence gifted into mortal matter; **Prometheus** stealing fire so the vulnerable line could endure the cold. Within this mythology, these are not mere allegories but fragmented memories of a layered procedure: the preparation of a seed population, the survival gift carried by the dissenter, and the later strategic merger with a native lineage to create a viable, hybrid species.

The archaeological imagination should stay terrestrial here. The refuges are not alien rooms but hard Earth: riverbanks, highlands, caves, mud, handaxes, butchered animals, hunger, children underfoot, and the first hearths carrying the signature of Prometheus / Enki rather than the control faction.
...
This was an evolutionary gamble on a massive scale. The seven pairs were distributed across different geographical regions and environmental conditions, creating parallel experiments in human development. All of these were the *Adamu*, the imported drone-prototype. But only one line would prove successful in the long run—the lineage that, crossbred with Earth's wild stock and switched on at the Activation, would survive the bottlenecks, catastrophes, and genetic challenges to become the *Lullu*: our own.
