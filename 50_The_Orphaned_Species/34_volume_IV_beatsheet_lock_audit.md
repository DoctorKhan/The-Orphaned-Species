...
| Birth simultaneity with transfer (birth at 17:06; transfer at 16:43) | Locked | Partial / check |  |
| Tara born without title (Ch 10) | Locked | Partial / check |  |
| Teahouse/garden coda (Ch 10 closing) | Locked | Partial / check |  |
| Swifts morning rhyme (Ch 10 closing) | Locked | Partial / check |  |

## Chapter-card status

| Chapter | Beatsheet card | Manuscript prose | Status |
|---|---|---|---|
| Chapter One—The Doors | Present | Present | Consistent |
| Chapter Two—Present Consent | Present | Present | Consistent |
...
1. Costa Rican place names (`Nosara–Sámara` / `Tenorio–Miravalles`) locked in architecture but may not yet be drafted into prose.
2. Hawaiʻi/Pele and Brazilian municipality research consultations still required before final prose.
