...
> **Status — HARVESTED SOURCE, no longer a standalone book.** This was the original standalone Aedan-cave novel outline. It is **not** a competing fourth book and is **not** drafted in this shape. It now serves as the **deep-past scene-detail bible** that feeds the trilogy.
>
> **Delivery mechanism — REPLACED. See `36_the_living_web.md` (the locked mechanism).** The old "memory capsules / two registers / through-Aedan nesting" framing is **deprecated and removed** (`36_memory_capsules.md` deleted). Under the current model there is **one living web**; Eli **clarifies** regions of it, and what he clarifies he learns. The scene detail below is fully retained — only its framing changes:
> - **The historical practitioners** (Aru, Daskar, Ila, Tem, Anthea, Cuno, Lovernios) are deep human **threads that resolve into people** when Eli clarifies them — *not* lives he becomes, not a numbered roster, not his past selves. A descent is a thread clarified to full resolution (the visceral immersion is retained).
> - **The cosmology** (Seven Pairs, Activation, Living Gods, War in Heaven, Adapa) is **deep web-structure** he clarifies late and partially — **not** "watched vision nested through Aedan." **Aedan does not route the cosmology to Eli.**
> - **The wheel / orphan-and-father / Qingu-vs-We-ila** remain motifs.
...
> **Status — deep web-structure (see `36_the_living_web.md`).** Under the locked series spine (`/00_NARRATIVE_STRUCTURE.md`), this outline supplies deep-past scene detail for the **living-web** model, not reincarnation. The historical practitioners are **distinct people who resolve as threads in the web** — they are not Eli's former selves, not one bloodline, and not a roster he "carries." Reception of a thread is not mastery of its practice. The term **resonance braid** is deprecated (see `36_the_living_web.md` §2). Where older passages below imply genealogy, reincarnation, bodily inhabitation, a numbered Seven, or equal mastery of every practice, `36_the_living_web.md` and `/00_NARRATIVE_STRUCTURE.md` control.

*Working title TBD. Folder is `50_Ancient_Creatures` but creatures are not structural — see "Working title" at end.*

## Premise

A boy in a singing village watches his world end under chariot-wheels and flees into a cave the elders always warned him about. The cave is the last sanctuary of the defeated old gods. Inside, the boy is shown the entire arc of the human experiment — from the seeding of the lineage 900,000 years ago, through the war in heaven, the breaking of Adapa, the burial of Göbekli Tepe, the long erasure of the Albians, down to a child sleeping today in a city built on the ruins of all of it.
...
| Location | What is discovered | Adventure function |
|---|---|---|
...
**When:** **Vol II late** — Book II Ch 6, same body-arrival as Pömmelte. After Eli has seen paired anomalies / opposed readings and knows a broken conductor leaves two ends. Somchai decodes the church as a live diagnostic template: ley lines repurposed as extraction architecture, congregation as medium, clergy as harvesters. Michael vs Gabriel iconography at the draining end labels the two ends of the break — not decoration.
...
- **No lecture.** Somchai supplies the decoded sentence: the grid was bent this way on purpose. Never "node" on-page — **end of the break**, **pew-side end**, **back-room end**.
...
- **Keeper contact:** a custodian left a marker in the sacristy. Retrieving it forces entry during service or after hours and pivots the group toward the uncorrupted Albion route.
- **Bridge rhyme:** the church is the post-split exploitation diagram; the Göbekli Bridge plaquette is the pre-split diagram. Same cosmology, opposite stage of the wound.
...
**Adventure function:** wrong map sends them to the church; Somchai's decoding explains why the town feels "off"; pursuit or clue in the back room forces entry; discovery **changes trust** (Wren: "They've been farming you") or **route** (avoid this ground; seek the uncorrupted end).
...
### The Sídhe layer — blood, mound, presence (LOCKED)

The westward trail does not end with an etymological “elf” click. In Ireland and the Gaelic west, several surviving realities compress into the **Tuatha Dé Danann / Sídhe**: Nephilot carriers who went physically underground or hid beside charged sites; dead gods and human ancestors persisting on the spirit plane; megalithic mounds that localize contact; and communities that maintained protocols around all three. The useful refrain is spoken as inherited belief, not omniscient taxonomy: **“The gods did not die, nor did they leave. They simply went underground.”** The deeper correction is that they went underground **in blood, earth, spirit, and story**.

**Discovery discipline:** Eli must first encounter a protocol that works before hearing an explanation. A road bends around a lone hawthorn; a keeper refuses to cross a mound-path at the wrong time; fresh rowan branches at the threshold soften or mark the crossing long enough to orient the group. When that fails, deliberately grounded worked iron interrupts the weak local coherence long enough to save someone but also severs contact. Then conflicting witnesses supply competing readings. Governing material contrast: **rowan negotiates; iron breaks**. Do not make rowan a wand, ordinary iron a universal power-canceller, every hawthorn a node, or the Bronze-to-Iron transition a solved historical war between species.

**The taking / changeling distinction:** Book II may connect the old fear to carrier abduction, gifted-child screening, threshold episodes, and people returned altered by captivity or illness. It must also expose the human cruelty of using changeling language against disabled, neurodivergent, sick, traumatized, or failing-to-thrive children. The supernatural history can be partly real without making the accusation true. Fairy doctors belong to the keeper lineage as fallible protocol specialists—plant knowledge, timing, family memory, diagnosis, ritual containment—not infallible shamans.
...
|---|---|---|---|
| **1. Göbekli anchor** | **Book II** (`32`) | Selection scar and westward question, not the elf answer. Aru/Daskar at the fox-pillar; the spiral-in-the-eye is a selection mark. The incomplete read associates inherited difference, lineage, labor, and reproductive control without proving a down-breeding system. **The plaquette's two-children reading seeds here:** the snake line (Apkallu) carried the practice down into the workforce; the bird line (Igigi) held the non-intervention rule and became the archive. Book II sees the two guardians flanking the tree and does not yet know what the division means. Book III certifies: interpreters vs. non-interpreters, teahouse vs. registry, native road vs. extraction — the parent split inherited by the children, running from the beginning. | Contested dig; faction race; Hassan's captive-transfer evidence; complete record remains partial |
...
|| **3. Massacre ground** | **Book II Ch 6** — Pömmelte outskirts sleep | Eli sleeps on the outskirts and experiences the massacre history in a dream/body memory — the ground carries the absence; no museum/aDNA framing on-page. A **ring sanctuary** (locked primary: **Pömmelte**, ~2321–2211 BCE — “German Stonehenge”; shaft burials of **dismembered women, juveniles, children** vs dignified **male** graves). Secondary rhyme: **Gomolava** (~800 BCE — 77 killed, **~87% female**, victims **unrelated**, gathered from many settlements). | Charged-ground encounter; Eli's dream/body memory reveals the sterility/reproductive-vacuum logic; the broken-line church domestic rhyme follows same body-arrival |
...
| **5. Alba / elf name** | **Vol II approach to Albion** | **Ch 5–6 civic:** Albion rename (Hassan; ferry clerk). **Ch 6 Pömmelte:** German fossil first — Anke's retired card *Alben*; Marta: grandmother used it for women missing at the rings. Eli sounds *Alb* and will not give the shafts a children's-book word. **Ch 7 Men-an-Tol:** he brings *Alben*; Morwen: they kept walking; later mouths said *elf*; same island. Eli writes *Alba?* on HOLT. Possibly Maren's line. He does not become an elf. | Pömmelte card; civic rename; rowan/iron |
...
**Escalation by location:**

| Location | Psionic-war pressure |
|---|---|
...
| **Singapore** | A state unit, Lang's acquisition team, and the protagonists converge on the same research archive. The psionic attack scrambles recognition and trust while physical surveillance closes the exits. |
...
> **Reframed to the living web (`36_the_living_web.md`).** Aedan is a deep-time figure in his own right — an early receiver who partially clarified the web long before Eli. He is **not** Eli's access path, and the cosmology does **not** reach the present "through Aedan." Eli clarifies the deep web **directly**. What the cave showed Aedan is described below as Aedan's *own* deep-time experience; do not read it as Eli's delivery mechanism.

The cave is local to Bronze-Age **Aedan**, an early receiver. It bends vision, not body. What it shows him is of two kinds:

- **Stories he watches** — myths and parables the cave plays before Aedan: the Seven Pairs, Activation, War in Heaven, and **Adapa**. He watches; he is not in the scenes. (For Eli, these are the faint deep web-structure he clarifies late and partially.)
- **Fragmentary practice-traces** — incomplete flashes, sensations, motifs, and practices of the historical practitioners. Aedan cannot hold any of them as a complete person and never becomes them. Eli, far later, clarifies these threads to full resolution — but full clarity still does not make a life his.

He returns to himself in Part IV — older, in the same cave, with a choice to make. The deep truth Eli eventually clarifies for himself is the one Aedan's life already shows: transmission has always moved through many partial receivers, objects, songs, and places — never owned, never one line. The boy is not Eli and was not being shown his own future incarnations.

**The cave as nervous system (deep-time sensory architecture).** Retain this sensory architecture for Aedan's own deep-time arc and echo it in Eli's present clarifying, but do not use it to imply shared identity or a delivery path between them:

- *Between practice-traces Aedan surfaces physically altered,* but with fragments rather than ownership: temperature gradients after Ila's trace, the edge of other minds after Tem's. When Eli later clarifies these same threads he must likewise name whose fragment remains. Watched stories leave a recognition or question rather than a practice.
...
## The orphan and the father — one of the book's threads
...
## The two creation myths — another of the book's threads

*The ideological engine under the orphan-and-father thread. Again: a recurring chord, never announced as thesis.*

There are two stories about where humanity came from, and which one Aedan believes is the measure of his arc.

- **The official story — *Qingu-blood* (the propaganda).** Taught in the ziggurat-schools, carried west with the Sintashta wheel (ch 3): humanity was fashioned from the blood of **Qingu the traitor-god**, so we are guilt-born and rebellious by nature and must be ruled. This is the father-god's justification given a creation-myth: *you are bad blood; kneel.* (Canon hook — and the control system's masterstroke: "Qingu" is *also* the real name of the genetic reserve stock the workforce was bred from, so the lie is welded to a true name. The Igigi stole the reality of the stock and inverted its meaning. See timeline, "The Qingu pun & the two creation myths.")
...
| **Anthea** | Ch 14 — Bronze Age Anatolia (~1500 BCE) | **Patriarchal cults** kill her for singing; daughter **Lira** scatters the chord west | Warlords want her **useful to their line** (Lesson 13 limit) — mirror of Adapa's failure |
...
- **The Boy / Aedan** — unnamed in Part I and named **Aedan** ("ember / little fire") through a carrier echo near the firing of the circle. A partial receiver, not Eli and not one of the Seven. He receives fragments strongly enough to carry heat from the cave, but never owns or fully inhabits the historical people.
- **The Grandfather** — dead before the book opens, but his warnings about the cave are the only door into Part II.
- **The Singer** — village priestess, killed in the raid. Her song is what the cave answers. She carries a late, partial transmission of Anthea's chord; no genealogy is required.
...
- **The Dragons** — the "ancient creatures" the cave is named for. *Not* mythic fire-breathers but an ancient, extraordinarily long-lived **Earth-born marine/reptilian lineage**, descended from an archosaur or marine-reptile branch and convergent with whales and dolphins. Their wings are fins for water, pressure, and charged-current control, not flight. Their "fire" is **biological thermal control** (electromagnetic/chemical discharge); their "telepathy" is **infrasonic/ultrasonic resonance** felt as a voice in the skull. They domesticated existing *Homo erectus* through hearth partnership: dragons ignited cooking fires while hominins gathered wood and other land materials. This supported calorie access, cooperation, and cultural acceleration before the Anunnaki converted reciprocity into extraction. They are the living precedent of the Singer's song and Aedan's heat. *(Full canon: timeline Phase 0, "the dragons — the K-Pg survivors.")*
...
### The Seven — distinct historical carriers

The Seven are **Aru, Daskar, Ila, Tem, Anthea, Cuno, and Lovernios**: separate people rather than seven Aedan lives. They never form a council in life, share no required genealogy, and may contradict one another. Together their retained imprints make a nervous system only at the level of the archive. The Seven Pairs Protocol supplies a symbolic rhyme, not a one-to-one descent claim. Eli's maternal line explains why he can receive; it does not make the Seven his ancestors or place their deepest history in Albion.
...
**The children who carry fragments.** Transmission often reaches a child, apprentice, stranger, object, or place. It survives through teaching and resonance, not automatic inheritance:

- **Sib** (8) — sweeps stone-dust in Aru's workshop; the only one who notices the spiral in the fox's eye.
- **Eshe** (7) — Daskar's daughter; he pushes what he knows into her hands before he dies. Her later fate is one transmission path, not proof that Ila descends from her.
...
**4. The Burning**
The raid. The Singer's last song. Two paths offered: be taken east in a wagon train, or run to the cave. The grandfather's voice is the only thing that decides it.

**5. The Cave of Dragons**
The boy enters. The statues are not statues — they are the **dragons**, and what reaches him first is heat off their stillness and a voice that never becomes sound. The altered band in the wheat terminates, though he cannot yet know it, at the cave's side of a broken conductor; the opposite end will surface in Cuno's record. The first vision begins before he stops trembling. The heat later warms Aedan's granary stone; the voiceless voice rhymes with the Singer's resonance. He is meeting the un-engineered precedent for capacities that later arise in many human lines.

---

## Part II — The Vision (Deep Past)

Watched-depth. The boy watches; he is not in the scenes. Voice should drift toward myth-cadence. These are myths the cave plays before him, **Adapa** included. The deep practice-threads begin in Part III, but remain fragments rather than inhabitations. (For Eli these are the faint, oldest web-structure, clarified late and partially; see `36_the_living_web.md`.)
...
- **ii. The First Spear.** A man on a ridge, a herd below, the moment cognition turns into distance-killing — not a weapon yet, a thrown stone: the shoulder cocks, the waist turns against the hips so the body becomes a whip, the elbow snaps at the last instant. The Anunnaki watching to see what he does next. This is the "dumb skill" that made the lineage dangerous: a rock arrives faster than the herd's horns or hooves can answer, from beyond their reach — the prey's whole defense, evolved against teeth and claws at close range, becomes irrelevant. *(Real floor: the human shoulder stores elastic energy in the cocking phase and releases it explosively; this anatomy is in* Homo erectus *by ~2 mya, long before the deliberate act the cave shows — see `90` §9. The scene is the* cognitive turn*, not the hardware.) Stay terrestrial: no lab, no instructor; the boy watches a wild thing learn to kill at a distance, and the gods watching did not teach it. Prometheus/Enki credit stays out of this beat — fire belongs to the refuge (i); distance-killing belongs to the hand.*
- **iii. The Key.** A pulse from the sky. Genes that have slept a million years switch on. The Umannu wake into themselves.

**Bottleneck texture — keep it terrestrial.** The 0.9-mya vision must not look like an alien laboratory. The science-facing anchor is a proposed genomic bottleneck (~1,280 breeding individuals, ~930–813 kya), not a mapped scene; the scene-facing texture should come from the archaeological world around that interval and its aftermath: refuge-water, mud, highland cold, drought, Acheulean handaxes, butchered megafauna, children at the edge of a water body, smoke later carrying through the recovery corridors. Think **survival academy**, not spacecraft. The cave can show the mythic fourteen, but the ground under their feet is Earth: stone, bone, ash, hunger, and weather.

**Prometheus / Enki credit.** If fire appears in this triptych as warmth, cooking, protection, or social center, let it carry the rebel-helper signature: **Prometheus stole it; Enki's Apkallu taught it.** Fire is the humane gift that helps the refuges endure, not the controllers' leash.
...
Seven historical chapters, seven distinct people, one practice per chapter. In the trunk these are deep human **threads Eli clarifies to full resolution**; in Aedan's own deep-time experience they appear only as partial flashes and bodily residue. Each chapter keeps the shape *encounter → instruction → first success → glimpse → loss*, but no teacher or artifact needs to prove a single ancestry. Transmission may occur; independence and rediscovery may also occur. (Per `36_the_living_web.md`: not a numbered roster Eli "receives" — recurring people who resolve out of the web; the count may stay near seven but is discovered, not imposed.)
...
**Evidence / scale lock:** Göbekli Tepe has yielded more than 10,000 grinding-stone fragments; 7,268 tools were analyzed in one study, supporting extensive cereal processing beyond a small household's needs. Six complete in-situ limestone troughs from the site's rectangular/apsidal building contexts have reported capacities of approximately **35, 38, 62, 70, 83, and 165 litres** — about **453 litres total theoretical capacity**, or roughly **900 half-litre portions**, not 960 litres. They stood in separate rooms and contexts, so never imply that all operated simultaneously or that this is a known batch size. Their later context means the fixed-trough details belong most securely to **Daskar's world**, not Aru's earliest construction phase. Integrated residue, use-wear, context, and experimental analysis favors cooking cereal porridge/gruel with heated stones. Fermentation was possible experimentally, but beer at these troughs remains unproven. Use **large-scale communal cereal provisioning / possible fermented mash** as the historical floor; keep the work-feast and managerial-control reading as interpretation. Sources: [Dietrich et al. 2019](https://doi.org/10.1371/journal.pone.0215214); [Dietrich et al. 2020](https://doi.org/10.1016/j.jasrep.2020.102618).

**11. The Builder Who Refused** *(Göbekli burial, ~8000 BCE — Daskar, ~40 — Practice: energy field, heat and cold spots)*
**Daskar**, around forty, lives sixty generations after Aru but need not descend from him. The provisioning technology has hardened into administration: fixed limestone troughs belong to rooms, fire-heated stones cook coarse cereal mash, grain is counted, portions are allotted, and priests decide who eats. Some mash left standing turns sharp and faintly sweet, possibly mildly intoxicating, but the narration never declares the installation a brewery or assigns an alcohol content. Aru was fed so that many bands could raise something together; Daskar is rationed so that administrators can command the same labor. The new priests order the pillars buried. His hands have always been strange — he can feel a fever through a wall, a corpse before he sees it. When he places his palms over the foxes (the spiral still in the eye), the pillars are *warm*. As the fill rises, the center falls silent even though the current beneath the site remains. He understands that the order is decommissioning a routing instrument, not destroying the natural line. He refuses, is beaten, and is made to bury it anyway. Before they kill him he presses his hands to his daughter **Eshe**, seven, and teaches **signature-read** through touch — heat for fever, cold for depletion. Her later transmission is one road among many, not the source of Ila.

**12. The Midwife** *(early agriculture, ~7000 BCE — Ila, 19 — Practice: healing touch, the diagnostic conduit)*
**Ila** is nineteen in an early farming community in **South Asia** (exact site/date to verify) and barely trusts what her own hands do. Bent backs, rotting teeth, and new diseases give her practice its material pressure. A new geometry emerges through the planted grain because the plants along it grow differently; Ila and the farmers observe it over days, reject irrigation and blight, and use the living pattern to locate a newly forming conductor. She discovers **somatic signature-read** independently or through a local teacher — not inherited from Eshe — and learns through trial, dead babies, and the few she saves: **heat** for viral fever, **tingling** for bacterial or nerve insult, **pressure/pulse** for blockage, **cold** for depletion. She develops the conduit between her palms, then teaches her twelve-year-old apprentice **Tava** because authorities have heard about her. Her record gives Eli the missing historical observation: crop formations are consequences of new lines, not inscriptions.

**Present-braid consequence:** Eli's contact with Ila's record helps produce one frightened, limited act of stabilization — a **pressure-read at a bleed** — and gives him language for signatures as information. It does not make him Ila's equal. The stronger present-day healer—also not Ila reborn—recognizes in the record a method that his own medical training and tactile gift can develop much further.

**13. The Hidden Son** *(17:1 bottleneck, ~3000 BCE — Tem, 6 → ~30 — Practice: dream-walking, telepathy)*
**Tem** is six when his mother **Marra** hides him in the grain pit — the pit becomes the first instruction. In the dark he learns to go elsewhere in his mind. After the hybrid lords kill her, she keeps reaching him in dreams. He discovers he can reach unrelated hidden children across scattered communities and becomes a listening post in the dream-chain; they dream one another into surviving. Then one cluster vanishes from the shared dream while remaining alive. Tem traces the silence to a broken route and encounters its opposed ends without words for polarity. By thirty he meets, in dream, an unknown young healer whose hands sense heat as Ila's did centuries earlier. The recurrence proves mind and capacity are not confined to skull or pedigree. The grain-pit story later rhymes with Moses without being its sole source.
...
The boy returns to himself in the cave. Older. Days have passed, or years; the cave doesn't say.

**17. The Boy Returns**
He walks out. The Sintashta are long gone. The village is grass. The granary's foundation stones remain, the sun-wheel faint on one. Across the former field, plants have taken up a new curved geometry: the broken network is not simply returning to its old course but forming another. He sits on the stone carrying **fragments** of seven practices and the name Aedan. He sings the Singer's partial chord and the stone warms. He is an **ember**, not the completed vessel — a partial receiver who carries fragments, not a conduit to the future — and the changed growth keeps the ending open: living networks repair by making new routes, not by restoring one perfect past.

**18. A Song Remembered**
A child in a city today dreams of a cave. They wake humming a tune their mother does not recognize, palms hot when their grandmother is sick, dreaming of a fox with a spiral eye. On the walk to school they stop at a vacant lot where weeds have begun to grow in an exact curve. They do not know what it means. The archive is still open. The Seven are still in the field and in human practice, not owned by one bloodline. The choice remains open.

*Closing line returns to the opening: we cannot build what we refuse to imagine.*

---

## Voice notes

- **Part I**: tight, present-tense, sensory. Cormac McCarthy without the punctuation rules.
- **Part II**: myth-cadence. Permission to drift toward scripture. Shorter sentences. Repetition.
...
- **Panspermia** (Crick & Orgel 1973 / Steele et al. 2018) — life and its genetic "receivers" seeded from elsewhere. Anchors Part II / Ch 6.i.
- **Chromosome 2 fusion + the 0.9-mya bottleneck** (IJdo et al. 1991; Poszewiecka et al. 2022; Hu et al. 2023) — we carry 23 pairs where other apes carry 24; the fusion is dated to ~0.9 mya, and Hu et al. model a severe bottleneck to ~1,280 in the same window. Two findings converging on one moment: the genetic Garden of Eden / Seven Pairs. Anchors Ch 6.i.
- **Bottleneck refuge texture** (Melka Kunture / Gombore II-2; Gesher Benot Ya'aqov; Atapuerca / Gran Dolina) — not proof of the exact founders, but the grounded archaeological vocabulary for early and middle Pleistocene survival: footprints, water margins, stone tools, butchery, fire/cooking, cave occupation, and pressure severe enough to make cannibalism plausible in some European contexts. Anchors Ch 6.i as texture and restraint.

## Canon anchors

Every chapter has a hook in the existing timeline (`30_The_Human_Experiment/src/90_appendix/10_timeline.md`):

| Ch | Era | Canon source | Practice / Capability |
|----|-----|--------------|----------------------|
| 1–5 | ~2000 BCE Sintashta raid | `20_part_control/40_generational_war.md` | — |
| 6.i | 0.9 mya Seven Pairs | Timeline Phase II | (foreshadows the Seven) |
| 6.ii | 400 kya Spear Moment | Timeline Phase IV | — |
| 6.iii | 70 kya Activation | Timeline Phase III | — |
| 7 | Anunnaki supervision | Timeline Phase IV | — |
| 8 | Younger Dryas / war | Timeline Phase V | — |
| 9 | Adapa | `20_part_control/60_wisdom_keepers.md` | (the lock — the Seven are keys to what he was denied) |
| 10 | Göbekli construction | Timeline Phase V/VI | Breath, stillness (`30_part_liberation/20_practices_for_liberation.md` — consciousness integration) |
| 11 | Göbekli burial | Timeline Phase VI | Energy field, heat/cold sensing (`practices` — energy awareness, scanning) |
...
- **The Cave of Dragons**
- **The Sun-Wheel**
- **What the Cave Remembered**
- **Before the Wheel Turned**
- **The Song the Singer Knew**

Series fit: previous titles are *Manual Override / The Social Game / The Human Experiment / The Consciousness Technologies*. This one wants something more lyrical — it's the mythic capstone, not another framework book.

## Open questions

1. **Locked: Aedan ("ember / little fire") names the cave-boy only.** **Somatic signature-read** is the present diagnostic spine (`32`, Carrier 3). **Fox is a transmission motif, not a lineage marker** — Aru carves it, Lovernios's name echoes it, the modern child dreams it.
...
4. The Singer in Part I carries a damaged transmission of Anthea's chord; descent is neither known nor needed. Plant the sound early and withhold the meaning.
...
7. On-page vs. posthumous/dreamt teachers? Keep the mix intentionally. The drift from alive teachers to transmitted, dreamt, independently discovered, and traditional instruction shows that knowledge does not require a single pedigree.
8. Watched stories vs. deep practice-threads (one dial of depth, per `36_the_living_web.md`). **Locked: in his own deep-time arc Aedan watches stories and catches partial practice-traces; Eli, far later, clarifies the same deep web — near human threads resolve to full embodied scenes, the faint old cosmology resolves only as watched fragments.** Neither implies reincarnation or ownership. Watched-depth leaves recognition/questions; a fully clarified thread leaves embodied information that still requires practice.
