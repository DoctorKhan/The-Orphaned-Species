...
> - **The cosmology** (Seven Pairs, Activation, Living Gods, War in Heaven, Adapa) is **deep web-structure** he clarifies late and partially — **not** "watched vision nested through Aedan." **Aedan as a relay is removed.**
...
> **Status — deep web-structure (see `36_the_living_web.md`).** Under the locked series spine (`/00_NARRATIVE_STRUCTURE.md`), this outline supplies deep-past scene detail for the **living-web** model, not reincarnation. The historical practitioners are **distinct people who resolve as threads in the web** — they are not Eli's former selves, not one bloodline, and not a roster he "carries." Reception of a thread is not mastery of its practice. The terms **resonance braid** and **Aedan-as-relay** are deprecated (see `36_the_living_web.md` §2). Where older passages below imply genealogy, reincarnation, bodily inhabitation, a numbered Seven, or equal mastery of every practice, `36_the_living_web.md` and `/00_NARRATIVE_STRUCTURE.md` control.
...
|---|---|---|---|
| **1. Göbekli anchor** | Vol II — Göbekli Tepe (`29`, `31`) | **Major reveal — what the elves are.** Aru/Daskar at the **fox-pillar**; the spiral-in-the-eye is a **selection mark**, not mere signature. Clarification shows Göbekli is the **sealing facility** for the Qingu reserve AND the **down-breeding site** where the first agriculturalists were selected into the **Nephilot** (~25% Igigi, fertile, found by gift). The burial **decommissioned** the interface, not the conductor (Daskar's warm palms). Mother's research / Emrys data: **first-farmer "ghost lineage"** (Basal Eurasian) — the trackable start of the westward carrier story. | Contested dig; **faction race to reach the sealed interface first**; touch pillar under pressure |
...
| **Göbekli / Anatolia** | Teams fight for the buried routing geometry. Old maps lure one force into a dead site while living observations expose a new route. Emrys is taken during or after this contest. |
...
> **Reframed to the living web (`36_the_living_web.md`).** Aedan is a deep-time figure in his own right — an early receiver who partially clarified the web long before Eli. He is **not** Eli's access path or relay, and the cosmology does **not** reach the present "through Aedan." Eli clarifies the deep web **directly**. What the cave showed Aedan is described below as Aedan's *own* deep-time experience; do not read it as Eli's delivery mechanism.
...
**The cave as nervous system (deep-time sensory architecture).** Retain this sensory architecture for Aedan's own deep-time arc and echo it in Eli's present clarifying, but do not use it to imply shared identity or a relay:
