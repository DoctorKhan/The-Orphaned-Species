...
|---|---|---|---|
| **1. Göbekli anchor** | **Vol I — Göbekli Tepe (Ch 17)** (`29`, `31`) | **Major reveal — what the elves are.** Aru/Daskar at the **fox-pillar**; the spiral-in-the-eye is a **selection mark**, not mere signature. Clarification shows Göbekli is the **sealing facility** for the Qingu reserve AND the **down-breeding site** where the first agriculturalists were selected into the **Nephilot** (~25% Igigi, fertile, found by gift). The burial **decommissioned** the interface, not the conductor (Daskar's warm palms). Mother's research / Emrys data: **first-farmer "ghost lineage"** (Basal Eurasian) — the trackable start of the westward carrier story. | Contested dig; **faction race to reach the sealed interface first**; touch pillar under pressure; **Emrys taken** |
...
|---|---|
| **Forest City** | Accountable privacy practices prevent outbreak records from becoming a recruitment list. Residents unknowingly shelter people wanted by more than one national program. |
...
| **Singapore** | A state unit, Crane's acquisition team, and the protagonists converge on the same research archive. The psionic attack scrambles recognition and trust while physical surveillance closes the exits. |
...
| **Göbekli / Anatolia** | Teams fight for the buried routing geometry at **Vol I climax**. Old maps lure one force into a dead site while living observations expose a new route. **Emrys is taken during or after this contest (Vol I Ch 17).** |
