...
| **Göbekli / Anatolia** | Aru and Daskar's records separate the natural conductor from its built interface: stones redirect; burial decommissions the node. | Crane controls the obvious site, forcing the group to reconstruct geometry from partial records and terrain while being hunted. |
| **Continental Europe** | Broken lines explain why some ancient nodes are silent and why others answer from unexpected directions. | The route becomes a moving puzzle. Each endpoint changes the next destination, and Crane's superior old maps become less reliable than the protagonists' living observations. |
...
| **Göbekli / Anatolia** | Teams fight for the buried routing geometry. Old maps lure one force into a dead node while living observations expose a new route. Emrys is taken during or after this contest. |
...
| **Albion** | Several psion groups converge, each intending to control, destroy, nationalize, privatize, or free the node. The final battle requires holding the communicative center without letting any team turn collective coherence into domination. |
...
- **ii. The First Spear.** A man on a ridge, a herd below, the moment cognition turns into distance-killing. The Anunnaki watching to see what he does next.
...
1. **Locked: Aedan ("ember / little fire") names the cave-boy only.** The heat thread is the spine. **Fox is a transmission motif, not a lineage marker** — Aru carves it, Lovernios's name echoes it, the modern child dreams it.
