...
|---|---|---|
| **Philippines, childhood** | Martial training teaches Eli to read line, range, angle, entry, and pressure through the body. This is disciplined perception, not secret mysticism. | A practical skill learned while the family is moving later lets him survive pursuit and notice geometry before he has doctrine for it. |
...
|---|---|---|---|
| **1. Göbekli anchor** | **Vol I — Göbekli Tepe (Ch 13)** (`29`, `31`) | **Major reveal — what the elves are.** Aru/Daskar at the **fox-pillar**; the spiral-in-the-eye is a **selection mark**, not mere signature. Clarification shows Göbekli is the **sealing facility** for the Qingu reserve AND the **down-breeding site** where the first agriculturalists were selected into the **Nephilot** (~25% Igigi, fertile, found by gift). The burial **decommissioned** the interface, not the conductor (Daskar's warm palms). Mother's research / Emrys data: **first-farmer "ghost lineage"** (Basal Eurasian) — the trackable start of the westward carrier story. | Contested dig; **faction race to reach the sealed interface first**; touch pillar under pressure; **Emrys taken** |
...
| **Melaka** | Two teams contest a carrier or route during the reopening crisis. Eli's breach makes him detectable to both, turning a local emergency into the first battle he cannot understand. |
