...
**Preamble → Ch 1 (Eli · Forest City).** No standalone Maren prologue in Book I. Ring suppression is felt through Custodians, white coats, and the mother-trail — attachment before mythology (`17`).
...
- **Eli:** hid puberty in keeper net; fears **Fractured** file-language (`26`); somatic read = gift **Union would sedate**. Arc: from "earn safety by usefulness" → Manual Override.
...
| Plant (Vol I) | Payoff |
|---|---|
| Song / guitar / rhythm | The tune survives copying; Khun Dang's lodge joins the keeper chain |
