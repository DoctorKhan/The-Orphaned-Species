...
> **Ambiguous-loss reveal — REVISED AND LOCKED 2026-08-10:** Eli believes both parents dead until Mei's Friday dinner. Mei knows only that they left the failed handoff alive in separate vans; she has no evidence that either survived captivity. The Malacca intake photograph proves Rasel survived the extraction years ago. Thailand supplies the first current trace: a four-day-old maintenance handshake bearing Rasel's initials and watering count. Sanxingdui supplies visual confirmation and reunion. Rasel then reports that Maren was alive two winters earlier, leaving her present condition open for Book II.
...
- **Ambiguous-loss reveal:** **Mei, Friday dinner** — the death file lied; both parents entered separate vans alive; no one on the Reach knows whether they survived. Mei turns the family photograph face-down and tells Eli what Babaji told her. She offers no document, destination, or promise.
- **Deep-time residue — REVISED 2026-08-10:** (1) Rasel's garden as reception-without-mastery / living craft vs Foundry cables; (2) missing-cohort texture — empty kid infrastructure or older work crew visible without lecture; (3) the face-down family photograph and Mei's hearsay. Wrong reading: Mei's certainty about the extraction night extends to the years after. Cost: he leaves the living plot for Stack cash without knowing whether it is a memorial.
...
- **Parent memory — REVISED AND LOCKED 2026-08-10 (three-phase):** Before Mei speaks, garden and food memories belong to people Eli believes dead. One memory remains useless as evidence: a mattress on tile under a metal roof, Maren's palm rising on his sternum, Rasel's cool hand at his neck, both still there when he wakes. From dinner through Thailand, the same memories carry ambiguous loss. In Ch 11 Eli gives the storm-room memory to Shireen, who remembers relatives remembering his parents more clearly than she remembers the people. Thailand's current handshake converts uncertainty into a rescue clock for Rasel. Maren remains unresolved until Rasel's two-winters-old note.
...
- **Aftermath:** father-son reunion is collision, anger, and partial truth—not
  ...
  `manuscripts/I_The_Breach.md` Ch 13 — "Nobody kept me... I walked into their
  program on purpose" replaces the earlier passive "I was kept" line; Babaji
  and Mei kept as genuinely unaware — they chose when to disclose the old
  extraction truth without knowing the archive trail would surface on the same
  schedule, preserving their own established warmth):
  Rasel adds that the capture was not a defeat — he walked
  ...
  talking about (`35_artifact_chain.md` § *The Folly*). Mei's old extraction truth created the uncertainty that made Eli
  follow the archive trail; Rasel and Maren had arranged for that trail to wake
  when Eli's name touched real corridor papers.
