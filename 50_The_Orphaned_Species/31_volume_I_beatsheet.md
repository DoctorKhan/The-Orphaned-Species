...
> **CURRENT SPINE — LOCKED.** Book I runs **the Reclamation, Pelangi Reach → Meridian City → Straits → Melaka → breach → Mekong Delta (agricultural witness) → Gulf/Mesopotamia → Göbekli Tepe (climax)**. Mekong/Vietnam is the substantial agricultural-witness sequence; Thailand a shorter grounding/memory hinge; Bangladesh a brief village/home hinge. **Book I climaxes at Göbekli Tepe:** Eli chooses people over the complete interface record and Emrys is taken. The old Mekong-climax allocation and the old chapter numbering are retired; use the order below.
...
> **Pelangi pressure — LOCKED 2026-07-16:** Pelangi Reach is a compromised royal tech-hub project under climate stress, not a preserved island utopia. The king's desalination, AI, flood, cooling, biotech, and robotics systems compete with Meridian City while older water, farming, temple, kinship, and craft institutions keep the island relational. Those institutions are changing, losing land, and being packaged for development; the island is less what it was, but not simply worse.
...
> **ROOTBOOK — LOCKED 2026-07-21:** Maren's encoded comparative field journal enters only after the ring and human witness have established the emotional trail. A damaged scan or folio recovered through the Melaka/Meridian evidence chain reveals a first **name** index and later a **foot/step** correspondence. It points to bounded tests, never the whole pilgrimage. Full design: `52_the_rootbook_word_web.md`.

> **OPENING ORDER — LOCKED:** **Ch 1 Pelangi Reach ordinary life and staged attack → Ch 2 one sustained southern-flight movement: escape through the blocked corridor → brief Meridian City processing and ring photograph → north through the Straits → Melaka witness collision → pursuit and asphyxia breach → Ch 3 aftermath and grounding → Ch 4 Wren's independent extraction and maritime departure**. The breach lands at the **end of Chapter 2**, not after a six-chapter runway. Meridian City remains a sharp pressure chamber inside the flight, not a second opening or a standalone worldbuilding stop. No post-Melaka return to Meridian City. The detailed opening material sits in the **Scene Bank** below; mine it into Ch 2–4 rather than restoring the retired sequence. The Mekong (Ch 5–10) and Gulf/Göbekli (Ch 11–13) chapters then follow.

### Current opening cards — authoritative order

- **Ch 1 — Pelangi Reach:** ordinary Foundry life and the staged attack that scapegoats the Foundry and anomalous residents. The mother's song may remain as background texture, not the inciting lure.
- **Ch 2 — Something of Hers / The Southern Exit:** the northward corridor is blocked; Eli and a small survivor group escape through Bengali diaspora contacts into brief Mandate processing in Meridian City. An ordinary archive photograph reveals Maren's ring and points north. Eli pays to escape classification, crosses the Straits under inspection and psionic interference, reaches Hassan amid Wren's colliding extraction, glimpses the physical ring, and is run down by the Custodians. The chapter ends underwater: asphyxia opens the receiver and the psi plane.
...
> **Locked inputs this sheet chains together:** Eli works **facilities at Forest Foundry (the Foundry)** and keeps his **dead father's garden, badly**, at Pelangi Reach (#1) → a **witness** clue reaches him via the compound/port network, half-bait (#1) → Melaka, where **Wren** is running an extraction that light-crosses the witness (#3) → the breach: a losing Kali fight ending in **asphyxia**, the psi plane opens, **receiver ON / overload + hunted** — not identity crisis and not a batch of lives downloaded (#2; `36` §3a) → the **Custodians** run him down and pursue (#4) → Mekong/Vietnam agricultural witness → Thailand grounding/memory hinge → westward maritime corridor, Gulf/Mesopotamian evidence, and the Göbekli race.

> **Route lock — Meridian City detour:** the direct northward land corridor from Pelangi Reach toward Melaka is blocked by wartime checkpoints and competing authorities. Eli is forced south through **Singapore / Meridian City**, the Eastern Mandate's de facto administrative and maritime capital — high-surveillance, unforgiving clinical order, the only safe harbor in the straits. Singapore remains the ordinary local name; *Meridian City* is the Mandate's official designation; residents call the vertical institutional city **the Stack**. The capital coordinates the bloc but does not contain all Mandate power: security, industry, energy, and launch capacity remain distributed elsewhere. The northern land route is closed, the Union is south, the open sea is nowhere; Meridian is the only place the breaker-net can reach him. From there he must book north by sea to Melaka. Its atomized order is the counterpoint to Melaka's plural social ecology. The archive encounter happens during this transit: translation, classification, and logistics are nearly perfect while relationship remains thin.

> **Meridian maze — LOCKED:** Meridian City cannot be navigated by an outsider using official maps. Eli moves through it via a distributed Bengali worker network. A construction worker gives him a partial shaft route; other workers supply food, warnings, service-lift access, and harbor timing. Each person knows one segment, each favor creates exposure, and the network's help remains human and fallible. Eli's Bengali opens the first conversation but never grants automatic trust or total access.
...
> **Inciting catastrophe — LOCKED:** a staged attack at Pelangi Reach targets **Forest Foundry (the Foundry)** and plants evidence blaming it and anomalous residents. The Union and Eastern Mandate exploit the event to justify intervention; the northern corridor is sealed, communications are cut, and residents are sorted into evacuation, detention, or medical assessment. Pelangi Reach is politically occupied and fragmented rather than simply destroyed. A small group, including Eli, escapes through maritime and Bengali diaspora worker routes into Meridian City, where rescue becomes atomized clinical processing; they then flee north by sea through the Straits to Melaka. Eli survives while most residents remain scattered, detained, or trapped, creating an obligation to return.
...
> **POV — LOCKED:** Eli governs every Book I scene except the Wren-only Laleh-extraction opening in Chapter 4. Chapter 4 returns to Eli only after a hard section break. “Ensemble” describes who acts, never a shared or roaming viewpoint; one scene holds one mind. Chapter 2 stays with Eli through Meridian City, the witness collision, and the breach; observable Wren conduct may create dramatic irony, but the narration does not enter her interior. Full rule: `14` § *POV architecture — LOCKED*.
...
**Ch 1 (Eli · Pelangi Reach), with no historical preamble.** The collapse is reconstructed through residue (`42`). No standalone Maren prologue in Book I. Measure suppression is felt through Custodians, white coats, and the mother-trail — attachment before mythology (`17`).
...
- **Want / Attachment:** get through an ordinary day — the early hour in his father's garden, then compound shift. Attachment: **somatic reads** through his palms on live junctions (he never quite burns on the hardware — competence, not gift); **Priya**, **Mei's terrace**, and the Foundry workers who expect him tomorrow; and, privately, **his dead father's garden, where he is *not as good* as his father was** — the tomatoes that won't take. The split he carries without naming it: the **mother's carrier receptivity** through palms and nerves, the father's green hands he can't match — the tomatoes won't take. **Daily luck:** towers with worse papers, shift sign-off, recognizers who expect him — *you shouldn't still be here, and you are*; he doesn't say *lucky* out loud but doesn't forget it. **Babaji's name got him work, not wealth** — platform wage, no equity.
...
- **Choice → Cost:** no voluntary departure — he **runs** because stopping exposes Mei and the attack makes the Foundry unsafe. Cost: the compound crew, the garden, the recognizers, the mall routines, the sail training, and the only safe life that has ever held him — **burned in one morning**, not surrendered in a packed-bag beat. **Mei stays — LOCKED 2026-07-23:** she does not travel and is not killed off. She holds the terrace through the occupation while Eli runs, which is what makes her chargeable in Book III (`33` Ch 3). The band plays; the attack hits during the set. Looks coordinated. Is not — the terrace was just the easiest target.
- **Revelation / inciting turn:** Pelangi Reach is real, accountable refuge, not dystopia. During or immediately after the terrace song, the staged attack hits the Foundry lab, port facility, or transit hub. Evidence is planted against the Foundry and anomalous residents; authorities seal the city and cut communications. The song's Melaka contact becomes an evacuation route rather than a voluntary quest.
...
- **Living world — LOCKED 2026-07-23:** the island has non-human inhabitants before it has cosmology — koel before dawn, house crows over the chess boards, kites off the west face, swiftlets pouring out of the commercial nest-house by the fuel dock. Three unexplained oddities carry the unease, each with a mundane cover Eli supplies himself: the kites have moved off their thermal (*wind*), Mrs. Dutta's seedlings are stopping too (*the heat*), and the nest-house speakers call all night to a colony that no longer comes home (a passing man offers five explanations and has money in one). **Restraint:** the birds stay ordinary. No character points at them, nothing is called an omen, and the fire produces no dead-bird beat — the swiftlets come out into the smoke and go feed. They are billed in Book III (`33` Ch 10), not here.
- **Three offers on the board before the fire — LOCKED 2026-07-23:** Priya's score (*useful, on our ledger*), Priya's Bhowmik report and the east-block bodily signature (*known, on file*), Babaji's name (*protected, on my terms*). All three are given by people who mean well. Eli takes all three without noticing they are the same shape; the fourth rung is the Book III crown.
...
- **Want:** survive the morning, keep the people helping him from being classified with him, and learn why an ordinary archive photograph contains his mother's ring.
...
- **Obstacle (human · material · psionic):** a staged attack seals Pelangi Reach and authorizes a general purge; Eli is not singled out — he is one of the anomalous residents caught in the sweep, and he does not yet understand what "anomalous" means in a psionic register. Biosecurity hunters enforce the purge; checkpoints block the northward land route; Meridian City atomizes the survivors into medical/security cases; the ring photograph demands an answer in Melaka; Straits inspection and psionic interference tighten the clock; Wren's extraction collides with Hassan's handoff; the Custodians finally run Eli down at the waterfront.
- **What Eli thinks he knows (false):** first, wartime general purge — another roundup of people without papers. In Meridian City he sees *anomalous residents* and *carrier-adjacent* but still reads a legal register where the apparatus is actually reading bodies. When the ring photograph points to Hassan, he believes the danger is attached to his mother's past, not to what his own body is about to reveal.
- **Movement 1 — Pelangi Reach chase:** Mei sends him out the back; **Kiran** on a tandem rental; **kiddy pedal cars** through the waterpark plaza; one full circuit on the **children's train** while white coats run parallel; tumble onto **Suresh's supply boat** as the white coats reach the dock. Mei throws the bag (eggs, crimp tool, chandlery address). The train never stops. It was built for loops, not emergencies.
- **Movement 2 — Meridian City pressure chamber:** Mandate-linked processing splits the survivors into individual cases. An archive worker recognizes Eli's resemblance to Maren, then quietly compares his intake record with the dissident's suppressed Cherry Cube evidence packet; one copied frame from a Maren extraction-era record shows her silver-and-brass ring. Eli sees it, verifies the seam and *same soil* inscription, and pays a concrete cost to escape classification. The image supplies a Melaka contact, not an explanation.
...
- **Movement 3 — the Meridian Circuit escape:** a scheduled Formula One–scale street race has sealed the central avenues, diverted transit, and filled the city with grandstands, service vehicles, drones, and controlled crowds. The archive worker's recognition triggers a quiet search; the worker chain gets Eli beneath Cherry Lane, and the Cherry Cube performer opens a wardrobe leak into the harbor logistics convoy. Wren is glimpsed at the convoy edge on her own operation and deliberately does not acknowledge him—the near-miss before Melaka, not a rescue. The escape is earned by the city's own event, but the route leaves helpers exposed and funnels Eli toward the Straits. Meridian City does not expand into a separate institutional tour.
- **Worker-network beat — LOCKED:** a Bengali construction worker recognizes Eli's speech and gives him one partial shaft route beneath Cherry Lane. He cannot guide the whole group and risks losing his badge and wages by opening the gate. The route works only because a cleaner, cook, and dock mechanic each supply the next correction.
- **Cherry Cube concert — LOCKED:** a fictional K-pop-scale idol performs on a mall floor above the circuit. The star knew Maren as a child/young subject of her early protective-integration work; she helped him survive an episode and refused to let the program classify him as property. He recognizes Eli through Maren's face, a grounding gesture, and the circulated archive frame—not through supernatural certainty. He creates a plausible backstage excuse, gives Eli one personal memory of Maren, and opens a protected service route. Fans mistake Eli for a surprise performer; Wren uses the crowd and wardrobe corridor without treating fans as shields. The star helps, but cannot become a secret cosmology expositor or abandon the people whose safety depends on him.
...
- **Movement 4 — witness collision:** in reopening Melaka, Hassan's physical ring confirms the photograph while Wren's extraction of Nura and Ilyas fouls the handoff. Eli sees enough to know the lead is real and not enough to understand the trap.
- **Movement 5 — chapter-end breach:** scooter flight → losing Kali fight → choke/drowning at the river's edge. Salmah reaches him only after the psi plane opens in the final pages. End the chapter on receiver ON, overwhelming field-noise, and the grid flare—not explanation.
- **Choice → Cost:** the first movement is forced: he **runs** because stopping exposes Mei. The later movement is chosen: after seeing the ring photograph, he continues north rather than disappearing inside the survivor flow. Cost compounds across the chapter—home lost, helpers exposed, classification narrowly escaped, Hassan recaptured, Salmah punished, and Eli's signature lit across the grid.
...
## SCENE BANK — Melaka / Meridian City beats (mine into Ch 2–4; NOT current order)
...
### [bank] The Reopening — Melaka witness contact *(→ current Ch 2)*
...
### [bank] The Breach — Melaka asphyxia *(→ current Ch 2 ending)*
...
### [bank] What Didn't Die — aftermath / Wren fold-in *(→ current Ch 3)*
...
### [bank] Grounding — flight out of Melaka *(→ current Ch 3)*
...
- **Revelation:** the registers are *different things* — and instruments can measure a signature without explaining it. The dissident's packet shows that Meridian's luxury supply chain and suppression archive share a data spine; the ring frame was deliberately copied before the dissident disappeared. **Forward clue:** Emrys's correlation points to a paired-anomaly record (a polarity reading) reachable in a surveilled archive.
- **Rootbook seed:** the packet also preserves a corrupted locator or partial scan from Maren's comparative field journal. Its repeated forms look like multilingual clutter until the group reconstructs a bounded **name** correspondence. The result authenticates one page and opens one index; it does not authenticate every claim in the book.
...
### [bank] Her People — Wren's Laleh opening + maritime departure *(→ current Ch 4)*
...
- **Wren's prior-love seed (Rowan remains off-page in Book I):** Wren receives a **coded ping, manifest name, or song fragment** tied to Rowan, the formative love before Mira—shuts it down with too much control; Eli reads tactical fear, not history. Rowan does not appear until Book II (`26` § Rowan; `19` § Rowan returns).
...
### Ch 5 — The Field That Counts *(Eli · Vietnam Mekong Delta agricultural stop)*
...
### Ch 6 — Midpoint: First Witness *(Eli · first witness site — Mekong Delta approach)*
...
### Ch 7 — The Forming Line *(Eli · Mekong Delta rice/aquaculture cooperative)*
...
- **Choice → Cost:** Eli tries to save both the people and the cleanest agricultural evidence. The charge turns competence into command; he recognizes the autopilot but cannot yet stop it. **Wren makes the humane choice for him**, forcing the evacuation while he hesitates over the record. A named grower is injured and the clean documentation is damaged. Eli leaves the Delta with less proof, guilt over the delay, and no private victory to hide behind.
...
- **Choice → Cost (VOLUME I CLIMAX):** the charge offers Eli the same bargain as Mekong, now with Emrys and the complete interface record on the scale. This time he **feels the charge, recognizes the autopilot, and refuses to let conditioning complete the act**: he protects civilians / companions and **sacrifices the complete interface record** rather than chase Emrys's captors or seize the founding read. Cost: **Emrys is taken**; partial plaquette/fox-pillar clarification only; pursuit continues west without him. Göbekli is the first completed personal Manual Override.
...
- **Romance cost (LOCK — rupture):** **Trust break** — Eli blames Wren's route or she says *I told you* when **Emrys is taken**. Operational cold shoulder into Vol II Ch 1. Union debt deferred to late Vol II (`19`).
...
**Mekong Delta (Ch 5–10) — LOCKED, not climax:** substantial agricultural-witness sequence — forming ley line, Ila midpoint, incomplete recognition of autopilot, and Wren's forced humane choice while Eli hesitates over **agricultural** evidence. Vietnam / Thailand / Bangladesh hinges per route lock (`99` Priority 1). Dioxin/history treatment unchanged in chapter quarry above.
...
| **2** | Mei/Suresh/harbor network carry Eli from Pelangi Reach through Meridian City to Hassan | Processing language becomes a body-register; Custodians hunt activation under biosecurity cover | **Two models collide in one flight** — human web gets him to the ring; registry logic drives him underwater; receiver opens |
| **3–4** | Wren folds him into harbor extraction; Emrys breath/inner ring = **keeper grounding** | Post-breach overload — body never got Union suppression *or* full Coalition completion | Eli learns regulation, not cure; Wren's network pays for carrying him |
...
- **Eli:** hid puberty in keeper net; fears **Fractured** file-language (`26`); somatic read = gift **Union would sedate**. Arc: from "earn safety by usefulness" → recognition at Mekong → completed Manual Override at Göbekli.
- **Wren:** official hunter, secret **route-runner** — her network *is* threshold-house logic at operational scale. Vol I cost: burning the net to save flare-boy.
...
- **Emrys:** measures signatures (Union instrumentality) but teaches **grounding** (Coalition keeper way) — his error at **Göbekli (Ch 13)** = map over territory; **taken** same beat.

### Vol II–III payoffs (plant in Vol I, pay later)

| Plant (Vol I) | Payoff |
|---|---|
| Song / rhythm / breath | The tune survives copying; Thailand's keeper stilt-house joins the grounding chain without restoring the retired Khun Dang/guitar route |
...
Meridian City archive, clinical corridors, **cure framing** — not punitive Fractured excision. Vol II Mesopotamian leg: state medicine vs harbor keepers.
...
- Precise Act II geography (Meridian City archive; Thailand grounding interval and Vietnam Mekong staging) and which leg carries the planted/false clue.
...
| 13 | **LOCK — rupture** | Emrys taken; trust break; cold shoulder into Vol II | Eli can grieve, disagree, and remain himself; Wren's hurt becomes visible but is not repaired or operationalized |
...
| 13 | Cold shoulder; unreadable hurt | Emrys taken / blame | Rupture; no comfort |
