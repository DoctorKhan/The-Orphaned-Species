...
> **Inciting catastrophe — LOCKED 2026-07-26 (rev. Z):** **not a staged attack or explosion.** Babaji's cell **refused transfer** of a flagged carrier at the causeway and **moved suppressed archive copy** (Cherry Cube / Maren evidence chain) off Mandate soil. The **Eastern Mandate** responds with **administrative strangulation**: corridor logistics freeze, extended-assessment sweep, cohort registry, causeway hold. Eli **holds a sabotaged line through a near-miss on the water** → Suresh awards him the Cherry Cube weekend manifest (**cash**, Shireen clinic wire); after the squeeze he **leaves on schedule** — hearth suspended, island locked down behind him. The **hunt begins at Singapore intake/concert**, not a Pelangi resort chase (kiddy-car sequence retired to quarry). Pelangi occupied and fragmented, not burned.
...
> **Volume I dramatic questions — REVISED 2026-08-15:** **Lived:** *Can he stay with what arises long enough for the inverse to form?* **Surface:** *Can he stay clear-headed enough under pursuit to decide whom to trust?* One question at two depths — `67_book_i_learning_adventure.md`. The registry, the ring, and the father remain the theater; the book the reader lives is learning and adventure.
...
- **Three offers — LOCKED rev. Z; race removed 2026-08-12:** Suresh's Cherry Cube manifest, awarded for holding a sabotaged line through a near-miss, not a wager; Babaji sponsor papers (via Wren); cohort vs worker lane.
...
- **Cherry Cube concert — LOCKED (rev. C — jacket + dance recognition, 2026-07-30):** a fictional K-pop-scale idol performs on a mall floor above the circuit during **Singapore Circuit** race night. **Eli's contract is Cherry Cube show crew** — stage/wardrobe/AV facilities for the set and afterparty; he reaches the Cube **from below**, late and off-gate, on the call sheet but hunted. The star knew Maren as a child/young subject of her early protective-integration work **at the sealed annex connected to the Cube itself** (`59_younger_dryas_nucleation_lock.md` § *Same site as Maren's early work* — not sayable on-page until Book III); she helped him survive an episode and refused to let the program classify him as property.
  **The exterior contact — LOCKED 2026-08-06:** before the wardrobe chaos, one quiet paragraph while Eli moves a freight case along the service perimeter, directly against the Cube's outer shell — closer than the highest-paying pilgrim ring ever gets. Sensory only, no explanation: a wrongness in how the light moves across the surface, a temperature that doesn't match the air around it, a sound under the crowd-sound that isn't quite silence. His body wants to walk the counter-clockwise direction even off the marked route, the way the whole Tower's circulation has been trained into every worker who's ever pushed a cart through it. He doesn't know he's touching what pilgrims spend a decade's wages to stand a ring farther back from (`95_glossary.md` § *Pilgrim rings*); the irony is never stated on-page.
...
- **Eli:** hid puberty in keeper net; fears **Fractured** file-language (`26`); trajectory read = gift **Union would sedate**. Arc: from "earn safety by usefulness" → recognition at Thailand → completed Manual Override at Göbekli.
