...
> **ROOTBOOK — REVISED AND LOCKED 2026-08-10:** Singapore/Malacca yields seven damaged scans from Maren's comparative field journal after the ring and human witness establish the emotional trail. The physical **শব্দজাল** (*Shabdajal / Word-Web*) remains in the Thai cooperative's custody, where it arrived with Ila's field record and accumulated local corrections. After the evacuation, the cooperative sends it north under seal while retaining ownership of its pages and copies. Eli privately calls it the Rootbook. It opens bounded tests and never supplies the whole pilgrimage. Full design: `52_the_rootbook_word_web.md`.
...
- **Ch 1 — Pelangi Reach:** **Friday AM** race (Eli vs Kiran; Suresh holds wager); **Friday PM** Mei dinner opens with both racers, then **private orphan truth** after Kiran leaves (only send-off). **Saturday AM** Babaji's **hotel** — lobby robot dog + automatic chess boards, private upper floor (decaying resort bones, not lavish life) — **first meet Wren** (handler through Singapore); Babaji's catamaran is now solely his own Saturday PM southbound departure, relocated from the meeting 2026-08-07. **Saturday PM** Wren at marina **before** checkpoint → aboard Suresh → squeeze → **raid on Babaji offices** as Eli departs **last light**. **No packet. No Priya. Wren ≠ Mei.**
...
- **Timeline — REVISED 2026-08-11:** **Thursday night** — Eli sleeps in Rasel's garden (**referenced only**). **Friday AM** — Mei warns him that boats are being turned back and Suresh has one Saturday berth tied to the Singapore job; **morning skiff race** against Kiran (**Eli wins**; Suresh's wager → Cherry Cube manifest + berth). **Friday PM** — **Mei dinner** with both racers; Kiran leaves; private orphan truth explains why she pushed Eli to go, only send-off. **Saturday AM** — Babaji's **hotel** (interior — relocated 2026-08-07 from the catamaran, which is now reserved for Babaji's own Saturday PM southbound departure), **first meet Wren**, papers + handler line. **Saturday PM** — squeeze; Wren at marina **before** gate; raid on Babaji offices as Suresh casts off **last light**.
...
- **Ambiguous sabotage — LOCKED 2026-08-07.** During the race's tight inside-line push along the floats, a rigging line lets go at the worst possible moment — Eli fights the boat and the failing gear at once; **"Now! Hold it!"** does double duty as Suresh's race call and the literal thing Eli has to do with his hands. He wins anyway, on the same skill already established, but it costs a rope-burned palm and adrenaline that doesn't fully explain itself. Back at the marina, Suresh finds the frayed end and it is a little too clean — not chewed, not salt-rotted. He says one flat thing and no more: *"That's not chew. That's not salt-rot either."* Nobody names a cause. **Never confirmed on-page, this book or later** — a permanent dead-end thread, same discipline as the mother's-clue chain's deliberately unresolved clues (`37_deep_time_source.md`). **Do not** let this read as the hunt beginning at Pelangi or connect it to the Saturday raid, which stays entirely Babaji's cell's own causation (§ *Inciting catastrophe* above) — this is a separate, coincidental near-miss. **Author-side ground truth only, never stated on-page (same treatment as the Charkha-under-Mandate's-face rule):** a dormant watch-flag from the old family case happened to ping off Eli's name touching real paperwork for the first time in years (the contractor sleeve, the loading slate) via Suresh's wager; one low-level local asset made a clumsy, deniable attempt to stop him from leaving, not to hurt him — killing an unconfirmed match in a small harbor community is a bad trade for someone that low in a chain, so the rational move is delay, not violence. It does not escalate and is never confirmed.
...
- **Extras seed — LOCKED 2026-07-28:** at the causeway hall, an unsponsored man with a valid pump-repair certificate is diverted under the official label **UNSPONSORED MALE / LOWER CONCOURSE**. A waiting civilian calls it the *Extra lane*. Eli sees the man treated as dangerous before he does anything dangerous. One use only; no explanation or subplot in Book I.
...
- The Singapore archive leak supplies seven damaged Rootbook scans; Babaji's
...
- **Deep-time residue — REVISED 2026-08-10:** Ila's copied ground record confirms what the growers already know: the new line through planted ground is a living system they must tend. The physical Rootbook remains in their custody. She mapped the ground; Eli is learning to read it.
...
|- **Revelation:** **community knowledge preserves the next clue** — Kitt's maps reveal a fork; the cooperative reveals the physical Rootbook and sends it north under seal. Its citation wakes the conservation checksum and Rasel's current handshake. **Forward clue:** Rasel was alive four days ago inside the Sanxingdui research relationship. Recognition remains provisional until the receipt and identity are independently verified.
