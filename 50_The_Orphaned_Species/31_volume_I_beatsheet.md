...
> **Maren's field notebook — REVISED AND LOCKED 2026-08-10:** Singapore/Malacca yields seven damaged scans from Maren's comparative field journal after the ring and human witness establish the emotional trail. The physical **শব্দজাল** (*Shabdajal / Word-Web*) remains in the Thai cooperative's custody, where it arrived with Ila's field record and accumulated local corrections. After the evacuation, the cooperative sends it north under seal while retaining ownership of its pages and copies. Eli privately calls it Maren's field notebook. It opens bounded tests and never supplies the whole pilgrimage. Full design: `52_maren_holts_field_notebook.md`.

> **Ambiguous-loss reveal — REVISED AND LOCKED 2026-08-11:** Eli remembers the family's flight as a holiday. His parents leave him at Mei's for what they promise will be one night, take their travel bags toward a rendezvous, and never return. Mei knows they never reached the guide; she has no witness to an arrest, vehicles, or death. Babaji closes the parents' file as dead so the search does not remain attached to Eli. Mei tells him this at Friday dinner. The Malacca intake photograph proves Rasel survived the disappearance years ago. Thailand supplies the first current trace: a four-day-old maintenance handshake bearing Rasel's initials and watering count. Sanxingdui supplies visual confirmation and reunion. Rasel admits he was taken before reaching the rendezvous and later chose to remain in the Mandate program. He then reports that Maren was alive two winters earlier, leaving her present condition open for Book II.

> **Opening order — LOCKED 2026-07-27:** Ch 1—race / orphan truth / Babaji /
> departure. Ch 2—Singapore / Cube / Malacca breach. Ch 3—aftermath and choice.
> **No Wren extraction POV or Laleh chapter.** Ch 4 begins the maritime/Thailand
> movement. Ch 11–13: northbound route / Sanxingdui / Rasel aftermath.

### Current opening cards — authoritative order

- **Ch 1 — Pelangi Reach:** **Friday AM** solo sail, sabotaged sheet, near-miss with Timah/Jul, Kiran capsizes on his own mistake, Suresh awards the berth to Eli on witnessed competence as a verdict over Kiran—Kiran witnesses the award, and his resentment becomes a standing debt he intends to settle; **Friday PM** Mei dinner, then **private orphan truth** after Kiran leaves (only send-off). **Saturday AM** Babaji's **hotel** — lobby robot dog + automatic chess boards, private upper floor (decaying resort bones, not lavish life) — **first meet Wren** (handler through Singapore); Babaji's catamaran is now solely his own Saturday PM southbound departure, relocated from the meeting 2026-08-07. **Saturday PM** Wren at marina **before** checkpoint → aboard Suresh → squeeze → **raid on Babaji offices** as Eli departs **last light**. **No packet. No Priya. Wren ≠ Mei.**
- **Ch 2 — Checkpoints → Singapore → Malacca breach:** **Saturday PM–eve:** **Wren escorts** marina gate → strait pier → pier arch → port shuttle → transit → buses → **causeway hall**; wrong-room overhear; **peels off at document lanes**; clerk → ring photograph → wage ticket → **Continue Inn**. **Sunday:** Cherry Lane toward **Circuit yards** → race traffic and sealed streets pour him **closer and closer to Cherry Cube** (spectacle, not his call) → concert floor he did not choose → closet as boxed fallback → tire-truck escape → Straits → Malacca breach.
- **Ch 3 — What Didn't Die:** Salmah pulls Eli back; Hassan and the ring are
  ...
  Babaji's legitimate fallback contacts to find and receive him, then gives him a
  consequential choice: disappear if he still can, or follow the exposed trail.
- **Ch 4 — The Passage:** maritime departure forces a first shared cost. Local
...
> receiver activation → Custodian pursuit → Thailand agricultural witness and
> grounding → Sanxingdui. No Wren extraction light-cross.

> **Route lock — Singapore detour:** the direct northward land corridor from Pelangi Reach toward Malacca is blocked by Mandate corridor holds and competing authorities. Eli **holds a sabotaged line through a near-miss with Timah's harvest boat**, and Suresh, watching from the wall, **awards** him the **Singapore Circuit freight / marshalling** job (**cash**; Shireen remittance — why he had to hold it; **stay off the Cube**) when the sweep forces flight. Escape goes south through **Singapore / Singapore**, the Eastern Mandate's de facto administrative and maritime capital — high-surveillance, unforgiving clinical order, the only safe harbor in the straits. Singapore remains the ordinary local name; *Singapore* is the Mandate's official designation; residents call the vertical institutional city **the Stack**. The capital coordinates the bloc but does not contain all Mandate power: security, industry, energy, and launch capacity remain distributed elsewhere. The northern land route is closed, the Union is south, the open sea is nowhere; Singapore is the only place the breaker-net can reach him. From there he must book north by sea to Malacca. Its atomized order is the counterpoint to Malacca's plural social ecology. The archive encounter happens during this transit: translation, classification, and logistics are nearly perfect while relationship remains thin.

> **Singapore maze / Harbor Thread — LOCKED 2026-07-24 (rev. B):** Singapore cannot be navigated by an outsider using official maps. Eli moves through **the Harbor Thread** (*the Thread* in street speech) — underground, **accepted but not spoken**; Weavers' **polite blindness**. Sorts **front posts** (spending leadership — CEO as dangerous occupation) as well as maze segments. Construction worker → partial shaft; cleaner, cook, mechanic → corrections. Each person one segment; exposure priced. **Home tongue opens** (show in dialogue — do not narrate ethnicity); never auto-trust. **Eli:** learned tongue/culture from **parents**, not Thread initiation — overlap is **useful**, not membership.
...
> **Weavers — LOCKED 2026-07-27:** Wren is a house Weaver doing junior Knotter
> work. Book I shows local civic acts—attestation, placement, food, waiting rooms,
> household connection—not covert extraction. Wren guides Singapore. Rowan does
> not appear or secretly route the group there; her west-corridor Weft enters in
> Book II.

> **Babaji — LOCKED 2026-07-24:** refuge patron, robot dogs, chess boards. `26` § Babaji.
> **Inciting catastrophe — LOCKED 2026-07-26 (rev. Z):** **not a staged attack or explosion.** Babaji's cell **refused transfer** of a flagged carrier at the causeway and **moved suppressed archive copy** (Cherry Cube / Maren evidence chain) off Mandate soil. The **Eastern Mandate** responds with **administrative strangulation**: corridor logistics freeze, extended-assessment sweep, cohort registry, causeway hold. Eli **holds a sabotaged line through a near-miss on the water** → Suresh awards him Circuit freight / marshalling (**cash**, Shireen clinic wire; stay off the Cube); after the squeeze he **leaves on schedule** — hearth suspended, island locked down behind him. The **hunt begins at Singapore intake**; the Cube is where race traffic dumps him, not a check-in. Pelangi kiddy-car chase retired to quarry. Pelangi occupied and fragmented, not burned.
> **Mei's arrest — LOCKED 2026-07-29:** the flagged carrier Babaji's cell refused to hand over had eaten at Mei's table — the same **free-meal list** she keeps without asking who's on it (`413` below). The extended-assessment sweep's cohort registry surfaces the link; she is taken in the same action as the raid on Babaji's offices, not as a conspirator but as someone the registry cannot distinguish from one. Eli learns it in passing — a shuttered terrace, a name Suresh won't repeat, not a witnessed arrest — while he is already committed to leaving on schedule and can do nothing about it. This is what "hearth suspended" costs specifically: the same unconditional hospitality that gave him the orphan truth over dinner is the thing that gets her taken. Residue only — no dramatized arrest scene, no on-page interrogation.

> **Volume I route lock — LOCKED 2026-07-23; learning subject 2026-08-15:** **Thailand** carries the substantial living-evidence sequence — river-valley rice/aquaculture cooperative, keeper stilt-house network, Khun Dang → wat → Pai pass-through grounding, forming ley line, Ila midpoint, stay-with / afterimage stack (`67`), and Wren's forced humane choice while Eli hesitates over **agricultural** evidence. **Cube-grounded visionary threshold (Delphic Games / Laurel Cube) — Book II only.** **Bangladesh — OFF-PAGE:** Shireen's encrypted messages only; no visit. From a **Bay of Bengal / Andaman** maritime corridor, the route enters the Gulf and Mesopotamia, then travels north through contested land routes to Şanlıurfa/Göbekli. **Mekong/Vietnam retired** — `manuscripts/I_The_Breach.md` Ch 5–10 is quarry, not spine.

> **AGENCY PACING — LOCKED 2026-08-15:** one loss, one return (`68` § *Pacing*). **Take away:** Malacca. **Return:** Thailand wat + Kru Dao as *one* stack, not two subjects. **Fail the return:** Sanxingdui mask (sweet needle). Ch 9 spends the stack on civilians; it is not a second return. No chapter exists to re-explain the candle. `67`, `68`.
>
> **Volume I dramatic questions — REVISED 2026-08-15:** **Lived:** *Can he keep the place from which he can still engage?* **Surface:** *Can he stay clear-headed enough under pursuit to decide whom to trust?* One question at two depths — `67`, `68`. The registry, the ring, and the father remain the theater.
> **Internal movement:** overload → usable stack → first peace that is not dissociation → father-ask he cannot hold. **Ending change:** Eli has a wat/afterimage stack he can run under pursuit; he has met a practitioner **as other**; he recognizes personal Manual Override and **fails it against Rasel's ask** (mask on, then he leaves). He follows the next clue west with a technique in his pocket and a regret he cannot yet size. Göbekli / relational hold belong to Book II.
> **Reveal discipline:** effects before terminology; human stakes before cosmic claims; no two cosmological answers in one chapter. **Life-tech spine:** each act owes at least one Life beat and one Knowledge beat toward eventual Two Trees reunification — `22_life_technology_and_two_trees_spine.md`. **Character development:** each chapter should advance at least one fellowship arc or Eli perceptual stage — proof scenes and Vol I checklist in `27_character_development_arcs.md`. **Past-vs-mask leaks:** one habit/object beat per major character, no exposition — `26` Part V. **Romance cost:** trust must move **up or down** on the page — § *Romance cost audit* below. **M/I/A (Wren):** **M**ystery · **I**ntrigue · **A**ttraction per Eli/Wren chapter — § *M/I/A audit* below; hub `19` § *Female mystery, intrigue, and attraction*. **Story-first resonance:** make Pelangi Reach desirable, keep the Vol I dramatic question clear, and escalate pursuit causally. Countdown and recurring-object devices remain optional — `44`.

> **POV — LOCKED 2026-07-27:** Eli governs every Book I scene. The retired
> Wren/Laleh extraction is not a POV exception.

> **Malacca civic seed — LOCKED:** Eli encounters the older maritime lesson that Malacca's power came from making difference usable: safe harbor, predictable port law, multilingual administration, seasonal cooperation, diplomatic recognition, trade advantage, and enough deterrence to make destruction less profitable. This is not a war-free Chinese empire or a single-culture achievement; Malay, Chinese, Indian, Arab, and other communities co-created the entrepôt. The lesson is **peace as infrastructure**, and it foreshadows the Hawaiʻi federation and the Continental Union's competing models of coordination.
>
> **NO-CLOCK SCENE — LOCKED 2026-08-06:** one scene in Vol I where neither clock advances and no clue moves — Eli and Wren simply exist together and enjoy it. Recommended placement: Ch 4 passage (a watch exchange with nothing to watch) or the Thailand stilt-house stretch (food, a joke, an idle hour while weather holds). The scene must end without interruption — the chase resumes after, not during. This is the sanctuary principle paid in full (`19` § Buildup 3), not a beat among beats: the reader must want one quiet week for them before the book is allowed to take anything.

> **Unthematic beat — LOCKED 2026-08-16:** every chapter also contains one stretch a thesis annotator cannot file as Circle / orphan / cage without cheating — a meal, a stupid complaint, a repair, a nap, a joke that does not mean Two Trees. If you can write the theme in the margin, rewrite the beat. The Ch 4 no-clock scene may count for that chapter. Ch 10's standing meal and kingfisher already count if left un-sermoned.

| Ch | Unthematic stretch on-page |
|---|---|
| 1 | Dock gossip about Timah; Mei knocks a coconut |
| 2 | Glass too hot; boy poles a skiff wrong |
| 3 | Keeper's lamp: kerosene cut with water |
| 4 | Monitor lizard on the plank; roasted peanuts |
| 5 | Red truck on the hairpin; monk smokes |
| 6 | Water monitor; tea too sweet |
| 7 | Wren hops the sluice; district-form joke |
| 8 | Jackfruit on the clinic roof; bicycle peanuts |
| 9 | Shear-pin joke; chili too hot |
| 10 | Standing meal; kingfisher misses |
| 11 | Fan motor on order; noodle-stall lunch |
| 12 | Toddler at a gutter; sweet-potato cart |
| 13 | Football argument; Wren burns her mouth |

---

## Book I residue → next — LOCKED 2026-08-16

Every listed fossil must spend something in the following chapter (`17` § *Tomorrow test*).

| Ch | Residue on-page | Next-chapter job |
|---|---|---|
| 1 | Garden vs Foundry cables; Mei's baby-Singapore aside; missing-cohort court | Ch 2 Free-man condition reads as vacated standing, not spectacle |
| 2 | Free-man condition; shell contact; Maren grounding gesture | Ch 3 grounding is how Wren finds him |
| 3 | Three Circles clay (wrong-first); kelong cup-count; notebook *Name* page | Ch 4 disclosed route; tablet travels as freight not doctrine |
| 4 | Pak Din "loud ones"; named stops | Ch 5 those named people can burn if they linger |
| 5 | Living field / not-for-sale mountain | Ch 6 confluence forced; coast exit already refused |
| 6 | Stone / Ila witness | Ch 7 west block is forced geography |
| 7 | Forming line; dual teams | Ch 8 wounded civilians + health fax |
| 8 | Bleed-read; clinic | Ch 9 battle cannot be quiet science |
| 9 | Burned record; pump house | Ch 10 leaves with half-series only |
...
If you cannot name the human and the Friday, the chapter has no antagonist. Not "the Charkha." Not "the system."

| Ch | Human | This week's job |
|---|---|---|
| 1 | Mandate cohort registrar on the Saturday list | Close the list and clear Babaji's offices before last light |
| 2 | Causeway document clerk; **Sora Vithan** | File Eli as a loose end; keep the Circuit hunt live through Sunday |
| 3 | Custodian boarding lead on Hassan's pier | Reclaim Hassan and the ring before the tow window closes |
| 4 | Gray-launch skipper; **Ros** at the drying racks | Catch the named northbound stops Wren spoke aloud |
| 5 | Custodian boat lead on the valley water | Quarantine-claim the living field before the growers move |
| 6 | Fuel-seller's drone contact (timestamp before dark) | Time the band so a team can own the stone |
| 7 | Custodian lead **and** northern soil-buyer | Own the forming-line record before the other does |
| 8 | District health clerk at Niran's clinic | Turn the admission into a registry fax before morning |
| 9 | Both field leads | Break the formation and take the clean record tonight |
| 10 | Pursuit lead still on the water | Keep the half-copy from leaving the landing |
| 11 | **Anika Voss**; **Dara Phommasone**'s permit clock | Get a clean voluntary scan before the annex moves Rasel |
...
- **Timeline — REVISED 2026-08-11:** **Thursday night** — Eli sleeps in Rasel's garden (**referenced only**). **Friday AM** — Mei warns him that boats are being turned back and Suresh has one Saturday berth riding on how Eli handles the water; **solo morning sail, sabotaged sheet, near-miss with Timah/Jul** (Kiran capsizes on his own mistake while rushing to help; Suresh awards Circuit freight / marshalling + berth to Eli on witnessed competence as a verdict over Kiran—Kiran witnesses the award, and his resentment becomes a standing debt he intends to settle). **Friday PM** — **Mei dinner**; Kiran leaves; private orphan truth explains why she pushed Eli to go, only send-off. **Saturday AM** — Babaji's **hotel** (interior — relocated 2026-08-07 from the catamaran, which is now reserved for Babaji's own Saturday PM southbound departure), **first meet Wren**, papers + handler line. **Saturday PM** — squeeze; Wren at marina **before** gate; raid on Babaji offices as Suresh casts off **last light**.
...
- **Ambiguous-loss reveal:** **Mei, Friday dinner** — the supposed family holiday was a flight. Eli's parents left him with Mei for one night and carried their bags toward a rendezvous they never reached. No one on the Reach witnessed an arrest or found a body. Babaji filed them as dead to break the link to Eli. Mei turns the family photograph face-down and offers no document, destination, or promise. **Locked Mei prose — LOCKED 2026-08-21:** *"I told you what a child could carry. I don't know whether I was right. I only know I couldn't give you the rest then."* Her hand rests on the table, not reaching for him. *"The harbor office is asking about old families again. You take Suresh's boat tomorrow night. Whatever that costs."*
- **Deep-time residue — REVISED 2026-08-11:** (1) Rasel's garden as reception-without-mastery / living craft vs Foundry cables; (2) missing-cohort texture — empty kid infrastructure or older work crew visible without lecture; (3) the face-down family photograph and Mei's account of the drop-off. Wrong reading: the packed bags prove Eli was abandoned. Cost: he leaves the living plot for Stack cash without knowing whether it is a memorial.
- **Mei's Cherry Cube seed — LOCKED 2026-07-30:** in the same dinner conversation, Mei adds one small, warm, undertechnical detail: his mother had work in Singapore sometimes, and once brought him along as a baby. She doesn't know more than that — a kitchen-table fact, not a lead, and Eli doesn't treat it as one. **Reads as pure grief-color in Book I; detonates in Book III** when the Cherry Cube's research annex is revealed (`59_younger_dryas_nucleation_lock.md`) and this offhand line turns out to be load-bearing — it's the same site where the idol's Ch 2 debt to Maren was earned, though nothing in Book I connects the two. Do not let Mei know or imply anything about the annex — she genuinely knows only the fact, not its meaning.
- **Ambiguous sabotage — LOCKED 2026-08-07; race removed 2026-08-12.** Eli is sailing alone along the wall-shadow lane he runs most mornings when a rigging line lets go at the worst possible moment, just as Timah and Jul's harvest boat drifts into it — Eli fights the boat and the failing gear at once; **"Now! Hold it!"** does double duty as Suresh's command from the wall and the literal thing Eli has to do with his hands. He holds it anyway, on the same skill already established, but it costs a rope-burned palm and adrenaline that doesn't fully explain itself. Back at the marina, Suresh finds the frayed end and it is a little too clean — not chewed, not salt-rotted. He says one flat thing and no more: *"That's not chew. That's not salt-rot either."* Nobody names a cause. Suresh awards Eli the Cherry Cube job on the spot, for what he watched him do with a failing line and a child in the water, not for beating Kiran. **Never confirmed on-page, this book or later** — a permanent dead-end thread, same discipline as the mother's-clue chain's deliberately unresolved clues (`37_deep_time_source.md`). **Do not** let this read as the hunt beginning at Pelangi or connect it to the Saturday raid, which stays entirely Babaji's cell's own causation (§ *Inciting catastrophe* above) — this is a separate, coincidental near-miss. **Author-side ground truth only, never stated on-page (same treatment as the Charkha-under-Mandate's-face rule) — REVISED 2026-08-12:** the frayed sheet is Rasel's doing, not a Mandate watch-flag. It is the first debt in the harbor-debt trail he commits as Eli moves toward Sanxingdui (`58_sanxingdui_climax_lock.md` § *Harbor-debt trail*) — a crude, deniable read on how his son handles real pressure, run through a local hand who has owed Rasel since before the abduction, before Rasel commits the rest of the chain to a son he has not yet confirmed is ready. Not meant to harm: a cut fine enough to fail, not to drown anyone. It does not escalate and is never confirmed.
- **Mei's reveal gets a proximate trigger — LOCKED 2026-08-07.** Word of the suspicious line reaches Mei before dinner (Suresh mentions it, or harbor gossip carries it) — this sharpens, but does not replace, her existing motivation for telling Eli the truth that night. Her "the reach is getting narrow" now has something concrete underneath it from that same day, without her knowing what actually happened or why.
- **Three offers — LOCKED rev. Z; race removed 2026-08-12; Cube not the job 2026-08-16:** Suresh's Circuit freight / marshalling, awarded for holding a sabotaged line through a near-miss, not a wager; Babaji sponsor papers (via Wren); cohort vs worker lane. Cube is spectacle the weekend dumps him into.
- **Parent memory — REVISED AND LOCKED 2026-08-11 (three-phase):** Mei leads with the harbor-office threat and the need for Eli to sail. His questions draw out the old file, Babaji's false death entry, and the truth that the family holiday was a flight. The file triggers the last-drop-off memory: his canvas bag under Mei's chair, his parents' larger bags at Rasel's feet, Maren's palm on his sternum, Rasel's hand at his neck, and a promise to return. Mei saw the bags, their worry, and their promise to come back; she did not ask where they were going and cannot say what happened after they failed to return. In Ch 11 Eli gives the storm-room memory to Shireen, who remembers relatives remembering his parents more clearly than she remembers the people. Thailand's current handshake converts uncertainty into a rescue clock for Rasel. Maren remains unresolved until Rasel's two-winters-old note.
- **Parent-domain split — LOCKED 2026-08-08, revised 2026-08-08.** Rasel's domain is the **garden**, exclusively — *ask the plant, don't grab it*, thumb-and-forefinger at the base, not the leaf. Sailing belongs to neither parent: **Suresh** taught Eli to sail (tiller, pump, placement, every dinghy lesson, this same fairway) — grounded in the fact that he's the one actually present daily, while Maren was already committed to her chosen position before Eli was old enough to be at a tiller (consistent with Book II Ch 10's "I have been exactly where I chose to be since before..." line). New backstory, logged as canon: **Suresh also once taught Maren to sail**, decades earlier — so his "the same one your mother would have" read on Eli's trance is a direct, twice-witnessed comparison, not a secondhand guess. Any stray memory-image crossing a parent into the wrong domain (e.g., a "hand on the tiller" attributed to Rasel) is a continuity error. Ch 1 race scene (tiller lessons now Suresh's) and the Hassan/ring flash in Ch 2 (father's hand now over a stem, not a tiller) both corrected. **Cross-book fix:** Book II Ch 10's Maren line changed from "...since before your father's hands were the ones you remember on a tiller" to "...on a tiller" → "...teaching you which stem to pinch," keeping Rasel as the time-anchor without the false sailing association (`II_The_Descent.md:7485`).
- **Timah/Jul obstruction moved to Eli — LOCKED 2026-08-08.** The near-collision with Timah's drifted harvest boat and Jul surfacing now happens in **Eli's own chosen lane**, not Kiran's — he has to give up distance to avoid the boy while the frayed sheet is failing in the same hand, compounding the two hazards instead of stacking three. Kiran now loses straight-up: he overcorrects chasing the returning breeze and capsizes on his own mistake (preserves the Ch1 Mei-dinner "Timah pulled my boat over" tall tale — now a transparent, funnier lie rather than a garbled true account — and the "soaked to the scalp"/"one for the swimmer" material downstream). Suresh's post-race line changed from "don't thank the grandmother, she wasn't helping you" to "don't blame the grandmother either — she wasn't in your way, you were in hers," consistent with the dock argument later in the scene about who owed whom a clear fairway. Restored Jul's pre-crisis diving image (dropped during the rewrite, now reads "surfacing wherever the game takes him, with no more sense of the race than his grandmother has") so the near-miss is properly foreshadowed. Also de-duplicated the two Suresh-teaching memories in the wind-pocket recovery: the first (panic-calming voice) is now unnamed instinct, the second (tiller lessons) is the one that names him and carries the sensory detail.
- **The race-scene absorption state — LOCKED 2026-08-08.** The wind-pocket sequence in Ch 1 (the "grand orchestra"/supreme-peace passage) is **samadhi** — a meditative absorption state, not a psionic activation. It stays unnamed on the page (felt, not explained) and is explicitly **not** the Malacca breach; Malacca remains Eli's first talent activation, untrained and overwhelming, per the existing lock. Whether Eli's version is inherited from Maren or simply his own is left open on the page — Eli's own reaction after the race states this ambiguity directly rather than confirming inheritance.
...
- **Singapore / Malacca — LOCKED 2026-07-24 (rev. C):** **No Thailand body memory** before Ch 5. Ch 2: **Maren grounding gesture** at Cube overload; **receiver activations** (palms, flags, strait, *lit up*) — **talents activate, not trained**. **No martial foreshadow.** Malacca fight = **untrained** → asphyxia → receiver **ON without control**.
- **Deep-time residue — LOCKED 2026-07-30:** (1) Stray-lane as fossil of discarded male standing; (2) Cube managed eternal cherry bloom vs Pelangi volunteer trees — engineered Life without Wild; (3) bodily surge toward stage/gantry before meaning. Wrong reading: Stray man = criminal; Cube = paradise; surge = destiny. Cost: wage ticket; receiver opens without control.
- **Want:** reach Circuit marshalling and get out; survive intake; learn why a Mandate
...
- **Movement 1b — Singapore approach (with Wren):** port shuttle → transit gantry → buses (Wren picks routes; no mall-lost beat) → **causeway hall**.
- **Stray men seed — LOCKED 2026-07-28:** at the causeway hall, an unsponsored man with a valid pump-repair certificate is diverted under the official label **UNSPONSORED MALE / LOWER CONCOURSE**. A waiting civilian calls him *Stray*. Eli sees the man treated as dangerous before he does anything dangerous. One use only; no explanation or subplot in Book I.
- **Movement 2 — Singapore intake (Saturday eve):** epic Stack reveal; document clerk; Cherry Cube archive packet; ring photograph; wage-ticket cost to escape classification; **Continue Inn** check-in — arcade tier, **live-play** cabinets/sims/VR (Foundry muscle rhyme; Rasel echo).
...
- **Commissioner Ma seed — light, not a reveal:** a convoy seal, shipping notice, or worker's complaint carries Ma's public designation. The same logistics office once kept medicine or desalination parts moving and now enforces a damaging restriction. Eli registers infrastructure, not a future ally; the detail earns Ma's Book III arrival without softening Singapore's clinical pressure (`51_field_sail_and_mandate_peace.md`).
- **Movement 3 — the Singapore Circuit escape:** a scheduled Formula One–scale
  street race seals the avenues. Wren is at the convoy edge because Babaji's
  intake/travel job put her there; she refuses to acknowledge Eli under
...
- **Cherry Cube concert — LOCKED (rev. C — jacket + dance recognition, 2026-07-30):** a fictional K-pop-scale idol performs on a mall floor above the circuit during **Singapore Circuit** race night. **Eli's contract is Circuit freight / marshalling.** He was not going to the Cube. Race traffic and sealed streets pour him closer until he is against the shell and then inside; he reaches the floor **from below**, late, **not on the Cube list**, hunted. The star knew Maren as a child/young subject of her early protective-integration work **at the sealed annex connected to the Cube itself** (`59_younger_dryas_nucleation_lock.md` § *Same site as Maren's early work* — not sayable on-page until Book III); she helped him survive an episode and refused to let the program classify him as property.
  **The exterior contact — LOCKED 2026-08-06; ON-PAGE 2026-08-16:** before the wardrobe chaos, one quiet paragraph while Eli moves a freight case along the service perimeter, directly against the Cube's outer shell — closer than the highest-paying pilgrim ring ever gets. Sensory only, no explanation: a wrongness in how the light moves across the surface, a temperature that doesn't match the air around it, a sound under the crowd-sound that isn't quite silence. Heat at the base of the spine; later, in the concert clap, a hand he cannot see. The alcove litany stays the crew's anti-chant, not a gift ritual (`59` § *The contact moment*). Irony never stated on-page. Drafted: `I_The_Breach.md` Ch 2.
  ...
  **The ceremony, then the stage — LOCKED 2026-08-16:** the Cube's public rite (counter-clockwise ring, two-syllable chant, too-clean clap) **pulls him in** — hands on his elbows, he cannot step out. That spiral delivers him to the stage lip. The star, seeing a stranger in the jacket about to be taken by security, **pulls him into the number**. Nobody questions a man who is clearly supposed to be up there. Recognition mid-routine. Closet after, in wardrobe, while the encore holds security.
...
- **Movement 4 — witness collision:** in reopening Malacca, Hassan's physical
  ...
  foul the handoff. Wren has no parallel extraction.
...
- **Choice → Cost:** Eli **left Pelangi on schedule**; at Singapore he **chooses forward** after the ring photograph rather than disappearing into the worker flow. Wrong-room eavesdropping **pre-echoes** Malacca/Hassan before the photograph confirms. Cost compounds — hearth suspended, helpers exposed, classification narrowly escaped, Hassan recaptured, Salmah punished, signature lit across the grid.
...
|- **Incompatibility marker — LOCKED 2026-08-16:** Wren's instinct is to route; Eli's is to stay. When he tries to turn a shared meal or a quiet watch into a future spoken aloud, she answers with logistics or a silence that reads like distance. She finds his earnestness tiring; he reads her composure as cold. The escort block should plant at least one small missed plan or mismatched desire — a cancelled watch, a skipped meal, a joke that lands for one of them and not the other — so their later bond is already accruing inconvenience, not just attraction.
...
- **Body-cost thread — ADDED 2026-08-09:** Eli's receiver work in the field is now visibly costing him — headaches, tremor in the hands, sleep that doesn't restore. The ground-read in Ch 5 paid in metabolic crash; the forming-line exposure in Ch 7 paid in accumulated small losses; here he pays in bodily depletion. Wren notices the tremor; he attributes it to adrenaline. The cost becomes visible in the greenhouse climax when the receiver opens under pressure and his hands shake so badly he can barely hold the tomato stem.
...
- **Obstacle:** documents and jurisdictions disagree; the handoff keeps slipping;
  the Custodians are in the city under biosecurity cover and the quarantine sweep
  closes ordinary exits. Wren can read the intake machinery but does not command a
  hidden route through it.
...
- **Revelation (dramatic irony through observable conduct, not a POV switch):**
  ...
  inscription as a bounded Maren's field notebook index. **Forward clue:** the handoff is set for
...
- **Romance cost (SHARPEN):** Wren treats Eli as a liability to the legitimate
  placement she attested, not as interest. Eli may misread her professional
  competence as belonging offered; it is not.
...
|- **Somchai (body language):** he does not call the intake a “classification problem.” He says the man at the gate is already carrying too much heat, that his breath does not reach the bottom of his chest, that his hands shake not because he is lying but because he has been standing in the same sun too long. Eli supplies the registry word; Somchai supplies the body.
...
- Wren finds him through Babaji's legitimate fallback contacts and receives him
  as a displaced worker, not cargo folded into an extraction. Helping him places
  her job and house standing under scrutiny.
- The Singapore archive leak supplies seven damaged Maren's field notebook scans; Babaji's
  route supplies the Three Circles object before the route breaks. Eli recognizes
  his mother's handwriting and makes the first wrong comparisons himself. **Author note (not on-page here) — corrected 2026-08-10:**
...
- Grounding comes from breath already practiced, food, sleep, Salmah's practical
  ...
  it.
- The maritime departure depends on real sailors and several bounded local acts.
...
- **Body-cost thread — ADDED 2026-08-09:** Eli's receiver work in the field is now visibly costing him — headaches, tremor in the hands, sleep that doesn't restore. The ground-read in Ch 5 paid in metabolic crash; here he pays in small, accumulating losses: a missed step, a wrong estimate, a day where the field-noise doesn't lift. Wren notices; he explains nothing. This becomes the book's physical through-line — the talent is not free.
- **Want:** find and document the forming line before the Custodians.
- **Kru Dao / why he trains — LOCKED 2026-08-15:** Malacca is the attack; do not add another. Eli asks, or a flinch when a hand comes up, because he could not reach Hassan. The cooperative will not host an untrained flare with two teams inbound. Kru Dao gives exit-route, not a champion (`67` § *Why he trains*). Wat breath already running. Time taken from documentation is the cost; Wren sees the delay.
...
|- **Three-Term check — LOCKED 2026-08-05:** What cultural program operates? (Custodian classification / registry logic; rival team targeting charged ground). What family/individual program operates? (Eli's earned-safety autopilot; evidence-as-worth). What pressure exceeds the program's vocabulary? (Growers' ordinary knowledge; line forming without Eli's direction). What practice emerges—or fails to emerge—in the gap? (He asks growers for help and exposes them; community stays wary; trust built through exposure, not rescue).
|- **Past leak:** **Malai** photographs a gauge before touching it, scolds a broken sluice like a coworker, and refuses Eli's hand when he steps off the marked bund; *third team this monsoon*.
...
- **Romance cost (SHARPEN):** Eli **resents being forced** — says something **cruel** (accuses her of control or using him as cover). Wren does not melt; holds the moral line. Repair deferred to Ch 10 — **do not** hug it out here.
...
|- **Revelation:** **community knowledge preserves the next clue** — Kitt's maps reveal a fork; the cooperative reveals the physical Maren's field notebook and sends it north under seal. Its citation wakes the conservation checksum and Rasel's current handshake. **Forward clue:** Rasel was alive four days ago inside the Sanxingdui research relationship. Recognition remains provisional until the receipt and identity are independently verified.
|- **Three-Term check — LOCKED 2026-08-05:** What cultural program operates? (Competence-as-command; evidence-as-worth; registry logic). What family/individual program operates? (Eli's autopilot: earn safety by usefulness; his recognition-aspower hazard). What pressure exceeds the program's vocabulary? (Community knowledge preserves the fork; Wren forces the humane choice; named grower injured). What practice emerges—or fails to emerge—in the gap? (Wren chooses for him; recognition not yet control; he leaves with less proof and no private victory).
|- **Three-Term check — LOCKED 2026-08-05:** What cultural program operates? (Competence-as-command; evidence-as-worth; registry logic). What family/individual program operates? (Eli's autopilot: earn safety by usefulness; his recognition-aspower hazard). What pressure exceeds the program's vocabulary? (Community knowledge preserves the fork; Wren forces the humane choice; named grower injured). What practice emerges—or fails to emerge—in the gap? (Wren chooses for him; recognition not yet control; he leaves with less proof and no private victory).
...
- **Delivery — LOCKED 2026-07-31:** antagonist job = Anika's clean-scan clock; chemistry = road logistics / irritation with Wren/Dara without thesis; wonder deferred to Ch 12 tree — keep hunger for Rasel and fear for papers audible. **Forensic structure — LOCKED 2026-08-05:** the father-search trail requires multi-step evidence authentication, not a single identification moment. Ring is physical evidence but circumstantial alone. Mandate photograph is cropped at the hand and angled so the "same soil" inscription is obscured. Maren's field notebook index is embedded in a comparative field journal, not flagged as personal identification. Rasel's location is behind at least two layers: the Guanghan program (Mandate work alias) and the Sanxingdui conservation project (work alias). The team must cross-reference biometric fragments, conservation staff records, Maren's field notebook index, and material analysis of the ring before they can move. One dead-end identification before the real Rasel.
...
- **Empty search — LOCKED 2026-08-14.** At the suspended Laos crossing, before the Vietnam detour, a patrol pulls a specific truck or container for inspection — manifest discrepancy, a tip, a dog's alert, real enough reason that Eli expects them to find someone. Tarps thrown back, crates shifted, a flashlight sweep down both sides. Empty. Whoever they were looking for already moved on through the same human-doors network a beat ahead of the checkpoint trying to catch them. Eli doesn't hide and isn't searched — he watches, and understands half a second before the patrol does that the search is already too late, which is its own small proof that the living network he's moving through outpaces the machinery hunting it. Costs nothing already locked here — Dara's permit still dies, Sora's highland-post help stands as written; this is texture, not a plot beat.
- **Immediate want:** authenticate Rasel's identity through forensic evidence before the Mandate moves him; resist the four-day road home to Bangladesh.
...
- **Revelation:** Anika tells the truth and is therefore more dangerous; Rasel is sabotaging forced convergence at a Guanghan program. **Dead-end identification — LOCKED 2026-08-05:** a preliminary name match from the Guanghan staff list points to a different man — a technical worker with a similar surname who has been in the program for eighteen months. The match looks credible until Wren cross-checks the biometric fragment against the Mandate photograph and finds a palm print mismatch. The false lead costs them six hours and forces the group to split: Wren and Dara pursue the civilian evacuation thread while Eli and Sora continue the forensic search alone.
...
- **Immediate want:** confirm Rasel's identity through forensic evidence before approaching him directly.
- **Opposing wants:** Luo and Qiao protect site, staff, and interpretive
  authority; Rasel's Mandate program wants the correspondence to become a model;
  Wren wants a viable civilian evacuation; Eli wants the object to answer his
  family question.
...
- **Delivery — LOCKED 2026-07-31:** climax must **satisfy** — father out, civilians out, Wren's cost paid and felt — then open Maren/west unpaid. Chemistry in greenhouse collision (food, tomato, unfinished love) before Book II road. **Forensic synthesis — LOCKED 2026-08-05:** final confirmation requires Eli to synthesize at least three independent evidence strands: (1) ring inscription decoded against Maren's field notebook index, (2) biometric match confirmed against Mandate photograph and conservator palm print, (3) material analysis matched to Suresh's Pelangi workshop sample. The Charkha plant is eliminated when the ring inscription does not match Maren's field notebook entry under Wren's archival method. Rasel's identity is confirmed through evidence convergence, not recognition. **Bird-tribe proof beat — LOCKED 2026-08-05:** this chapter carries the first proof-of-hidden-social-system beat in Book I: Maren's saboteur network (Hassan, Sora, Malai, Rasel) operated without a center, without a commander, without a document — proving that distributed coordination is possible even under institutional capture. The proof is forensic: the evidence exists in fragments that only make sense when cross-referenced, not in a single smoking-gun document.
- **Immediate want:** confirm Rasel's identity through forensic synthesis before the annex activates.
...
- **Aftermath:** father-son reunion is collision, anger, and partial truth—not
  ...
  reveal — LOCKED; DRAFTED 2026-08-07** (van + greenhouse dialogue in
  `manuscripts/I_The_Breach.md` Ch 13 — "They took me. Keeping me became
  unnecessary" replaces the earlier claim that he walked into custody; Babaji
  and Mei remain genuinely unaware of the interception and of when Rasel's trail
  would surface): Rasel admits that he chose the Mandate program after his
  abduction. Maren's sabotage was her own work, not Phase 1 of a joint plan. Eli's
  receiver opening in Ch 2 was the expected activation of an instrument Maren
  designed. She carried him, an infant, through a circular megalithic ground in
  England, and whatever the ground did to him that day is the design Rasel is
  talking about (`35_artifact_chain.md` § *The Folly*). Mei's account of the failed rendezvous created the uncertainty that made Eli
  follow the archive trail; Rasel alone arranged for his trail to wake when Eli's
  name touched real corridor papers.
...
- **Maren summons — LOCKED 2026-08-10:** Rasel unpicks his lab cuff and gives Eli
  the two-winters-old correction Maren routed to him. Her technical hand changes
  pens for one private line: *Babu—if this reaches you, ask me why I stayed.*
  Rasel cannot explain why she expected Eli to see it. His answer is plain: *Go
  ask her.* The note opens Book II as a request for testimony. Eli still mistakes
  that request for a rescue assignment.
...
The tepes are not a tour of interchangeable stone circles. They are a distributed argument, with each site carrying one layer of the human/Heaven interface. Only Karahan Tepe and Göbekli receive full dramatic scenes; the other sites arrive through field records, scans, recovered reports, and arguments over interpretation.

- **Çakmaktepe:** ordinary shelter, food, cooperation, and mutual aid before monumentality. Civilization begins as care, not priestly command.
- **Nevalı Çori:** household and communal ritual coexist. The sacred is still embedded in family, work, and the body.
- **Karahan Tepe:** the body as receiver. Architecture cut into the hill, benches, and human imagery give Somchai's breath/posture/resonance practice an ancient precedent. Eli learns that altered perception is disciplined practice, not supernatural status.
- **Sayburç:** human/animal scenes turn symbol into narrative and memory. Myth is an early technology for preserving interspecies relationship.
- **Sefer Tepe, Harbetsuvan, and Taşlı Tepe:** local variation proves the network had no single capital or authorized reading. This undercuts the Custodians' claim that Göbekli alone licenses ownership.
- **Göbekli Tepe:** in authorial canon, a buried communication station whose bodies, animals, symbols, sky, and collective attention once made contact repeatable. To the Book I characters it remains only the most complete surviving interface: the enclosures and associated artifacts preserve a damaged human record of contact and attempted control, but the station's actual function is still unknown.
...
- **The cost:** cleanest interface read is lost or partial; no new captive.
...
**Eli's dramatic question rhymes this:** Can he stay clear-headed under pursuit? = Can a keeper-taught body survive Union quarantine logic hunting him?

### Vol I — chapter hooks (add / sharpen while drafting)

| Ch | Coalition (keeper) beat | Union (quarantine) beat | Story move |
|---|---|---|---|
| **1** | Nico freezes mid-dough → Mei adds free-meal list **without asking**; Babaji **boat papers** | **Wren:** cohort squeeze + compound attestation | Reader loves **community care** before hunt |
| **2** | Mei/Suresh/harbor network carry Eli from Pelangi Reach through Singapore to Hassan | Processing language becomes a body-register; Custodians hunt activation under biosecurity cover | **Two models collide in one flight** — human web gets him to the ring; registry logic drives him underwater; receiver opens |
| **3–4** | Wren receives him through Babaji's fallback; food, sleep, and breath begin grounding | Post-breach overload | Eli learns regulation, not cure; Wren's standing begins to carry risk |
| **5** | Local growers / Bali subak — **living expertise** over planted lead | Custodians = **collared carriers** (took Union bargain) | Wren mirror: hunter vs harbor rescuer |
| **6** | **Ila witness site** — midwife **signature-read** (heat/tingling/pressure) = historical **keeper grounding**; talking-stone lore | Pursuit won't wait for witness | First **other** practitioner; grief not identity |
| **7–10** | Rice community **refuses both factions**; grower knowledge survives | Two psion teams contest formation; **entrainment panic** = Union war on nervous systems | Ch 10: Eli recognizes the charge but hesitates; Wren chooses evacuation, a grower is hurt, and the evidence is damaged — **no completed Manual Override** |

### Character load-bearing beats

- **Eli:** hid puberty in keeper net; fears **Fractured** file-language (`26`); trajectory read = gift **Union would sedate**. Arc: from "earn safety by usefulness" → Thailand stack → **failed** personal hold at Sanxingdui (mask). Relational hold belongs to Book II. Göbekli is Book II ground, not Vol I completion.
...
| Plant (Vol I) | Payoff |
|---|---|
| Song / rhythm / breath | **Khun Dang *Hotel California*** (present Ch 5) + wat + keeper stilt-house + Pai staff rhyme |
| Nico "still not right" | Union **Fractured** ward-track vs keepers saved him with gaps |
| White coats + merged databases | Eli nearly flagged **Fractured**; Wren scrubs files |
| Ila's diagnostic read | Healer depth vs Eli bandwidth; **same signature language**, different depth |
| Rice community knowledge | Vol III coexistence proof — **harbors beat fortresses** |
| Maren suppression scene (Vol II) | Union ward logic applied to **his mother** — personal |

### Mandate (third pole — use sparingly in Vol I)

Singapore archive, clinical corridors, **cure framing** — not punitive Fractured excision. Vol II Mesopotamian leg: state medicine vs harbor keepers.
...
- Precise Act II geography (Singapore archive; **Thailand** river-valley cooperative, keeper house, witness site, temple/Pai staging) and which leg carries the planted/false clue.
...
| 8 | OK | Eli useless — romance not the center | Shame survives lack of usefulness; inclusion does not immediately disappear |
| 9 | **SHARPEN** | Cruel line; no repair yet | Anger reveals fear of being used and abandoned; he harms Wren by presenting fear as accusation |
| 10 | **SHARPEN** | Trust without label; recognition without completed Manual Override | Eli names his conduct and asks honestly for participation; Wren admits use and agrees to tell him first |
| 11–12 | **INSERT** | Gulf/Mesopotamia corridor; permit-window pressure | Silence becomes company rather than concealment; one ordinary desire is spoken without a plan attached |
| 13 | **LOCK — displacement** | Wren signs the evacuation; her return closes | Eli cannot convert her cost into debt, rescue, or a claim on her next choice |
...
| 4 | Terminal sketch | Weaver help has bounded limits | Boarding squeeze; sanctuary |
| 5 | — | Escape offer refused | Pull, refused |
| 6 | Colder on Ila grief | — | Down |
| 7 | Control argument | Exit vs doc | — |
| 8 | — | — | — |
| 9 | Holds line | Forces hand | Strained |
