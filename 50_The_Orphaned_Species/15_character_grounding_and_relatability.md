...
- **Psionic development is slow, trained, and embodied — not a classroom upgrade.** Wren and Rowan's abilities emerge in Book II through sustained exposure, practical need, and incremental craft. Each new register should arrive with a visible cost: wrong reads, exhaustion, triage failures, or relationship damage. There is no Player vocabulary, no instant mastery, no destiny frame.

- **Rowan — entanglement / causal perception (Book II onward).** Book I gives her no psionic role. In Book II, repeated exposure plus practical craft lets her sense how different nodes in the mesh are entangled. She does not see a predetermined future or hear spirit voices. She feels thermal and pressure shifts in the mesh's causal-reasoning network — where load is building, how physical variables align, what downstream consequences are already locked in. Her "sight" is hyper-awareness of the system's entropic state. Her danger is information without consent, not power without control. Her training is observational discipline: naming what she feels, checking it against ground truth, accepting wrong reads without treating them as disqualification. **Site trigger — LOCKED:** first full activation at the deepest temporal layer — **Göbekli Tepe or a Mesopotamian ziggurat/quarry** — where sequential pressure and causal layering are sharpest. That site makes her register legible because the mesh there preserves the oldest stacked consequence.

- **Wren — entropic allocation (Book II onward).** Book I leaves her in bounded house craft: placements, attestations, route liability. In Book II, proximity to Eli's broadcast and to repeated life-or-death triage opens a separate register. She does not read minds. She manages the physical and systemic load of the mesh. When the mesh threatens to overwhelm them at a deep-time site, Wren acts as the human grounding wire — intercepting bio-feedback loops, redirecting or absorbing entropic cost, enforcing boundaries so no one burns out. Her "empathy" is her ability to stabilize other people's autonomic nervous systems and allocate squad load. Her training is practical: consent, boundaries, switching off, knowing when not to carry. Her arc is learning to let another person be opaque without interpreting that as failure. **Site trigger — LOCKED:** first full activation at the site where raw signal is most physically overwhelming — **the Gulf quarry or a deep single-chamber threshold** — where the mesh is trying to write on bodies, not just read them. That site forces her register into existence because someone has to absorb the load or the squad dies.

- **Somchai remains the trilogy's only healer.** His somatic scan-and-alignment craft is distinct from Eli's receiver reads and from any carrier broadcast. He uses local-first biofeedback to repair the physiological damage the mesh inflicts — recalibrating heart rate variability, respiratory loops, and nervous-system phase when Rowan goes too deep or Eli is hijacked by an ancient threshold. He reads bodies the way Eli reads junction boxes. He returns in Book II when outbreak scale makes his register strategically necessary. No other character takes the healer slot.
...
Use a stable, limited symptom set rather than whatever a scene needs:

- word- and name-retrieval failures, worse under stress;
...
3. **Charge / pain.** Contact deposits charge into the embodied machine. Conditioning answers with a rule — and often an **emotion** (the response, not the charge). Repeated automatic execution, suppression, or the second-step story that this is happening to an I turns the body into the place where refused information insists.
4. **Relation.** He learns to keep the place from which he can engage: hold the charge as guidance without obeying it, suppressing it, or telling the story that it is I. Early control uses substantial psi allocation; practice makes it more efficient.
...
**Fugitive Thailand (after the disappearance):** Somchai tends Eli after the failed return; **wat breath seed only** — **no martial**, **no body memory** carried into Pelangi/Singapore/Malacca. The Fever scar comes later, at Pelangi during the outbreak (`26` § Eli turn).
...
The trilogy's only healer is the male medical worker who tends Eli after his parents fail to return and passes him into the escape network. His practical medical competence precedes the gift. The search exposes him to the suppression apparatus; he and Eli are separated, then meet again when two independent clue trails cross in Volume II. Neither has been knowingly traveling toward the other. Over time the healer can sustain deep repair of severe tissue injury, complicated fractur
...
- people who need something from him that has nothing to do with psionics.
...
- Bangla speech, private counting, jokes, curses, and terms of affection;
...
**Father's disappearance — locked shape (rev. 2026-08-11).** Rasel Khan—legendary
physicist and gardener in Eli's memory. Bangladeshi passport → Mandate claim;
Maren's Albion passport → Charkha chain. Ch 1 reveals only that no one witnessed
their deaths. Rasel later confirms that both meant to return for Eli and that he
was taken before reaching the rendezvous and later chose to remain with the Mandate.
...
- irritation, boundaries, consent, disappointment, humor, and repair;
- occasions when each misreads or fails the other;
- care that costs time or safety and cannot be mistaken for utility;
- an indispensable choice by Wren that changes the outcome;
- interests, loyalties, and grief that do not orbit Eli.
...
> They were real. They were not me. I am responsible for what I do with what they left.

## Discovery must remain shared, physical, and dangerous
...
For every chapter, remove the cosmological vocabulary and ask:

> What human problem remains?

Strong answers include:

- A refugee decides whether to trust a stranger who knew his mother.
- A wounded man receives another person's grief and struggles to remain himself.
- Two frightened people test whether their connection is care or manipulation.
- A son accepts that reunion with his mother would prolong her suffering.
- A survivor must choose between helping one person now and pursuing a truth that may help many later.
- A receiver must accept that the healer beside him can do something he cannot.
- A fugitive must decide whether an unproven reading of the land is reliable enough to risk other people's lives.
...
When elements compete, protect them in this order:
