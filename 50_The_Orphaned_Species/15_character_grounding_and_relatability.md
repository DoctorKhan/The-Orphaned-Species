...
- **Wren — psionic empathy → telepathy (progressive, Book II onward).** Book I leaves her in bounded house craft: placements, attestations, route liability. In Book II, proximity to Eli's broadcast and to repeated life-or-death triage opens a separate register. She first feels other people's states as bodily noise—mistaking it for stress, for Eli's broadcast, for occupational hazard—before she can name it as empathy. Telepathy arrives later, under triage, as a choice rather than a default. Her training is practical: consent, boundaries, switching off, knowing when not to read. Her arc is learning to let another person be opaque without interpreting that as failure.

- **Rowan — seer / web of life / contextual intel (Book II onward).** Book I gives her no psionic role. In Book II, repeated exposure plus practical craft lets her read connections that are already present but invisible—routes, debts, fidelities, the shape of what is already happening. She does not see the future. She sees topology. Her danger is information without consent, not power without control. Her training is observational discipline: naming what she sees, checking it against ground truth, accepting wrong reads without treating them as disqualification.

- **Somchai remains the trilogy's only healer.** His somatic scan-and-alignment craft is distinct from Eli's receiver reads and from any carrier broadcast. He returns in Book II when outbreak scale makes his register strategically necessary. No other character takes the healer slot.
