...
5. **The protagonist's body as the exhibit.** Eli *is* the awakening (natural-carrier line, the receiver, the surge, his mother's "useless read," the hummed song). His phenomenology delivers the awakening with zero history lecture — the strongest channel, already load-bearing.
6. **One rememberer, one shard.** An elder, a scarred sailor, Babaji drops a *single concrete line* about the war — never a summary. A specific image beats a paragraph of context.
7. **Disagreement carries interpretation.** The three factions' *readings* (violation / disease / integration) surface as friction — two ports treating Eli differently, an argument between characters — never narrated as "the three factions believed X, Y, Z."
8. **Rumor for the deep hook.** "The earth held secrets… an ancient force began to stir" stays sensation and superstition — talking-stones folk memory, a sailor's unease, Eli's pull toward the stones. The moment it is stated, it dies.
...
## Research notes formerly attached to the preamble
