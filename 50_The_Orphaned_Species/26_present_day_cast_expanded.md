...
- **Turn (layered — REVISED 2026-07-22, author direction: the ring never recruited her):** in their threshold years, Wren and **Rowan — her ply** — **discover the ring together**: a training-sister from their house disappears into a quarantine pickup; they trace her through the Net's capillaries and find the harvest apparatus at the end of the trail. Their first joint rescue attempt fails — *the failed extraction* that ends their shared life (`19` § Formative bond and renewed desire). The ply splits **over doctrine, not love**: Rowan holds the Weaver way — outside, patient, corridors and memory; Wren decides the inside can only be beaten from inside and **walks into the ring on her own feet** — a handler by infiltration, never by recruitment. Contact between the strands goes dark for security. But the inside grinds: cover demands compliance, subversion shrinks to small file delays, and only **Mira's** loss (love during the handler era; the extraction she couldn't save) turns scattered sabotage into the organized secret network (`99` #3). The network is one structure with two ends — Wren/Asha inside-facing, Rowan the west corridor — that do not meet again until Book II. Soft Wren trades for exit-first survival.
