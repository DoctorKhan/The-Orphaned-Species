...
- **Turn (layered — REVISED 2026-07-22, author direction: the ring never recruited her):** in their threshold years, Wren and **Rowan — her ply** — **discover the ring together**: a training-sister from their house disappears into a quarantine pickup; they trace her through the Net's capillaries and find the harvest apparatus at the end of the trail. Their first joint rescue attempt fails — *the failed extraction* that ends their shared life (`19` § Formative bond and renewed desire). The ply splits **over doctrine, not love**: Rowan holds the Weaver way — *distance*: corridors, patience, memory; Wren chooses *contact* — running against the ring at knife distance, **in its skin**. **REVISED 2026-07-22 (supersedes "ring handler" phrasing in `00_NARRATIVE`/`05`/`99` #3): Wren never joined the ring. She wears it.** Her tradecraft is **impersonation** — she extracts people by walking in dressed in the ring's own procedures, credentials, and manner, and she knows its systems the way a burglar knows locks: from outside, better than the owners (the co-discovery trace, years of adversarial study, stolen manifests, a defector source or two). To observers — and to Eli, and to the reader, for as long as the book can hold it — she is indistinguishable from ring personnel when working, which is the point: **her allegiance has no floor to hit**; the reveal is never "secretly good," it is "never what either side thought." The grey survives intact: masks need upkeep, so she sometimes feeds the apparatus something real to keep her costumes credible — dirty hands, triage, the counterfeit, none of it resolved by a membership card. Contact with Rowan's strand goes dark for security. **Mira's** loss (love during the masked era; the extraction she couldn't save) turns scattered raids into the organized secret network. The network is one structure with two ends — Wren/Asha at contact range, Rowan the west corridor — that do not meet again until Book II. Soft Wren trades for exit-first survival.
...
**Voice:** flat under stress; unexpectedly precise when lying; rarely explains twice.
...
**Past:** trained in facilities logistics and occupational safety during the reopening, when a missed inspection could close a whole residential block. She learned that records can force employers to provide rest, medicine, and compensation; she also watched the same records become cohort lists for removal. A former coworker died after staying invisible to avoid a registry flag.

**Want:** build enough documentation to make institutions responsible for workers without making workers legible to hunters.

**Habit:** assigns ticket numbers to personal favors so nobody owes her privately; hesitates before entering health information; notices tremor, fatigue, and overload before Eli admits them.

**Vol I:** signs Eli's shifts, quietly adapts work around his TBI without infantilizing him, and recognizes the Friday overload. When white coats request the facilities cohort, she delays and corrupts the export, costing her job access and placing herself under review.

**Vol II beat:** working as a displaced-worker status liaison, she offers Eli legal protection if he submits a baseline scan, then permits Wren's counter-record to pass. *"It's not ownership, it's visibility,"* she says, and means it. Her mistake is believing good administrators can permanently control how collected data will be used.

**Voice:** concise and procedural until angry; dry about founders; never says *trust the system*, only *make the system sign its name*.

**Guardrails:** not a doctor, maternal substitute, or faceless bureaucrat. Her systems sometimes genuinely protect people. She and Mei may disagree without either representing the single correct form of care.
...
| **Priya Nair** | Trauma bond to visibility | coworker died while hiding; control through accountable paperwork as anxiety management |
