...
## Rasel Khan *(Eli's father; physicist; taken alive into Mandate lab custody; on-page from the Sanxingdui recovery through Book III)*

*Synthesized 2026-07-28 from scattered locked material (`00`, `15`, `27`, `29`, `31`, `40`, `52`, `58`) — no new facts invented; first dedicated sheet for this character.*

**Function:** Eli's intimate route into complicity's second half — Maren shows Eli that resistance and collaboration can coexist in one person; Rasel shows it again, differently shaped, so the lesson isn't a one-time exception. Father-line source of symbol-reading: he reads the living world (soil, stem, season, seam) with his eyes shut, the register Eli inherits without the fluency.

**Past:**
- **Ordinary life:** physicist, claimed as a high-value asset rather than robbed of a single invention (`40`). Gardener in Eli's memory with "a physicist's precision" — plants measured, staked, corrected. Taught Eli the pump (*feel the cloth, don't fight the air*) on a borrowed skiff; Bangla mixed with English when a lesson mattered; **Babu** at home, never on a form — the surname a child does not inherit is a fact, not a mystery, and he says so plainly when it comes up.
- **Turn:** extraction attack splits the family — Rasel taken on his Bangladeshi passport into Mandate lab custody; his field-coupling physics is coerced toward a weaponizable, centralizing interface. He is **neither a helpless captive nor a secret master of the site** (`58`): he has been delaying and sabotaging the apparatus, protecting local staff where he can reach them, for as long as the captivity has lasted.
- **Unreconciled:** the same rationing math as Maren's, differently dressed — he protects whoever is in reach and cannot save everyone, and has never totaled the cost of the ones he couldn't. Recovered at Sanxingdui, he wants to **expose the Mandate physics** before pursuing anything else for himself (`32`) — the sabotage was never going to be the end of it.

**Want:** get free without becoming an instrument again; make the coerced apparatus impossible to rebuild, not just personally escape it.

**Wound (proposed — parallel to Maren's, not yet author-confirmed):** He chose incremental sabotage and selective protection over one clean act of exposure, because exposure, attempted too early or too loudly, would have gotten staff and family killed. It worked, as far as it went. It is still a rationing choice with a toll he has not named aloud — the same architecture as Maren's delay, arrived at from the opposite side of a lab bench. Eli wanting an innocent father runs into this the same way he runs into Maren's ledger.
...
**Good at:** grounding abstraction in land, labor, and direct consequence rather than argument (`27`: he "understood systems through land, labor, and consequence and challenged [Maren's] willingness to accept institutional means for humane ends"); converting captivity into small, real, unauthored acts of protection rather than waiting for rescue or an audience; refusing despair or self-mythologizing under years of custody.

**Bad at:** saying the feeling instead of the measurement — the corrective instinct reads as criticism to a child, and he has never adjusted it; believing, like Maren, that he can ration a captured system from inside for exactly as long as it takes, when the true cost is paid by people he isn't watching in that moment.

**Voice:** dry, exacting, states hard things plainly, as data; rarely raises his voice; humor so dry it can be missed as coldness.

**Guardrails:** not a secret hero, not a passive victim — the complicity is specific and real, matching Maren's in structure without duplicating her content. Reunion with Eli **refuses restoration**: they garden together, argue about complicity and control, and remain separate moral agents (`27`, already locked) — recovery is not the same as repair.
...
**Want:** absolution he can't get from institutions.
