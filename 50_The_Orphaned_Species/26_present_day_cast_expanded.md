# Present-Day Cast — Expanded Character Flesh

> **Status:** working cast bible for scene generation. Fleshes recommendations from cast review session; **does not** replace locked beats in `99_open_questions.md` where those docs win on conflict. Companion to `05_story_architecture.md` §5 (fellowship), `15_character_grounding_and_relatability.md`, `16_reader_attachment.md`, `19_romance_and_divine_pairing.md`, `24_comedic_register_slapstick.md`, `27_character_development_arcs.md` (volume arcs and proof scenes), and `28_present_day_tetralogy_craft_index.md`. **Structure:** Part 0 complex pasts · Parts I–II cast · Part III placement · Part IV comedy · **Part V past-vs-mask (Vol I)** · **Part VI trauma patterns** · Part VII open items.
...
- **Eleri RETIRED 2026-08-10.** Anglesey and the bitter-cup ceremony are cut (`32_volume_II_beatsheet.md` Ch 8 location contraction). Morwen absorbs Ch 8's keeper/abort-protocol function during the Rollright→Stonehenge transit rather than a second keeper being introduced; she does not gain a "roads vs doorway" foil anymore. **Morwen — hedgerow/fairy-doctor keeper, Ch 6–8, Callum recovery through the corridor transit.** Voice: dry, unhurried, deflects sentiment with brevity rather than warmth — *"The tree has been called rowan longer than she's had the name. Neither is a spell."* / *"Still funny." "Unfortunately."* States rules and risks flatly, the same register whether the stakes are a splinter or a mind. Do not write her lines in the more gnomic, koan-shaped register Eleri used to carry (*"If you cannot name what brings you back, you are only naming what pulls you in"*) — that was Eleri's voice, not hers, and reusing it flattens the distinction this note exists to protect.
...
- **Return rule — REVISED 2026-08-16:** a named Book I survivor is live only if a later page names them or names a cost that still hurts. **Paid:** Mei, Suresh (Pelangi home-node through III); Salmah (boat seized, I); Qiao (clearance, I); Wren (credential, I). **Paid this pass:** **Malai** (III garden packet); **Dara Phommasone** (III still on the highland list, still angry). **Quarry for later appearance:** Kiran. **Stay off-page:** Shireen (voice note only). Do not invent a new local until Malai and Dara have landed.
...
|- **Sora Vithan — LOCKED 2026-08-06; chapter-pinned 2026-08-08:** defect confirmed; end state locked. Sora defects into Wren's network in Book III and dies there — not as martyr, not saving Eli, but protecting the threshold network she chose. **Death lands in Vol III Ch 8** (`33_volume_III_beatsheet.md` § *Ch 8*), the same distant-corridor engagement where the rival national team's identity resolves; St Michael medal recovered and returned to her sister, not kept as evidence. **The cost specific to Wren lands one chapter later, in Ch 9's hearing** (`33` § *Ch 9*, "Wren's cost, named"): the person who owed her Mira's truth is the person who pays the price of Wren's choice to keep the network open, and that truth dies with her, unpaid — Wren carries it into the hearing room rather than testifying to it. Her defection is the named Extra man/woman who chose differently from Sol — her route out is the proof that the split is character-shaped, not category-shaped.
|- **Vane — LOCKED 2026-08-21:** Eli's dark reflection. Awakened, brilliant, and ruthless about survival. Repeatedly saves Eli's life or the lives of Eli's people, but always for the wrong reasons. Believes the Mandate is a cage and the Igigi were tyrants; while Eli wants to dismantle the machine, Vane wants to sit in the captain's chair. Speaks in action, not monologue. Never explains the moral case; lets the cost speak. Minimum one Vane beat per two-book cycle. Function: make Eli's refusal of power costly, seductive, and visible to the reader.
...
Each entry includes: **function**, **look**, **past** (ordinary life → turn → unreconciled), **want / wound / habit**, **voice**, **story load**, **first appearance**, **guardrails**, and **scene seeds**.

---

## Complex pasts — craft rule

Every major character **existed before the psion war, before Eli's breach, and before their current job title.** Runs, registries, descents, and network ops are the **emergency overlay**, not the whole person. If everyone reads as born for extraction, the book collapses into Eli + lore.

Each major entry should hold **three layers**:

| Layer | Question |
|---|---|
| **Ordinary life** | Who were they when the world still felt like work, meals, family, shame, and appetite — not mission? |
| **The turn** | What event or slow pressure made them who they are at story open? |
| **The unreconciled** | What is still unpaid, unspoken, or misnamed — and what does the present plot reactivate? |
...
**Change from baseline:** play him as the dry straight man to ensemble disorder and Wren's armor-breaks—laughs through restraint, not pratfalls. Fever-scar comedy is **scary** (wrong order ticket, dropped plate), never sitcom.
...
- **Independent objective — LOCKED 2026-08-16:** If Eli vanished tomorrow, Wren would still be trying to get a **signed right of return** onto every house attestation she touches, so nobody can be moved the way Mira was. This is the load-bearing want. Book I after Thailand she sends the draft south to Asha. Book II she puts the same clause on Rowan's table. A reader should be able to say what Wren is doing that is not helping Eli.
- **Private texture, not a plot engine — REVISED 2026-08-16:** she wants to be held, and she snaps at unasked kindness. Play it in conduct (rail-stares, one night of sleep when he has the watch). Do not treat her as building Eli into the person who can hold her. Return rights is the character. Being held is a later cliff, chosen by her. She reads him as craft; he steadies her as presence. No Lance, no probe, between them.
...
**Voice — LOCKED 2026-07-25:** **composed, soft-spoken, hostess register** — airline hostess / luxury hospitality; comfortable with wealthy clients (Babaji's world). Speaks quietly, unhurried, precise; makes queues and lies feel temporary. Contrast on-page: **Babaji** = educated analytical; **Suresh** = harbor blunt; **Mei** = kitchen scolding. Under stress the softness stays — exit-counting beneath the composure; **unexpectedly precise when lying**. Never harsh handler bark; never mystic. Authentic contact = disorientation, not warmth (`26` § Authentic contact).
...
**Want:** build small, lawful-enough threshold houses throughout the ports instead of depending forever on heroic clandestine extraction. She wants durable rooms, trained neighbors, appeal rights, and boring rotas.

**Wound / flaw:** separation made her procedural. She can delay urgent action while protecting the fairness of the system and sometimes confuses documented consent with consent freely given under scarcity.

**Habit / pleasure:** labels everything except her own tea; grows night-blooming jasmine in medicine tins; sings badly while counting stock because silence makes the work feel like custody.
...
**Refuse Wren without Rowan — LOCKED 2026-08-16:** at least one Book III scene where Asha tells Wren no and Rowan is not in the room. On-page: `III` hearing stretch. The no has to cost a route Wren wanted.
...
**Temperament — softer than Wren, composed beyond her years — REVISED AND LOCKED 2026-07-28:** Wren is the **runner** — hostess composure, exit-counting, harder shell, operator register even when gentle. Rowan is the **sitter** — **softer in voice and manner**: unhurried warmth, humor without performance, person-first doctrine that takes real nerve. But softer is not less composed. Rowan reads as **older than her age**, not fragile: cost gets folded into posture and pace rather than displayed — she does not perform fatigue, does not let grief leak onto her face in ordinary moments, and stays focused on the next right action while everyone around her is deciding whether urgency should win. Reserve visible strain (a line crossing her face, a held breath) for the few scenes where the cost is specifically named and warranted — not as her ambient state. She **does not manage danger by becoming steel first**, the way Wren does; she manages it by already being settled before the danger arrives. Where Wren redirects Eli's feelings with plain lines and returns to the tablet, Rowan **stays in the room** with cost — calmly, not wearily. Draft Rowan with more pause and less hostess polish than Wren, but never as tired, soft-focus, or younger-reading than the woman beside her.
...
**Interior life — private vulnerability beneath the composure (new 2026-07-28, awaiting author lock):** The older-than-her-years composure (`26` § Temperament, revised 2026-07-28) is real, not a mask over a secretly frightened girl — but it is not the whole truth either. Rowan carries ordinary uncertainty and fear like anyone her age; she has simply learned not to perform it for people who need her steady. She lets her guard down with almost no one. **Wren first** — oldest trust, ply-bonded, nothing left to prove after a shared adolescence — and **Eli, later and more slowly**, as one of only two people who ever see the unsettled version behind the settled one. Play this as a difference in audience, not an inconsistency in character: professional and stranger-facing Rowan is genuinely composed; private Rowan, with these two specifically, admits doubt, asks a question she already suspects the answer to, or goes quiet instead of steady. This gives her a wound-shaped gap without inventing a dead person to match Wren's Mira — the vulnerability is ongoing and relational, not a single past failure.
...
**Voice — added 2026-08-11 (no prior entry):** unhurried, precise, refuses to let a question be answered smaller than it was asked (*"Ask the actual question."*). Where Wren redirects with a plain line and moves on, Rowan holds the room open until the real thing gets said — short affirmations once it does (*"Yes." "Better." "Still yes?" "Yes."*), no filler between them. States limits as fact, not negotiation (*"He knows what I may want. He does not authorize it."*), and does not soften a "no" to make it easier to hear. Humor without performance — dry, low-key, never reaching for the room's attention the way banter does.

**Romantic redevelopment:** recognition alone is not reunion. Rowan first sees whether, when she says no to something, Wren lets it stay no — or starts managing it the way she manages intake, finding the correct placement for a refusal, the way she folds a limit into a route and asks for a signature afterward.
...
## Rasel Khan *(Eli's father; physicist; inside the Mandate research program by his own settled choice; on-page from the Sanxingdui climax through Book III)*
...
- **Turn:** no extraction into custody, no coercion. Mandate scans of the Sanxingdui bronze tree's geometry resembled Rasel's own field models; he offered his research to the program once he understood what the tree could do, and stayed by his own choice — twenty years without status or protection had already taught him what happens to people the Mandate has no use for (`58`). He built an apparatus he could not finish alone: his own receiver was never active enough to close the circuit through the masks he designed.
- **The ask:** once he judged Eli ready, he arranged for the truth of his own survival to reach his son — not to be rescued, but because Eli is the one live, strong receiver who can complete what Rasel's research couldn't. At Sanxingdui he asks Eli to wear the mask directly, an ask from a father who has already decided what his son is for. Eli does it. Rasel measures the field live — signature strength, decay curve — data his training program and engineering effort had both been missing.

**Want:** standing and protection through usefulness — his own, and now his son's. He wants his son at Sanxingdui, and he wants what his son can complete more.

**Book III clock — LOCKED 2026-08-16:** If Eli never entered the room, Rasel would still be racing the Mandate's **October Continuity recertification**. The Sanxingdui annex array transfers the staff line and fires the cadence without him unless he can show a recordable reference model by that Friday. He wants the model honest enough that a board cannot use it as a master rhythm, and complete enough that his people keep their posts. On-page: `III` Ch 2 wall-screen; Ch 4 Sideways lab. `33` § *Rasel's independent stake*.

**Wound:** two decades of learning that a man with no status is disposable to the Mandate, resolved into a single, coherent, transactional logic: usefulness is the only currency that reliably buys safety, for himself or for anyone he loves. He applies this to his own son without much hesitation and without much guilt — the logic is load-bearing, not a lapse. When the Mandate later turns its own reach on Eli using exactly the data Rasel supplied, that betrays the bargain Rasel believed he'd made, not the choice to make it.

**Habit:** measures instead of names — controls, error bars, correction, precision — as the only grammar he has for love and fear. Corrects a knot or a graft when he means *I'm glad you're alive*. This is the actual mechanism behind Eli's "garden failure = shame": Eli inherited the precision without the words underneath it, so tending the plot badly is Eli trying to speak a language whose grammar he was never given.

**Good at:** grounding abstraction in land, labor, and direct consequence rather than argument; arguing his own choices coherently enough that they're genuinely hard to refute, not merely rationalized; treating his son's usefulness and his love for him as the same fact rather than a contradiction to manage.

**Bad at:** apologizing — he defends the choice rather than asking forgiveness for it, and would very likely make it again; hearing "I'm glad you're alive" in his own corrective register, which reads as criticism to a child and has never been adjusted; recognizing his own good-life-through-usefulness logic as anything other than realism.
...
**Voice — added 2026-08-11:** intellectually restless, boundary-crossing, makes a research room feel like a conspiracy and a kitchen feel like a laboratory (already established under "ordinary life" above — carry that register into dialogue, don't flatten it). Under pressure or across the damaged one-way contact, compresses hard: fragments, not full sentences — a single freighted word doing the work a paragraph would elsewhere (*Release. Inside the correction.*). Never self-pitying; states her own complicity as flatly as she'd state a result.
...
**Past:**
- **Ordinary life:** **public-health / immigration / outbreak logistics** career — built tracing, checkpoints, and registries that **saved lives** before they became cages. Reasonable man in reasonable rooms.
- **Turn — LOCKED 2026-08-16:** **Imani Vale.** He was the officer who classified her withdrawal delay as a protection case. She never left. He still updates her paper file on her birthday. That case is how grief became policy. Do not invent a sibling or a child.
- **Unreconciled:** private **file of carriers who died in custody**; each row feels like love; believes Eli's freedom would add rows.

**Want:** prevent psionic catastrophe through registration and command — sincerely, in his frame.
...
**Playing him — coercion as courtesy (*Godfather* grammar):** the menace never raises its voice. Seed an un-thanked favor early (Vol I–II); by the throne offer (Vol III Ch 4, "The Standard" — confirmed via `47_coercion_as_courtesy.md`) that favor is called in, and Eli feels exactly how a kindness quietly became a debt he never agreed to. The offer itself stays *sincere and right about the danger* the whole time — Lang isn't lying about the threat, which is what makes accepting it a cage anyway. The private file of the dead is the un-stated threat, shown as grief. Full mapping + drafted seed/payoff scenes in `47_coercion_as_courtesy.md`.
...
**Wound:** stabilized child-Eli once, then lost track of him in the escape network — carries guilt he won't perform.

**Anchor (new):** aging **mother with diabetes** in a clinic queue he still checks on between jobs; co-worker **Pin** who once shared a healing clip "to help" — betrayal of *don't tell anyone* with a face.

**Habit:** sleeps in chairs; washes hands twice; answers "son of a man" before anyone asks for god.
...
**The depth-scan — REVISED 2026-08-16:** Book II Ch 4. This is a psionics reveal, not a sermon. Consent first. Wrist. Three facts Eli can use later: most people are quiet inside; the leftover fever is scar and the receiver was always him; at least one other person in the room is loud (Pin at the fridge, already doing a job). Somchai does not lecture a hidden population. Eli looks at the chairs and keeps the difference. Then triage.

**Voice — added 2026-08-11 (no prior entry):** clinical, minimal, triage-trained — states boundaries as fact, not negotiation (*"Currently he is my patient." "No. Mine governs this room."*); short medical-check cadence even outside medical scenes (question, answer, next question); redirects rather than argues (*"Care first."*); uses **Babu** only to end an argument, never to open one, because he knows exactly what the name costs to hear. Says a boundary once, in the same flat tone he'd read a pulse out loud, and does not repeat it.
...
**On-page texture:** **old hotel** on the Reclamation (half boarded, half laundry — keeper base, **tech labs**, **portable brain scanners**, tea room); **Wren** runs front-of-house — host/assistant, beautiful, composed, **soft-spoken** (airline-hostess register; comfortable with Babaji's class); plaza **robot dogs**; **automatic chess boards**; **wine-coloured car** parked outside; **massive motor catamaran** at anchor off the channel mark (twin white hulls, wide bridge, dark glass — wrong for Pelangi, perfect for Babaji); hotel **launch** for handler runs; kettle, four quiet men, *door was open*. **Wren has no Mei/terrace overlap on-page.**
...
**Status:** Book I only. Quarry for later appearance. Do not bring him to Belém or the court.
...
**Want:** keep his boat, crew, and cousin musicians paid without dying for strangers.

**Wound (new):** lost **cousin Iqbal**, a port musician flagged as carrier-adjacent — disappeared after a "quarantine pickup." Suresh still plays nothing of Iqbal's tunes in public.

**Habit:** hums wrong notes on purpose; counts chits twice; never asks permission twice.

**Voice — expanded 2026-08-11:** low, practical, guilt as dry humor. Imperative and short under pressure (*"Now! Hold it!"*); flat statement of fact instead of alarm when something's wrong (*"That's not chew. That's not salt-rot either."*); affection arrives as instruction, never as a stated feeling (*"Feel the cloth, don't fight the air."*). Does not ask questions he doesn't want answered. States what he noticed — the frayed line, the boy in the water — and stops there.
...
## Priya Nair — **RETIRED 2026-07-25**

**Former function:** Pelangi Reach facilities scheduler → worker-status liaison. **Ch 1 compound attestation, cohort squeeze, call sheet, dawn manifest → Wren** (intake cover on Pelangi). Book III procedural beats → **Wren/Asha network** or **Mei** hearth logistics. Do not reintroduce on-page without author pass.

---

## Mei Lin *(Pelangi Reach kitchen manager / community hearth)*

**Function:** local trust, nourishment, and communal protection. She knows who has eaten, who failed to arrive, whose child needs watching, and which rule a community can break without making someone else pay. She is distinct from Wren and does not become the registrar.

**Past:** ran a **smaller kitchen** through the first outbreak wave — fed neighbors through closures; her **younger brother** was sent back to a locked province (he survived; she does not forgive the choice). A cousin died unregistered, leaving Mei suspicious of both invisibility and official visibility.

**Want:** keep people fed and held in community through wartime rules without turning care into debt.

**Habit:** pins hair with a pen; translates at the till; sees everything, says half; feeds people while pretending she is solving inventory.
...
**Voice — expanded 2026-08-11:** Mandarin/Malay/Bengali code-switch; commands without shouting until the rush; kind, tired, food-first. Feeds before she confronts (*"Eat it like you mean to come back, even if you don't"*); delivers hard truths only after the plate is down, flatly, without softening the delivery even while softening the moment (*"So you could live"*); teases before she scolds, scolds before she grieves. Never apologizes for a choice she'd make again — states her reasons once and moves to the next task.
...
**Past:** **fishery accountant or port clerk** before black-site rotation — someone who trusted paper; held weeks with Eli's mother; saw her **removed alive**.
...
**Want:** absolution he can't get from institutions — believes he owes Eli what actually happened, not a comforting version of it.

**Habit:** watches doors; speaks in dates and times like testimony.

**Voice:** quiet, precise, exhausted; no mysticism.

**Scene seeds:** handoff slips twice; Eli glimpses the ring before it can be transferred; Hassan is recaptured by the Custodians during the breach; transferred through the Thrace/Balkan holding corridor (relocated from an earlier Gulf staging per `58_sanxingdui_climax_lock.md`'s Book II route) because his memory may unlock Maren's damaged maps; returns alive in Volume II custody; Eli must choose Hassan's extraction over the clean recovery of Maren's evidence.
...
**Ordinary life:** sells fish and drinks from a quay-side stall, keeps a small working boat, and knows the river's currents, prop wash, submerged lines, and places where people do not come back up. She is known locally for returning dropped cargo and charging fairly for it.
...
## The Custodians *(recurring rival psion unit)* — members fleshed
...
### The Lance — **Tomás "Tommy" Reyes**

**Past:** **soldier or dock-league athlete** before lance training — body first, questions later; program offered **purpose** after a discharge or injury.

Hurts people; tremor in left hand; armor of willingness over self-loathing. **Most likely to kill a civilian** in crossfire — Shield's opposite.

**Wound:** first lance kill was a child in a crowd entrainment accident — program called it collateral.

### The Shield / conscience — **Sora Vithan** *(defection candidate)*

**Past:** volunteered for program to **protect Mira** (partner) or a sibling — believed collar was **shield**, not leash; watched Mira die in custody in another uniform.

Coherence holder; tries to spare civilians; fraying.

**Tie to Wren:** **Mira Okonkwo** was Sora's **partner** in a prior program iteration — Wren's extraction failed because Sora's unit intercepted the route; Mira died in custody or during transfer. Wren doesn't know Sora survived into the Custodians. Sora knows Wren's face from files.
...
### The Mask / Scout — **Jin "Grey" Pak** — RETIRED 2026-08-06; stay unnamed

**Past:** **scholarship recruit** — young, fluent, poor; program sold as **education and safety**; first ops felt like games until they weren't. Do not restore the name. The scout stays unnamed until a want earns one.

Youngest; false signatures; seduction ops; socially fluent. **Believes they're buying time** until a better system exists — not amoral, **coerced idealist**.

**Habit:** mirrors your accent; leaves conversations unfinished.

---

# Part II — New characters

## Mira Okonkwo *(dead; Wren + Shield backstory)*

**Function:** wound shared between Wren and Sora; never on page alive except flash/dialogue.

**Bio:** carrier with sonic/resonance gift; Wren loved her; extraction failed; died in Charkha custody or transfer. Sora was there in another uniform.

**Rule:** no resurrection; no "she was Anthea" — recognition under uncertainty only.
...
**Knows:** the forming line is not irrigation failure, salinity, blight, pesticide damage, ordinary industrial pollution, or the mapped legacy-contamination parcel. She does not confirm Eli's cosmology; she proves that familiar explanations fail.

**Voice:** “You are the third team this monsoon.” Dry, furious, practical; exact about which family recorded which field.
...
**Book III return — LOCKED 2026-08-16:** she does not travel. A packet reaches Pelangi/Belém: polarity photocopy, Niran walks, *do not send teams*. `III` garden.
...
## Dara Phommasone *(Laos–Vietnam freight; Book I Ch 11)*

**Function:** the Friday Eli wrecked. She wanted her family's twenty-three-year license to survive the highland posts. It did not.

**Want:** keep driving coffee without a stamp that names her.

**Wound:** license suspended, vehicle on every secondary-inspection list from the highland posts to Kunming. She paid gold. She still has no renewal.

**Book III return — LOCKED 2026-08-16:** she is still on the list. A cargo office or Wren's slate carries her name. She wants gold, not thanks. She is still angry. Rowan is not required.

**Guardrails:** do not redeem her by letting her forgive him. Do not bring her to Belém unless a later pass promotes her.
...
**Past:** **bloc program carrier** with family, maybe a degree, maybe a child — **identification/charge spiral** at stadium/clinic/checkpoint broke him publically; before Sol preached fire, he **begged for help**.

**Bio:** former carrier in a bloc program; **identification/charge spiral** broke him (public incident — stadium, clinic, or checkpoint); now preaches *burn registries, follow the flare, the chosen don't ask permission*.
...
**Voice — REVISED 2026-08-16:** too much warmth. He laughs once at the wrong time. He talks past the end of the point. He offers a sweet from a paper bag and is offended if you refuse. Volume is allowed. He is not Lang with a scarf. The second line can still reframe; the first line can be sloppy. `"Witnessed access"` can stay. The even-pace lock is retired.
...
**Cultural grounding:** from a Hui Chinese family; the exact city, given name, languages, religious practice, and family history require Chinese/Hui research and cultural review before prose. **Do not assign a given name** until he has a Friday job that is his own week, not the Mandate's. The Zheng He rhyme is historical function, not reincarnation, costume, or one-to-one biography.
...
**Ceiling — LOCKED 2026-08-16:** one testimony. No court career. No Book IV promotion.
...
# Part V — Vol I past-vs-mask scenes

One **drafting beat per major character**: the **mask** is what the reader (or Eli) assumes first; the **leak** contradicts it **without explanation**. No backstory dialogue; one object, habit, or competence out of register. Map to `31_volume_I_beatsheet.md`.
...
# Part VI — Trauma & internal cage patterns

**Craft guide** — not a clinical dossier. Injuries to **attachment, agency, and truth** echo the trilogy thesis: external cages (registry, collar, prophecy, ownership) have **internal mirrors** (control, identification, custody, visibility addiction). **Do not diagnose on-page** unless a character would plausibly use a clinical word; show **behavior under pressure**.

Pair with **Part V** (past-vs-mask leaks) and **Part 0** (complex pasts). Guardrails: `15_character_grounding_and_relatability.md` (Eli Fever scar, healer, disability).
...
- Treat mental injury as **cosmic upgrade** (especially Eli's Fever scar or psion contact).
...
## Shared war / fugitive patterns (~2040)

Most major cast can carry some mix:
...
## External cage ↔ internal pathology

| External cage | Internal mirror |
|---|---|
| Registry / collar | Control, visibility addiction, belief fusion |
| Prophecy / chosen one | Identification, messiah hunger |
| Charkha / extraction | Moral injury, triage guilt, split self |
...
|---|---|---|
| **LOCKED** | **Moderate–severe Fever scar** (bioweapon post-infectious aftermath — `26` § Eli turn; `15` § *Eli's Fever scar*) | word/name retrieval failure, overload, fatigue, shame, panic around blasts/restraint/medical authority (quarantine-era clinics) |
...
| Pattern | Behavior |
|---|---|
| **Attachment avoidance** (post-Mira) | intimacy = operational liability |
| **Control trauma response** | love = manage danger first (`19`) |
| **Moral injury / triage guilt** | secret network → someone always doesn't get out |
...
| Pattern | Behavior |
|---|---|
| **Caregiver burnout** | every body feels like his responsibility |
| **Boundary-collapse anxiety** | *don't tell anyone* practical, not saintly |
| **Moral injury** | lost child-Eli in network; guilt he won't perform as holiness |
...
| Pattern | Behavior |
|---|---|
| **Converted grief** | policy instead of mourning after carrier loss |
| **Moral certainty as dissociation** | private ledger of dead — love misfiled as admin |
| **Compassion fatigue → control addiction** | built tracing that saved lives; can't stop building cages |
| **Sincere paternalism** | pathology is **believable care**, not cartoon evil |

---

## The Custodians — collar as trauma
...
| **Shireen** | Secondary persecution stress | family still entangled in mother hunt |
...
Wound object only — **no on-page psychology**. Lives in Wren's avoidance, Sora's betrayer trauma, sonic-tuner stillness (Part V Ch 8).

---

## Dramatizing without pathology lectures

1. **Under stress primarily** — baseline drift, not constant melodrama.
2. **One symptom cluster per scene** — don't stack.
3. **Refused behavior proves growth** — Somchai's *no*; Wren's third loyalty; Eli's Manual Override.
4. **Part V leak can expose trauma** — Wren's bun (can't rest); Suresh's wrong notes (grief); Sora's collar touch (leash).
5. **Research floor** — Eli Fever scar and any clinical presentation: medical/sensitivity readers before final prose (`15`).

---

# Part VII — Still open (track in `99_open_questions.md`)

- Lock witness personal detail (tune vs. name vs. fact).
- ~~Lock Hassan fate after breach.~~ **Resolved above** — recaptured, transferred through the Thrace/Balkan holding corridor, rescued Book II Ch 5, returns Rasel's ring.
- ~~Lock Sora defection beat vs. death.~~ **Resolved** — see "Cast-consolidation pass" note at top of file: defects into Wren's network Book III, dies Ch 8 protecting the threshold network.
