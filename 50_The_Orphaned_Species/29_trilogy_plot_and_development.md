...
**The Book III revelation (author direction 2026-07-22 — the resolution of the gender architecture).** Late in Book III it is **understood as revelation, not argued as position**: the sorting and the sacrifice are not the settlement's inventions — they are the species' oldest machinery. **Women instinctively sort men into accepted and rejected** — the selection engine, older than every institution, and the Ch 12 bottleneck evidence was its archaeological receipt (17:1; caste-filtered fatherhood; king lists swelling while family trees stop being written). **And men must do the risky things, as they always have** — bear the danger, stand at the perimeter, and sometimes die for the peace — because that risk-bearing is the standing payment that keeps the genders in balance; when men stop carrying risk, the surplus does not vanish, it ferments (raiders, Sol's coalition), and when risk is carried *remotely* (the drones), peace loses its moral regulator — **the guardian who can die has skin in the peace; the operator who cannot has only a target list.** Neither instinct can be abolished. The revelation is the registers concept applied to the deepest layer: **an instinct you know you're running is agency; one you've renamed as justice is the machine.** So the mature settlement does not delete the sorting or the sacrifice — it **keeps them**: the cloisters make male risk *chosen, witnessed, honored, and grieved* (rites in, names spoken, the chain holding the widow and the son); the sorting is made *honest and revisable* — a rejected man can trial back in, which no instinct offers and only an institution can. Craft delivery: assembled, never speeched — the drone operator who requests perimeter duty *in body*; the first cloister cohort walking toward the danger the drones used to own; a grandmother saying the old quiet thing at a funeral with the whole settlement finally listening: *he stood where it was worst, and we say his name.* **Guardrail:** the revelation dignifies the risk-bearers without romancing death — the book's price sheet stays honest (the veteran unrepaired, the grief unpaid-off), and "not much better" remains true of every arrangement that keeps only half its people.
