...
Dangers, per no-sides: the ply is the lever on any Weaver — capture one, steer the other — and a Weaver severed from her ply has lost her witness: her ledger goes unaudited. **This is Wren's arc mechanism named:** never ring, always at knife distance from it — she and Rowan discovered it together and the ply split over how to fight it (distance vs contact); wearing the ring's skin for years, with contact dark for security and the ply never unbound, she had no one entitled to check her arithmetic — the Laleh falsification is what a ledger does with no ply to answer to, and a woman who impersonates the apparatus long enough must ask nightly which procedures are still costume. Asha performs ply-work without the bond (refusing to certify, demanding return rights), which is why her reforms read as a constitution replacing what the ply once provided. Folk echo: the crowd's *sons-of-Deiwos* twinning of Eli and Somchai is the world reading two strangers as a ply — the pattern is old enough that people recognize its shape before its name.
