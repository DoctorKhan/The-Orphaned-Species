...
**Resolution — not a refusal scene.** Eli never denounces the name; he **re-teaches** it. The Volume III rootbook/concordance beat (`52` Book III): the older layer of *deiwos* is just *the daylit sky* — a word for weather, not a warrant for kneeling — and beside it the earth song-name register (Ki/Enki, horizontal) turns out to be the grammar of what the cells are actually *doing*, which is feeding strangers. The practice shifts, Weaver-style, from marks to memory: washable chalk, rotating signs, houses known rather than written. The support survives; the kneel dissolves. Sol keeps the vertical reading, and that becomes one of the visible differences between his network and the federation's.
