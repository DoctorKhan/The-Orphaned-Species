...
- **The inversion of the quiet-culture rule:** *no one outside is owed the knowing — your ply is owed all of it.* Not as duty. As fact: she already knows; she was there.

A ply is lifelong, may be romantic or not and may move between, and is orthogonal to the Net's knots — a ply is not a marriage, and neither bond constrains the other. It ends only by death or the **unbinding**, a completed rite of release (`19` § Formative bond and renewed desire) — which is why an un-unbound ply *remembers*: reflexive coordination, bodily familiarity, and the right-to-truth survive the end of the shared life. **The bond remembers; the person still chooses.**
