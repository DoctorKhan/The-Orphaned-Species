# The Divine Council — a reconstructed roster

*Working roster of the "seventy sons of El" / the gods of the nations, for Book 5. This is the partial, defensible reconstruction described in `45_divine_names.md` — assembled from the four evidence streams, with confidence flagged. It is grounding for the bible, not prose, and not a decoder ring (see craft rules at the end and in `45_divine_names.md`).*

---

## Read this first — the honest caveats

1. **There is no ancient master-list of seventy named sons.** "70" is a symbolic, recurring slot-count, not a register: the **seventy sons of Athirat** at Ugarit (KTU 1.4 VI), the **70 nations** of Genesis 10, the **70** of Jacob's house (Exod 1:5; Deut 10:22). Deut 32:8 (DSS/LXX) ties them: El Elyon divides the nations "by the number of the sons of God." Some traditions count **72**.

2. **This roster is reconstructed, not transmitted.** It triangulates: (A) **Ugaritic pantheon god-lists** (KTU 1.47, 1.118; Akkadian parallel RS 20.24), (B) **biblical "gods of the nations"** data, (C) **toponymy** — place-names that fossilize a god, and (D) **theophoric onomastics** + comparative ANE lists.

3. **Confidence is flagged** ◆ strong · ◇ moderate · ○ speculative. Treat ○ entries as mythic rhyme only.
...
*(Covered fully in `45_divine_names.md`; repeated here so the council has a top and a bottom.)*
...
| **Mot** ◇ | Death, the underworld throat | — | Ugarit (Baal vs. Mot) | the swallowing-grave tier |
...
|---|---|---|---|---|---|
| **Baal / Hadad** | storm, kingship | Canaan / Aram (many local Baals) | Baal-Hermon, Baal-Zephon, Baal-Peor, Baal-Gad | Ugarit Baal Cycle; throughout OT | ◆ |
| **Chemosh** | national war-god | **Moab** | — | Num 21:29 ("people of Chemosh"); 1 Kgs 11:7; **Mesha Stele** | ◆ |
| **Milcom / Molech** | national god | **Ammon** | — | 1 Kgs 11:5,7; 2 Kgs 23:13 | ◆ |
| **Dagon / Dagan** | grain, then national god | **Philistia** (orig. Mari/Ugarit) | **Beth-Dagon** | 1 Sam 5; Judg 16 | ◆ |
| **Qos / Qaus** | national god | **Edom** | theophoric names (Qos-gabri) | epigraphic; implied in OT | ◇ |
| **Hadad-Rimmon** | storm god | **Aram / Damascus** | **Beth-Rimmon** ("house of Rimmon") | 2 Kgs 5:18; Zech 12:11 | ◆ |
| **Baal-Zebub** | (Baal of) the oracle | **Ekron** (Philistine) | — | 2 Kgs 1 | ◆ |
| **Ashtart / Astarte** | war & love | **Sidon** | **Ashtaroth**, Be-eshterah | 1 Kgs 11:5 | ◆ |
| **Bel-Marduk + Nabu/Nebo** | imperial pair | **Babylon** | **Mount Nebo**, town of Nebo | Isa 46:1 ("Bel bows, Nebo stoops") | ◆ |
| **Tammuz / Dumuzi** | dying-and-rising | Mesopotamia (cult in Jerusalem) | — | Ezek 8:14 | ◆ |
| **Queen of Heaven** | (Astarte / Ishtar) | Levant / Mesopotamia | — | Jer 7:18; 44:17–25 | ◆ |
| **Gad** & **Meni** | Fortune & Destiny | Levant | **Baal-Gad**, **Migdal-Gad** | Isa 65:11 | ◇ |

---

## C. The Ugaritic pantheon — recovered by god-lists and toponyms

*Deities of the divine assembly (*phr ilm*) named in the Ugaritic god-lists, many of which survive in Israel only as fossilized place-names — the divine council demoted to geography. **This is the cluster the book should lean on**: each name is a god surviving without its meaning, exactly like the Part I village's "Ki, Enki."*

| Deity | Domain | Toponymic fossil | Attestation | Conf. |
|---|---|---|---|---|
| **Shapshu / Shemesh** | sun | **Beth-Shemesh**, En-Shemesh, Ir-Shemesh, Mt. Heres | Ugarit god-lists; OT toponyms | ◆ |
| **Yarikh** | moon | **Jericho** (*Yeriḥo*) | Ugarit (Yarikh & Nikkal) | ◇ |
| **Horon / Hauron** | chthonic, serpent-warding | **Beth-Horon** ("house of Horon") | Ugarit; Egypt (Hauron-Harmachis / the Sphinx) | ◆ |
| **Anat** | war & love | **Anathoth**, **Beth-Anath**, Anat-Bethel | Ugarit; OT toponyms; Elephantine | ◆ |
| **Resheph** | plague & war | Resheph place-names; survives as common noun | Ugarit; Deut 32:24, Hab 3:5 ("reshep") | ◆ |
| **Kothar-wa-Khasis** | craftsman / smith | — | Ugarit (the divine artisan) | ◇ |
| **Athtar** | Venus / morning-star; failed usurper | South-Arabian cult | Ugarit (tries Baal's throne); cf. Isa 14 "Helel ben Shahar" | ◇ |
| **Shahar** & **Shalim** | dawn & dusk twins | **(Jeru)salem** ← Shalim | Ugarit ("The Gracious Gods"); Isa 14:12 (Shahar) | ◇ |
| **Dagan** | grain | (see Dagon above) | Mari, Ugarit | ◆ |
| **Nikkal** | orchard / moon-consort | — | Ugarit (Yarikh & Nikkal) | ◇ |

---

## D. The resettlement gods — a ready-made mini-list (2 Kings 17:30–31)

*When Assyria resettled foreign peoples in Samaria, the text names the gods each group brought — an actual ancient list of national deities, i.e. several "sons" in one verse.*

| Deity | Brought by (nation) | Likely identity | Conf. |
|---|---|---|---|
| **Succoth-Benoth** | Babylon | Sarpanitu / Banitu (Marduk's consort)? | ○ |
| **Nergal** | Cuthah | Mesopotamian underworld god (real, well-attested) | ◆ |
| **Ashima** | Hamath | attested deity; cf. "Ashima of Samaria" (Amos 8:14); Elephantine Ashim-Bethel | ◇ |
| **Nibhaz** | Avva | obscure | ○ |
| **Tartak** | Avva | obscure | ○ |
| **Adrammelech** | Sepharvaim | Adad-milki? | ○ |
| **Anammelech** | Sepharvaim | Anu-malik? | ○ |

Other foreign gods named in passing across the OT, usable as portions: **Nisroch** (Assyria, 2 Kgs 19:37), **Nehushtan** (the bronze serpent, 2 Kgs 18:4), **Sikkuth & Kaiwan** (Amos 5:26 — Saturn deities).

---

## E. The late angelic-prince layer — flag as derivative

*Second-Temple and rabbinic tradition re-skins the seventy sons as **70 guardian princes (*sarim*) of the nations**. These are late, inconsistent, and theologically reworked — usable as the *covenant-era memory* of the council (Eden III → Phase VIII), not as primary evidence.*

| Prince | Nation | Source | Conf. |
|---|---|---|---|
| **Michael** | Israel | Dan 10:13,21; 12:1 | ◆ (biblical) |
| "Prince of **Persia**" | Persia | Dan 10:13,20 (unnamed) | ◆ (biblical, unnamed) |
| "Prince of **Greece**" | Greece | Dan 10:20 (unnamed) | ◆ (biblical, unnamed) |
| **Dubbiel / Dobiel** | Persia | 3 Enoch; b. Yoma 77a | ○ |
| **Samael** | Rome / Edom | later midrash | ○ |
| **Rahab** | Egypt | rabbinic; also a sea-monster name | ○ |

Frame: Targum Pseudo-Jonathan on Deut 32:8 reads "**70 angels**" for the divine sons — the explicit late identification of the council with the nation-guardians.
...
|| **Prince of Persia** | **Rival bloc** — Daniel's blocker. | **Vol II–III:** callsign first; late reveal as **national sar** — human operator wearing a title, revealed at the distant corridor attack (**Vol III Ch 8**, Ch 13 seed). Whether an other-plane agent backs the bloc = **ON HOLD → § H** |
...
|| **Prince of Persia** | **Ch 13:** rival psion team on the ground (no name yet) | Daniel register + unit callsign **"Prince"** or **"Persia hold"** in intercept/briefing (chapter TBD) | codename resolves to **national sar** — partition war, not a demon; human operator was wearing a title, revealed on the ground at the distant corridor attack (**Vol III Ch 8**, chapter-pinned 2026-08-08, `33` § *Ch 8*) — other-plane backing = **ON HOLD → § H** |

**Cast lock:** **Sora Vithan** carries Michael (Vol I seed → **Vol III Ch 8**: defects into Wren's network and dies defending the threshold house destroyed there, medal returned to her sister — chapter-pinned 2026-08-08). **Rival national team** wears Persia-prince callsign (Vol I Ch 13 → **Vol III Ch 8** reveal, same engagement as Sora's death). **Healer** carries Gabriel projection (Vol II rumor → late Ch 9 single hard no → Vol III withering).

**Still open (`99`):** **Prince** callsign holder's personal name — **LOCKED (2026-08-01):** Middle Eastern / Persian Gulf framing confirmed; chapter now pinned to **Vol III Ch 8**; personal name remains author's choice at draft time. **Michael watched-depth — LOCKED:** portion-logic Eli reads at a charged ground in Vol III, not an encounter; chapter pin still deferred — the Ch 8 pin above resolves Sora's death and the rival team's identity only, not this separate watched-depth beat, which remains open.
...
|---|---|---|
| **Name ladder** (Michael, Gabriel, Persia prince) | Plot **seeds** only | Vol I–III references in § G plot ladder — iconography, callsigns, limit rhymes |
...
| **Healer limit / Eli anti-throne** | **LOCKED** drama | Independent of whether Gabriel is a real messenger elsewhere |
...
1. **El / Ilu** (= Anu) ◆
2. **Elyon** (title of El) ◆
3. **Asherah / Athirat** (= Ki/Antu) ◆
4. **Ilib** — Ugaritic ancestor-god, heads the offering lists ◇

**Chaos & death tier**
5. **Yamm** (= Tiamat / *tehom*) ◆
6. **Mot** — death ◇

**Storm-king & the Baals**
7. **Baal / Hadad** (= Marduk) ◆
8. **Baal-Zaphon** — Baal of Mt. Zaphon ◆
9. **Baal-Zebub** — Ekron ◆
10. **Hadad-Rimmon** — Aram/Damascus ◆

**Sun, moon, astral**
11. **Shapshu / Shemesh** — sun ◆
12. **Yarikh** — moon (→ Jericho) ◇
13. **Nikkal** — moon-consort ◇
14. **Athtar** — Venus / morning-star ◇
15. **Shahar** — dawn ◇
16. **Shalim** — dusk (→ Salem) ◇
17. **Sikkuth** & **Kaiwan** — Saturn (Amos 5:26) ◇

**War, plague, underworld**
18. **Anat** — war & love (→ Anathoth) ◆
19. **Resheph** — plague & war ◆
20. **Nergal** — underworld (Cuthah) ◆
21. **Horon / Hauron** — chthonic, serpent-warding (→ Beth-Horon) ◆

**Craft, healing, birth**
22. **Kothar-wa-Khasis** — divine smith ◇
23. **Kotharat** — birth-goddesses ◇
24. **Pidray** ◇ · 25. **Tallay** ◇ · 26. **Arsay** ◇ — Baal's daughters (light / dew / earth)

**Grain, fertility, fortune, dying-rising**
27. **Dagon / Dagan** — grain (→ Beth-Dagon) ◆
28. **Tammuz / Dumuzi** — dying-and-rising (Ezek 8:14) ◆
29. **Gad** — Fortune (→ Baal-Gad) ◇
30. **Meni / Manat** — Destiny ◇

**The Astarte / Ishtar complex**
31. **Astarte / Ashtart** (= Queen of Heaven; → Ashtaroth) ◆

**The explicit national portions**
32. **Chemosh** — Moab ◆
33. **Milcom / Molech** — Ammon ◆
34. **Qos / Qaus** — Edom ◇

**The 2 Kings 17 resettlement gods**
35. **Ashima** — Hamath ◇
36. **Succoth-Benoth** — Babylon ○
37. **Nibhaz** ○ · 38. **Tartak** ○ — Avva
39. **Adrammelech** ○ · 40. **Anammelech** ○ — Sepharvaim

*— end of the West-Semitic core (40). Below: the wider pantheons of the 70 nations. —*

**Mesopotamian high council (An = Anum)**
41. **Enlil** — executive king ◆
42. **Enki / Ea** — wisdom/craft ◆
43. **Marduk / Bel** — Babylon ◆ *(= the storm-king tier; named here in his imperial role)*
44. **Nabu / Nebo** — scribe-god (→ Mt. Nebo) ◆
45. **Sin / Nanna** — moon ◆
46. **Ishtar / Inanna** — *(Mesopotamian form of #31)* ◆
47. **Ninurta** — war/agriculture ◆
48. **Ereshkigal** — underworld queen ◆
49. **Nusku** — fire/light ◇
50. **Erra** — plague/war ◇
51. **Ninhursag** — mother-goddess ◇
52. **Gula** — healing ◇
53. **Kingu / Qingu** — the slain progenitor *(in-canon: the reserve-stock name + the propaganda god; see timeline)* ◆
54. **Nisroch** — Assyrian, obscure (2 Kgs 19:37) ○

**Theogonic ancestors (Enuma Elish)**
55. **Anshar** ○ · 56. **Kishar** ○ · 57. **Lahmu** ○ · 58. **Lahamu** ○ · 59. **Mummu** ○

**Phoenician / Punic city-gods**
60. **Melqart** — Tyre ◆
61. **Eshmun** — Sidon (healing) ◆
62. **Baal-Hammon** — Carthage ◆
63. **Tanit** — Carthage ◆
64. **Baalat-Gebal** — Byblos ◆

**Aramean / Palmyrene**
65. **Bethel** — the deified (Elephantine) ◇
66. **Atargatis** — the Syrian Goddess ◇
67. **Aglibol** — moon, Palmyra ◇
68. **Yarhibol** — sun, Palmyra ◇

**Arabian**
69. **Allat** ◇ · 70. **al-Uzza** ◇ — (with Manat ≈ #30, the three "daughters")

*Spares beyond 70 (borderline / cult-objects): **Nehushtan** (bronze serpent), **Hubal** (Mecca), **Eshem-Bethel** (≈ Ashima).*

**Tally.** The strict West-Semitic core (1–40, dedup) is the honest answer to "how many *sons of El* can we name": **~40**, of which roughly **24 are ◆ strong**. Reaching a full **70** requires reading "the seventy" as **the gods of the seventy nations** and aggregating the neighboring pantheons (41–70) — which is legitimate, since that is what Genesis 10 / Deut 32 actually frame, but it mixes pantheons and lowers average confidence. **Bottom line: ~40 defensible, 70 reachable only by widening scope.**
...
1. **Toponym test.** Find a place-name with a divine element: `Beth-X`, `Baal-X`, `X-el`, `Migdal-X`, `Anat-`, `-shemesh`. Check whether **X** is an attested deity in Ugaritic/Mesopotamian god-lists. Hit = a fossilized son.
2. **National-god test.** Any deity the OT names as belonging to a *people* (Moab's Chemosh, Ammon's Milcom) is a portion-holder by definition under Deut 32.
3. **God-list cross-check.** Match a candidate against KTU 1.47 / 1.118 / RS 20.24 (Ugarit) or Mesopotamian An = Anum lists.
4. **Onomastic test.** Theophoric personal names (`-baal`, `-gad`, `-anat`, `-qos`) reveal which god was live in a region even when no temple survives.

Each new entry: assign a confidence flag and, if speculative, mark it ○ so the prose never leans on it as fact.

---

## Craft note — how the book uses this

- **The map is the buried roster.** The strongest device here is **Section C**: the divine council survives as place-names that no longer know they are god-names — Beth-Horon, Beth-Shemesh, Anathoth, Jericho. This is the **landscape-scale version of the Singing Village** keeping "Ki, Enki, the names that survived without their meanings" (`37_deep_time_source.md`). The portions of Deut 32 are still legible in the dirt.
