...
| **Forest City, outbreak refuge** | Residents compare observations, plot them, and separate rumor from repeatable pattern. Eli learns that distributed, accountable reporting can reveal what one gifted observer cannot. | The refuge supplies method and allies, not a dystopian lesson. Later, scattered reports of abnormal growth become usable evidence because Eli learned how to organize them here. |
...
The cave is local to Bronze-Age **Aedan**, an early receiver whose partial record later becomes one of Eli's access paths. It bends vision, not body. What it shows divides into two registers:

- **Stories shown** — myths and parables the cave plays before Aedan: the Seven Pairs, Activation, War in Heaven, and **Adapa**. He watches; he is not in the scenes.
- **Carrier echoes** — incomplete flashes, sensations, motifs, and practices from the Seven. Aedan cannot hold any of them as a complete person and never becomes them. In the present trunk, **Eli** receives the full embodied imprints directly from the resonance archive. The distinction is ethical and structural: full access does not make a life his.

He returns to himself in Part IV — older, in the same cave, with a choice to make. In the full novel, Eli later reaches Aedan's residual record and discovers that transmission has always moved through partial receivers, objects, songs, and places. The boy is not Eli and was not being shown his own future incarnations.

**The cave as nervous system (legacy cohesion device).** Retain this sensory architecture for Aedan's partial relay and echo it in Eli's present integration, but do not use it to imply shared identity:

- *Between carrier echoes Aedan surfaces physically altered,* but with fragments rather than ownership: temperature gradients after Ila's trace, the edge of other minds after Tem's. In the trunk, Eli receives fuller imprints and must name whose fragment remains. Stories shown leave a recognition or question rather than a practice.
...
Stories shown. The boy watches; he is not in the scenes. Voice should drift toward myth-cadence. These are myths the cave plays before him, **Adapa** included. Carrier echoes begin in Part III, but remain fragments rather than inhabitations.
...
**8. War in Heaven**
The generational conflict. The Igigi rising against the Anunnaki. The boy sees the Younger Dryas comet from above, then from below. The planetary network fractures with the catastrophe: routes fail, and paired ends remain where continuity existed before. Marduk kills Tiamat — and Tiamat is the dragon at the cave's mouth. The boy understands which side his cave is on, but the vision still does not name positive, negative, or ley line. The reader receives the break before the manual.
...
Seven historical chapters, seven distinct people, one practice per chapter. In the trunk these are the full imprints Eli receives; inside Aedan's cave relay they appear only as partial flashes and bodily residue. Each chapter keeps the shape *encounter → instruction → first success → glimpse → loss*, but no teacher or artifact needs to prove a single ancestry. Transmission may occur; independence and rediscovery may also occur.
...
Seeded so far:
- **The 17:1 bottleneck** (Karmin et al. 2015) — the Y-chromosome collapse showing patriarchy was *installed* over millennia. Anchors Ch 13 (Tem).
...
8. Stories vs. carrier records. **Locked: Aedan receives stories shown plus partial carrier echoes; Eli receives the Seven's full embodied records.** Neither mode implies reincarnation or ownership. Stories leave recognition/questions; carrier records leave embodied information that still requires practice.
