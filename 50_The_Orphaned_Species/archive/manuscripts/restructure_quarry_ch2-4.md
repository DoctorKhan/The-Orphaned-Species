...
> **Status: QUARRY, not canon (moved out of `manuscripts/I_The_Breach.md` 2026-07-22).** This is the pre-restructure Chapter 2–4 prose. The canonical Chapter 2 is in `manuscripts/I_The_Breach.md` (sustained flight ending at the breach); decision flags live in `DECISIONS_Chapter_Two.md`, which absorbed and corrected the usable Malacca material here.
>
> **Reuse audit — 2026-08-06:**
> - **Usable as scene salvage:** Suresh's character voice and the Malacca marina/chandlery texture inform his later Book I/II appearances. The general street-level Malacca atmosphere and the white-coat pursuit pattern are reusable. The chandlery boy's silent intelligence can seed Salmah's introduction if reworked.
> - **Permanently dead — do not restore:** the kiddy-car chase through the waterpark (retired to quarry 2026-07-24); the direct Pelangi Reach→Malacca route without Singapore intermediate (canon: southern exit through Singapore first per `31`); the "seven chambers / seven rooms" breach framing (canon: undifferentiated field-noise, `36` §3a); Grid/Nodes/Wire/Conductor capitalized jargon (`95` vocab ban); the King-James register passages (locked voice: present-tense close third); the ring remaining in Eli's hand at the chandlery (canon: ring remains with Hassan); the chandlery man/boy as the breach rescuers (canon: Salmah); solo-Eli-to-Pai immediately after Malacca; the Khun Dang / Hotel California route (current Thailand material is the short keeper-house grounding/memory hinge in Ch 11).
> - **Character note:** Hassan in this prose is the chandlery man with the ring. In current canon Hassan enters differently. The ring detail is reusable; the role is not.
...
"English," Eli says. "Her name was Maren Holt. Always Holt. My father was Rasel Khan — Rasel on the forms. I'm Holt, not Khan."
