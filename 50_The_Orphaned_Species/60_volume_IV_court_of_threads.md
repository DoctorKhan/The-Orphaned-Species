...
> emergency crowns answer emergency crowns; every faction tries to secure the
> part it cannot bear to lose and thereby enlarges the common danger. His mature answer
...
> IV measures development by what he does **not** build around a dream. He records
> it, checks bodily and hostile-influence explanations, shares it only where
> relevant, and does not use it to settle succession, pregnancy, guilt, route
> priority, or policy. If a late dream rhymes with birth or transfer, nobody
> interprets it publicly and no outcome confirms it as prophecy.
...
> is systemic, not a Sea Peoples reenactment and not a single-cause allegory:
> tightly coupled centers lose archives, specialized supply, routes, and
> legitimacy under several pressures at once; outcomes are uneven; people,
> knowledge, and exchange continue in altered forms after central institutions
...
> armed protection. These couple with water, medical, displacement,
> misinformation, and retaliatory pressures that no mastermind created as a
> whole. Some settlements
> improvise, some centralize, some evacuate, and at least one fails. The victory
> is not that every node survives. It is that failure does not synchronize.
>
> **Decentralization means modular interdependence, not autarky.** Communities
> keep minimum local capacity in water, food, care, repair, testimony, and
> defense while retaining several nonexclusive routes for what cannot be local.
> The compact distributes protocols and practical competence, not merely legal
> offices. Book III's work-song becomes one small proof: children and new workers
...
> that the eastern Mediterranean collapse caused Buddhism. The Late Bronze Age
> crisis centers around 1200 BCE; the conventional Axial Age frame is roughly
> 800–200 BCE; early śramaṇa movements and Buddhism emerge especially in the
> sixth–fifth centuries BCE within South Asia's own second-urbanization, trade,
> state, and Brahmanical contexts. Book IV therefore plants conditions, not a
> finished new religion: portable disciplines, renunciant or service houses,
> shared meals, work-song, witness circles, care for the dead, itinerant teaching,
> and authority grounded in practiced conduct rather than palace, sacrifice,
> lineage, or ruler. Several answers must appear. Some turn inward, some serve,
> some preserve Eli as a messiah, and some begin hardening liberation into a new
> institution or father. The closing society asks not only how to rebuild rule,
> but what kind of life deserves rebuilding.
>
> **Research floor:** [Knapp and Manning, *Crisis in Context*](https://doi.org/10.3764/aja.120.1.0099)
> (uneven, multicausal Late Bronze Age transformations); [Manning et al.,
> *Are civilizations destined to collapse?*](https://doi.org/10.1016/j.gloenvcha.2023.102792)
> (coupled network failures); [Fogelin, *An Archaeological History of Indian
> Buddhism*](https://academic.oup.com/book/7301) and [Bailey and Mabbett, *The
> Sociology of Early Buddhism*](https://doi.org/10.1017/CBO9780511489167)
> (sixth-century BCE origins and the urban, economic, political context). These
> support the structural rhyme and the guard against direct causation.
>
> **CIVIC ECOLOGY / FAILURE FIELD — LOCKED 2026-08-01:** Decentralization is
> not the moral answer by itself. A local council can become a clan court, a
> defense crew a militia, a market a debt regime, a service house a church of
> purity, a sports club a recruiting office, and a psion circle a caste. The
> surviving order works because affiliations overlap and no institution is
> allowed to define the whole person. Rivals play under independent officials,
> trade through several routes, eat in one another's service houses, train in
> mixed workshops, use common clinics, and carry standing into appeals outside
> the place that harmed them. **Authority is local; personhood and appeal are
> portable and federated.** The compact's three operating rules are: decide as
> near as possible to consequence; standing survives every border; harm can be
> appealed beyond the community that caused it.
>
> The system must fail visibly. Sports produce settlement chauvinism, betting
> debt, cheating, psion suspicion, injury concealment, youth ranking, and
> military scouting. Commerce produces hoarding, route cartels, counterfeit
> credit, price leverage over essentials, and attempts to purchase office.
> Spirituality produces service and mourning alongside founder worship,
> revelation-as-command, sexual or doctrinal gatekeeping, and prestige disguised
> as renunciation. Technology distributes repair capacity but also hides control
> in identity systems, proprietary parts, automated scores, and networks that
> fail gracelessly. Psionic practice aids rescue, diagnosis, and attestation but
> invites mind-entry, emotional profiling, performance enhancement, and a new
> hereditary or professional caste. None is solved by prohibition. Each is
> bounded by consent, independent review, mixed membership, multiple routes,
> transparent rules, repairability, exit, and appeal—and each boundary remains
> vulnerable to capture.
>
> **Sports are the compact in miniature.** Use a regional games-and-market
> gathering in Chapter 7. It combines bounded rivalry, child and adult play,
> trade, equipment exchange, service-house hospitality, repair teaching, and
> psion/nonpsion participation. A disputed result exposes concealed psionic aid,
> gambling pressure, settlement grievance, and an attempt to turn athletes into
> security recruits. The dispute nearly escapes the field. It does not end in a
> speech or universal reconciliation. Independent officials void the result;
> harmed competitors retain appeal; a merchant loses a contract but not civic
> standing; the recruiting captain is removed from selection; the teams still
> share the post-match meal because other obligations remain. The same people
> meet again as medics, mechanics, hosts, traders, kin, and witnesses. The scene
> gives the governing dramatic truth: **they do not eliminate rivalry; they keep
> rivalry from becoming identity, and identity from becoming permission to
> kill.**
>
> **Governing outcome:** the court fails as a functional palace. Society changes
> shape and continues. By the climax, ports, farms, clinics, councils, Weaver
> routes, and cloister companies have already operated through a real interval
> without Eli or a trusted center. His final transfer recognizes that fact. It
> does not gamble that they might someday manage without him.
...
Caribbean, and Pacific nodes already connected by Book III's compact. Costa
Rica is Central America and functions as the inhabited isthmus between the
court's Eagle–Condor rhetoric, not as “South America,” empty transit ground, or
a morally pure sanctuary. Local councils, Indigenous authorities, clinics,
growers, ports, and route houses set capacity and admission terms, sometimes
refuse northern demands, and do not surrender local records to the court.
...
The ground still behaves: a spring at the old cube fence that does not fail in the Hollow Year, Courage-field vertigo the pilgrims came for. Suppression of devotion is permits, checkpoints, a crackdown or dispersal the court has to answer or decline (`95` § *Sacred devotion*). Eli's relationship stays oblique — he is not there to resolve the Cube, only to register that the state he provisionally governing treats a living ground and its people as a threat. He visits the fence once, without Wren or Rowan, and stands motionless in the same posture the reserve uses for sitting, not because he knows the ritual but because his body has done this before at two other sites without his permission. The vertigo arrives. He does not name it courage. He does not name it contact. He breathes through it the way he breathes through any pressure he cannot immediately route to a file, and leaves before the spring changes its rhythm.

> **Heather cube-body beat — LOCKED 2026-08-18 (`59` § *Eli's cube-body sequence*).** This is Eli's third and final guardian-spirit contact: heart center, felt as vertigo/ground-response, during motionless sitting/proximity at the fence. He never names it, never integrates it, and never claims it. His only residue is continued ordinary work. The book must not explain the sequence.
...
working landscapes. Mixed trees hold water and soil, shade people and crops,
stabilize slopes, feed households and animals, and keep pollinator and wildlife
...
does; growers and public measurements must verify it. Trees never issue moral
orders or transmit human memories. The court's first bad proposal clears a
living strip for rapid shelter and replaces diverse local stock with one
fast-growing certified clone. The route councils instead salvage stormfall,
site temporary shelter on already altered land, plant several locally chosen
species, and reduce the intake. The smaller number is not aesthetic purity: it
is what keeps water moving and the roaded slope above the clinic in place.

**Capture and disagreement:** Continuity seeks sensor access and an allocation
key for the canopy; merchants sell decontextualized “corridor credits”; Sol
calls rooted interdependence proof that sovereignty is obsolete. Local actors
also disagree: conservation payment can privilege title-holders, protected
land can exclude people, tourism can turn restoration into spectacle, and a
forest rule can erase the needs of farms and towns. Do not give Costa Rica one
ecological voice. The durable settlement treats restoration, nursery work,
selective harvest, agroforestry, hydrology, and monitoring as paid civic labor
under local review.

**Work-song / teaching payoff:** Nursery and restoration work carry the earlier
series insight that rhythm and repeated movement teach a task socially. Older
growers work beside adolescents and newly arrived adults. Younger children may
sort robust seeds, fill pots, carry light water, keep rain marks, and learn short
work refrains under explicit age, schooling, rest, and refusal limits. The songs
...
**Eagle–Condor court use:** Book III established the teaching as multiple,
living, and contested. Book IV shows capture. Sol calls hemispheric fusion the
prophecy's fulfillment. Continuity officials argue that South American supply
and Costa Rican passage are obligations of continental unity. Merchants brand
an emergency route after the birds. Brazilian and Costa Rican participants
answer that flying together is not becoming one bird, one command, or one
resource ledger; they also ask who disappears when the isthmus and Brazil's
distinct peoples are flattened into a North/South binary. The story never
confirms the teaching through omen or inevitability. Its only proof is
cooperation that preserves refusal.

The mandate is narrower than local sovereignty. Eli may coordinate scarce
resources and obligations **between** participating jurisdictions, preserve
ceasefire and evacuation corridors, and convene review. He cannot command a
settlement's farms, clinics, schools, water, local defense, or admissions merely
because the center is frightened. A local refusal remains legally and
materially possible. The court accretes because access to cross-route decisions
is valuable, not because every community has surrendered rule to it.

Two civic movements save continuity during the second crisis:

- **The Weavers** preserve living attestations, place displaced families,
  restore routes, verify receiving communities, and determine which identities,
  inventories, and messages can still be trusted.
- **The men's cloisters** escort convoys, repair damaged infrastructure, staff
  voluntary relief roles, and keep demobilized fighters from being discarded or
  remobilized without limit.
...
Book IV is led through **women's perspectives**, with **Rowan and Wren as the
principal recurring lenses**. Asha may carry the institutional/audit lens;
Sora, Qiao, Maren, or another already-established woman may receive a bounded
away movement only when she owns a consequential choice Rowan and Wren cannot
witness. Do not turn the volume into a catalogue of female viewpoints.

Eli is no longer the home consciousness. The reader experiences the ruler,
lover, symbol, and prospective father largely from outside. This makes his
public gravity more legible and prevents Rowan's pregnancy from becoming
primarily his emotional experience.

The governing register is **subtle power**:

- access before command;
- seating before battle lines;
- delayed messages before open attacks;
- medical privacy before bodily capture;
- household recognition before succession law;
- placement, hospitality, rumor, ceremony, and attestation as instruments of
  rule.

Book III asks who commands during attack. Book IV asks who reaches the commander,
who prepares the room, whose version enters the record, and who is made to wait.

---

## 3. The court and the two rising institutions

The emergency court forms around Eli because the constituent assembly cannot yet
replace him. It is not a restored monarchy, although monarchic language and
behavior accrete around it.

### The Weavers

Weaver power comes from social infrastructure: household continuity, routes,
placement, welcome, identity attestation, trusted messages, medical and
reproductive privacy, and knowledge of who is actually answerable for whom.
Wren's Knotter craft becomes court power because rooms, audiences, residences,
introductions, and safe placements determine what the ruler can know.

The Weavers divide over:

- remaining a quiet mutual-aid ecology versus accepting public office;
- living attestation versus scalable registry;
- secrecy versus appeal and review;
- protecting Rowan versus claiming authority over her pregnancy;
- whether emergency access rules should become permanent law;
- whether intimacy with Eli gives Wren or Rowan improper influence.

Asha presses for consent, public limits, independent abort contacts, return
rights, audit, and appeal before humane custom hardens into unreviewable state
power. The Weavers may retain civic influence, but they may not become a hidden
sovereign or the sole source of legitimate identity.
...
protection rackets. There is no single Book IV cull that flips demography overnight.
...
**Mirror of the Weavers' own test.** Both rising institutions face the same axis in Book IV, in different currencies. The Weavers risk converting earned trust into "permanent hidden sovereignty" over attestation and legitimacy (§ The Weavers above); the cloisters risk converting earned standing into permanent claims on men's bodies, loyalty, marriage, and descent—Extra discard reversed into scarce-male function. Neither institution's growth is safe by default. Both are tested on whether a necessary historical role hardens into identity and inheritance: the civilization-scale form of adults mistaking what saved them once for what everyone must remain forever.
...
Do not map all women onto the Weavers or all men onto the cloisters. Neither
movement speaks for a sex, and both contain alliances, dissent, class conflict,
regional obligations, and people who belong to neither. Their rivalry is
structural: one controls much of trust and passage; the other much of defense
and repair.

### The inherited labor inversion
...
answerable to aptitude, training, consent, rotation, recovery, appeal, and
continuing care. Rowan's pregnancy changes her own present capacities and risks;
it does not become an argument about what all women should do.
...
Recurring intrigue must operate through concrete stakes:

- certification evidence disappears or arrives through a compromised route;
- an audience list changes and therefore changes policy;
- a survivor is placed in a household that controls her testimony;
- a cloister commander withholds security unless granted formal standing;
- women officers and cloister veterans contest appointments, seniority, risk
  rotation, and whether restored male standing means female displacement;
- a Weaver attestation is challenged as private favoritism;
- a medical record or pregnancy rumor is leaked;
- marriage, consort, paternity, and household language are used to force the
  plural relationships into hierarchy;
- factions delay the assembly while publicly insisting they protect continuity;
- an attempted protection of Rowan becomes surveillance or confinement;
- ceremonial precedence is used to manufacture a successor before law does.

The court's strongest pro-dynasty faction should have a credible case: a named
heir and formal household might prevent civil war. Its error is converting
persons and pregnancy into constitutional instruments.
...
Conception and discovery occur in Book IV, early enough for gestation and birth
to complete within the volume. The court may already be speculating about
consort and heir before conception; its attempt to define the relationship
faster than the people inside it is part of the intrigue.

Rowan is the primary authority over pregnancy, medical disclosure, attendants,
movement, intervention, and acceptable risk. Pregnancy does not make her passive
or magically protected. It materially changes her work: nausea, fatigue, food,
balance, sleep, pain, appointments, route duration, danger tolerance, and later
mobility must affect scenes.

She remains a capable Weft while adapting rather than denying her body. Other
people may offer necessary care; the conflict begins when care becomes custody.
Eli's fatherhood gives him responsibility and a voice in their relationship,
not jurisdiction over Rowan's body. Wren's ply history gives her knowledge and
trust, not automatic medical access.

In a baby-bust society and a messianic court, the pregnancy becomes contested
public property:

- demographic hope;
- proof of divine or genetic continuity;
- a stabilizing heir;
- a target for registry and security;
- leverage over Eli;
- a reason to formalize Rowan and demote Wren;
- a bridge supposedly joining the Weavers and men's cloisters by blood.

The text rejects all of these ownership claims without treating pregnancy,
motherhood, or freely chosen continuity as suspect.

---

## 7. Climax — birth and relinquishment — SIMULTANEITY LOCKED 2026-08-01

Eli prepares the legal and practical transfer throughout Book IV. He does not
abandon public duty impulsively when labor begins. Wren, Rowan, Asha, the
constitutional cloisters, assembly survivors, and other communities make a
credible successor structure possible before the final crisis.

**Simultaneity — LOCKED 2026-08-01:** labor, heir motion, succession vote, and
cloister/Weaver fracture run in the **same hours**, not as sequential admin
chapters with birth as an afterthought. Epic = concurrent institutional and
bodily crisis on the same pages (`17` § *Climax staging*; `55` §6). Birth supplies
the deadline; the prepared transfer supplies the solution. Do not debate
succession to a close and *then* cut to a quiet delivery room.

As Rowan enters labor:

- a court faction moves to recognize the unborn or newborn child as Eli's heir;
- the reconstituted assembly reaches its succession vote;
- pro-Eli cloister chapters threaten to reject any commander not personally
  chosen by him;
- Weaver leaders must decide whether their living attestations will certify a
  dynasty, certify the assembly, or refuse sole control of legitimacy.

The birth pays off the three bonds without turning Rowan into scenery:

- Rowan controls the room, attendants, information, and interventions.
- Wren returns to the oldest ply function: Rowan can lower her guard while Wren
  faces outward.
...
through a material loss of central communication. The
cloisters accept civilian, plural command; the Weavers certify a reviewable
constitutional process rather than a bloodline and accept limits on their own
attestation power.

**Before the child takes a first breath, the crown has ceased to be Eli's.**
...
- Eli is a father and citizen, not permanent ruler.
...
- The men's cloisters retain standing, houses, memory, repair work, and
  consent-bound defense without becoming Eli's personal army.
- The constituent system distributes authority across communities and
  institutions capable of surviving Eli's absence.
- The repair-hall court does not survive as a replacement capital. Cross-network
  functions migrate into rotating, replaceable sites; local functions remain
  local.
- Some communities and people are lost. Decentralization limits cascades; it
  does not confer invulnerability.
- No heir resolves the work of coexistence.

Governing lines:

> Power is not only who gives the order. It is who prepares the room in which
> the order becomes possible.

> A child may continue a life. A child may not be made to continue a crown.

---

## 9. Governing ten-chapter spine — LOCKED 2026-07-28

Book IV spans roughly ten months. The first four chapters cover the court's
first six to eight weeks; Chapter 5 discovers the pregnancy; Chapters 6–8 use
explicit seasonal and bodily time jumps; Chapters 9–10 cover labor, transfer,
birth, and the later ordinary coda. The calendar must be legible through weather,
...
- **Collapse distinction:** federation-wide allocation and authentication fail;
  ...
  cargo, ceasefire, and transfer obligations jam. Eli's reinstated scope is
  cross-route triage only.
- **Wren's choice:** she gives Asha's objection ledger to a review body with
  non-Weaver members and appeal authority. Cost: the Weavers lose exclusive
  control of the evidence that made them indispensable.
- **Relationship:** Wren and Eli remain lovers, but court attempts to treat her
  access as office. She refuses consort privileges and accepts a reviewable
  public route role on her own authority.
...
- **Court engine:** factions cast Rowan as future consort, Wren as mistress or
  ...
  succession. Weaver rivals argue Wren's disclosure rules make her politically
  compromised.
...
- **Romance turn:** work, disagreement, sleep, care, humor, missing one another,
  and private language make Rowan/Eli romantic. They name it after the change,
  not before.
...
- **Political action:** Eli completes a credible transfer package: distributed
  certification, rotating coordination, Weaver audit and appeal, civilian
  control of cloister defense, and no dynastic succession.
- **Coupled-failure middle:** the eruption's delayed climatic and harvest effects
  meet route, water, medicine, displacement, reprisal, hoarding, and export
  pressures. No common author.
  Outcomes diverge: one node adapts, one closes, one hardens, one evacuates, and
  one suffers irreversible loss after waiting for central help. The transfer
  package distributes material capacity and portable procedure, not credentials
  alone.
- **Southern-route proof:** the first northern evacuees reach Costa Rica under
  capacity limits written there, not at court. A North American official calls
  delay betrayal of Eagle–Condor unity; the receiving council publishes the
  missing clinic, water, housing, canopy, slope, nursery, and food-tree counts
  and admits a smaller named group. A court contractor proposes clearing a
  living strip and installing certified quick-growth stock; local councils use
  stormfall, altered ground, and mixed locally selected planting instead. The
  refusal saves the route from collapsing under symbolic generosity.
...
- **Pregnancy discovery:** Rowan privately confirms pregnancy. She controls who
  is told, including Eli and Wren, and sets medical disclosure terms.
- **Leak:** appointment metadata—not Rowan's medical record—reaches a
  pro-dynasty faction. Rumor outruns confirmation.
- **Wren's choice:** she protects Rowan's privacy without pretending privacy can
  erase the political danger. She declines automatic co-parent status and asks
  for time to choose a real role.
- **End hook:** the court announces a “continuity celebration” for an heir
  Rowan has not publicly acknowledged.

### Chapter 6 — The Body of State *(Rowan)*
...
- **Conflict:** an attempted protection becomes confinement. Wren helps Rowan
  leave through ordinary access craft; Eli supports her authority over the body
  even when afraid.
- **False refuge offer:** security proposes moving Rowan to a protected Costa
  ...
  The named receiving institution refuses the dynastic custody terms. Rowan may
  decline the journey for medical reasons without accepting confinement or
  performing invulnerability.
- **Labor inversion:** women officers and cloister veterans negotiate rotation,
  seniority, care work, and dangerous assignments without restoring sex caste.
- **End hook:** a credible threat targets Rowan's medical route, while evidence
  suggests the threat may be intended to justify—not execute—permanent custody.

### Chapter 7 — The Two Houses *(Wren)*

- **Time:** middle pregnancy.
...
- **Games-and-market proof:** before the chamber settlement, Wren attends a
  ...
  settlement slogans begin replacing names. Officials void the result and open
  an external appeal. The teams do not reconcile cleanly, but medics treat both,
...
- **Court engine:** constitutional cloisters demand formal standing; a
  ...
  custody.
- **Wren's relationship to the child:** after time and direct conversation with
  Rowan and Eli, Wren chooses a named role of continuing adult/kin—not automatic
  mother, not outsider, and not constitutional guardian. Exact household terms
  remain revisable.
...
### Chapter 8 — The False Heir *(Rowan)*

- **Time:** third trimester.
- **Immediate want:** finish the succession terms before her mobility and energy
  narrow further.
...
- **Transfer readiness:** successor council, distributed credentials, physical
  backups, abort conditions, and defense oaths are complete.
- **Practical proof:** during the six-hour council test, a real cross-route
  disruption lands. Local nodes act without Eli; the council handles only the
  contested boundary among them. A slower convoy and a local refusal impose
  cost, but no cascade reaches the whole network. In Costa Rica, storm damage
  closes one planted transfer site; nursery crews and apprentices redistribute
  shade, water, and arrivals through a neighboring working landscape using the
  locally written limits. They report after acting rather than petitioning the
  court. Children are visible in safe teaching tasks, never used as surge labor.
- **End hook:** labor is near; the reconstituted assembly schedules the final
  succession vote for the same week.

### Chapter 9 — The Room Prepared *(Wren)*

- **Immediate want:** prepare a birth room that belongs to Rowan while the court
  prepares a constitutional room designed to claim the child.
- **Labor begins:** Rowan controls attendants, information, intervention, and
  who enters. Wren faces outward in the old ply function; Eli remains inside as
  lover and father.
- **Political crisis:** dynasty delegates move to recognize the unborn child;
  pro-Eli cloisters threaten to reject plural command; Weaver leaders are asked
  to certify blood or withhold attestation.
- **Center-loss proof:** before final certification, the court loses its outward
  command channel for long enough that local nodes must govern on portable
  protocols. When contact returns, they report decisions already made rather
  than queue for permission. This—not a speech—is the final answer to the
  dynasty's continuity case.
- **Choice:** Wren releases the final living attestations to the reviewable
  assembly process, ending Weaver monopoly. Constitutional cloisters accept the
  assembly's civilian command and isolate their praetorian chapters.
- **End hook:** officials demand one more continuity extension from Eli while
  Rowan enters active labor.

### Chapter 10 — Before the First Breath *(Rowan, with a hard-break Wren coda)*

- **Climax — simultaneity LOCKED 2026-08-01:** Eli does not leave the birth to seize the political center. From
  Rowan's room, he activates the already prepared transfer **while** heir recognition,
  succession vote, and cloister/Weaver fracture are live in the same hours (`60` §7;
  `17` § *Climax staging*). The reconstituted
  assembly certifies plural civilian authority; the Weavers certify the process
  under audit; the cloisters transfer defense loyalty from Eli to the compact.
- **Meaning:** the transfer catches law up to reality. The network has already
  survived the center's absence; Eli is relinquishing recognition and access,
  not holding civilization together until the final second.
- **Locked timing:** the crown ceases to be Eli's before the child takes a first
  breath.
- **Birth:** bodily, difficult, and governed by Rowan's prior and present
  choices. No supernatural sign, inherited title, prophecy, or perfect family
  tableau.
- **Immediate aftermath:** the child has a private name before any public
  announcement and no civic status beyond personhood. Rowan is mother by choice;
  Eli is father and citizen; Wren's named kin role begins through care, not
  romantic assumption.
- **Coda, months later:** the shared garden and teahouse material retired from
  Book III lands here. Eli pours tea and takes instruction. Rowan, Wren, and Eli
...
- **Closing image:** mountain swifts leave to feed while Eli works in the garden.
  He is wanted and replaceable. Nobody interprets the birds.
...
- No useful institution appears without its plausible capture path, and no
  ...
  correction** active in court, market, clinic, game, service house, workshop,
  household, and psionic practice.
- The regional games are not a unity montage. A child is hurt, the result is
  voided, a family refuses contact, a service house calls accountability
  persecution, and recruitment succeeds with some participants. What holds is
  the plurality of later encounters, not a shared feeling at supper.
- Rowan/Eli sex never occurs because Wren is absent, unavailable, or being
  replaced.
- Wren neither grants nor withholds permission for a bond she does not own; the
  existing relationships require disclosure and renegotiation, not brokerage.
- Rowan wants motherhood before choosing Eli, then separately chooses Eli,
  timing, and conception.
- Pregnancy is not discovered later than Chapter 5.
