...
**Mesopotamian Human-Design Triad — LOCKED 2026-07-25:** **Adapa lacuna** + **Enki and Ninmah role-fragment** + **Sumerian King List (declining reigns)** travel as **one clue leg** (same archive packet, three texts) and recur across the trilogy — foolable mind, purposed roles/specialties, mortal focus (`35` § *Mesopotamian Human-Design Triad*). Adapa is **both** triad member and load-bearing object #3. Ninmah and King List are **mandatory clue-chain texts** with chapter pins in `35`; not a fourth/fifth load-bearing *object*, but equal narrative weight to the triad thesis. **Umul lacuna** pays off Vol III late.
