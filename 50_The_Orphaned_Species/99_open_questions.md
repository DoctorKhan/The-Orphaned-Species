...
**Visuo-spatial talent — LOCKED:** exceptional **visuo-spatial memory and skills** — maps a route once, holds cable/robot geometry in head, reads splice paths fast. **Distinct from** carrier/receiver (Maren) and symbolic feeling (Rasel). **TBI:** inconsistent — sharp in quiet focus; holes under noise/overload.
...
- **Locked — Delphic Games / Laurel Cube contact (2026-07-23; remapped 2026-08-01):** **Book II Ch 4, Delphi** — keeper-supervised consent-bound visionary encounter paired with **giant face / white markings** somatic imprint. **Not Book I Thailand** (wat = breath/Aru only). v1 § *The Medicine* in `archive/manuscripts/v1_archive.md` = quarry; adapt for Delphi; strip v1 cosmology dump; no Book III serpent-as-Makers-face reveal here. Eli drifts through layered vision: the giant face, then older hands performing the same motions across generations, then his own hands moving fast with the same cadence. A fellow incubant beside him stares, eyes wide, and that contact breaks the trance. He comes out of it still moving; afterward he begins to speak with his hands more often, the new vocabulary already operative before he has words for it. Partial memory on exit: body changed; daylight mind cannot carry all.
- **Locked — Laurel Cube witness site (2026-07-23; remapped 2026-08-01):** **Delphi / Kastri**, Book II Ch 4 — paired with Delphic Games contact above.
