...
**Extraction night — LOCKED:** one attack at a **border / third country / keeper handoff** (not Dhaka on-page). **Passport split — LOCKED 2026-07-24:** Maren and Rasel **separated because different citizenship** — not one chain, **two claimants**. **Rasel** (Bangladeshi passport) → **Eastern Mandate** black-lab custody — **Rasel Khan** on files, claim-category physicist; coerced secret research (registry-adjacent instruments, field coupling, or signature physics — exact program TBD). **Maren** (Albion passport; legacy *British* on extraction files) → **Charkha Measure / Ring** chain — claim-category neuroscientist; **parallel convoy**, site unknown to keeper net. Attack may wound and scatter; **file routing** finishes the split. **Eli:** blast/masonry or vehicle impact → **persistent TBI**; healer stabilizes; escape net splits him from Somchai and moves him toward Thailand. **No second attack.** Retired: *Rasel killed during extraction*; *single custody chain for both parents*.
