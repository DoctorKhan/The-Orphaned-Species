...
- **Locked — Delphic Games / Laurel Cube contact (2026-07-23; remapped 2026-08-01):** **Book II Ch 4, Delphi** — keeper-supervised consent-bound visionary encounter paired with **giant face / white markings** somatic imprint. **Not Book I Thailand** (wat = breath/Aru only). v1 § *The Medicine* in `archive/manuscripts/v1_archive.md` = quarry; adapt for Delphi; strip v1 cosmology dump; no Book III serpent-as-Makers-face reveal here. Partial memory on exit (body changed; daylight mind cannot carry all).
