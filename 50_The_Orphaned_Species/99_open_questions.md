...
| Person | Name rule |
|---|---|
| **Eli** | Given name **Eli** (Maren); **dak nam Babu** (বাবু) — Rasel at home, Shireen in Bangla texts; unrelated to *Eli* on paper. **Not** Eli Khan / Eli Rasel / Eli Russell. English/maternal paperwork: **Eli Holt** (mother's line surname on passport, Stack contract, intake). **Europe (Vol II Ch 5):** when asked why not **Khan**, Eli says **Bengali thing** — true for father side; **Vol II Ch 5–6:** learns **Holt** = **matrilineal Alba/Nephilot** custom on mother's side (`99` § *Holt / matrilineal reveal*). |
| **Rasel** | Full legal name **Rasel Khan** (রাসেল খান). **Forms say Rasel** — not Russell. Speech & narration default: **Rasel** / *Rasel's boy*. **Khan on his records only** — not passed to Eli. **Russell:** some English mouths only — Maren in formal English, Anglo corridor workers, clerks mishearing — **habit, not the ink**. Eli says **Rasel** when it matters (one correction per scene max). Reader ease: **one natural gloss** allowed at first significant mention (*Rasel — though some people said Russell*), then **Rasel** in narration. `95` § *Rasel / Russell*; `14` § Culture.
