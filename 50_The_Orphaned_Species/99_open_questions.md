...
- **Conspiracy:** **of the ages** — Charkha = present face of recurring suppression apparatus (pattern, not single bullet).
...
- **Phantom god-perception / mature worship — LOCKED 2026-08-01; control relationship clarified 2026-08-16:** capture = perceiving absent gods as domestication remote collar. In mature worship, practice helps robot (ego) interrupt autopilot and make its controls available to Player (consciousness). False worship routes control to an external claimant or fallacious internal rule. The spiritual payoff belongs in **V–X**, not an I–IV sermon. Book II seed; Book III civic diagnosis; V–X mature liturgy. `17` §9a; `40`; `SERIES_STRUCTURE.md`.
- **Truth, evidence, and reader judgment — LOCKED 2026-08-16:** the Player ontology may be true and scientifically demonstrated in the story world. No manufactured counter-thesis or permanent ambiguity is required. Earn proof through reproducible effects, nulls, false positives, failed predictions, measurement limits, and revised perimeters. Proof grants no access to Player reasons, consent to harm, moral rank, or institutional authority. Competent disagreement remains available around attribution, scope, policy, and conduct. `SERIES_STRUCTURE.md`; `17` §9a; `40`.
...
- **Book I ends at Sanxingdui.** Pelangi Reach → Malacca → Thailand →
  ...
  confronts Rasel, refuses to remain with him, and watches Wren spend her real name and house standing to open
...
- **Book III is the community/network book.** Rasel remains at Sanxingdui after Eli refuses his offer at the end of Book I. Pelangi Reach, the **Thailand river cooperative**, Somchai's clinic network, Wren/Asha threshold houses, and an open Albion ground attempt durable connection without central ownership. Lang's surviving apparatus pressures standardization; Sol pressures militarized centralization. The climax tests whether temporary coordination can disperse after necessity.
- **Parent schedule — REVISED 2026-08-11:** Eli **reaches and refuses father — Book I at Sanxingdui**; Eli **finds and releases mother — Book II at Albion**. Ch 1 learns that no one witnessed either parent's death. Rasel's confrontation directly costs Wren's protected standing and Qiao's institutional access and reveals Maren's early complicity.
...
- **Rasel's garden on Eli's return — LOCKED:** the community took over the abandoned plot and it is thriving because no one preserved it unchanged. Mina and Lopa began tending it; Mei redirected kitchen compost; **Wren kept it on a legitimate maintenance manifest** so the plot could not be confiscated as abandoned; refugee families planted crops Eli does not recognize. His failed tomatoes finally grow because someone grafted them rather than following Rasel's method. Eli feels gratitude, grief, and irrational replacement before recognizing that continuity without ownership is the garden's lesson.
- **Old `31`/`32`/`33` chapter allocations are superseded as spines.** Preserve their scenes as quarry; rebuild chapter beats before drafting beyond the current Pelangi Reach/Malacca manuscript. **Route lock — LOCKED 2026-07-23:** after Malacca, use the substantial **Thailand agricultural-witness sequence** (Ch 5–10); Eli leaves through a Bay of Bengal / Andaman port, crosses into the Gulf/Mesopotamian corridor, and travels north through contested land routes to Göbekli. **Mekong/Vietnam retired.** **Bangladesh — OFF-PAGE:** no village visit in any volume; Shireen's encrypted messages only.
...
- **Still open:** exact calendar year of Eli's parents' disappearance; Somchai primary clinic city (name locked; location: mobile / corridor clinics, provisional flesh in `26_present_day_cast_expanded.md`); **Thailand temple** — specific wat, city, caregiver link, and whether recovery interval is shown in flash or only as Vol I habit leak (`15` § *Eli's meditation seed* — LOCKED in design).
...
|---|---|---|
| Continentalist Party of the Americas | **The Continental Union** | *the Union*, *Continental* |
| East | **The Eastern Mandate** | *the Mandate*, *the East* |
| Ports / remnant states | **The Free Ports Coalition** | *the Coalition*, *the Ports* |

**Canon doc:** `WORLD_BIBLE.md` §1a. **Singapore** = the Eastern Mandate's de facto administrative and maritime capital, but not its sole seat of security, industry, energy, or political power; it remains the local/ordinary name and the official Mandate designation, and *the Stack* resident slang for the vertical institutional city. **Pelangi Reach** = formally Coalition gray space, economically dependent on Meridian, and politically tolerated until the **Mandate squeeze** (keeper holdout + screening hold); it is not Mandate territory. **Malacca** = Coalition port under uneven reopening. **Hawaiʻi** = **contested Coalition member** — acceded for harbor necessity; Union and Mandate both dispute/limit sovereignty. **Britain / Albion** = **Coalition European inland-keeper remnant** — present polity **Albion** (monarchy abolished post-Turning; **old Celtic name reclaimed**); *Britain/British* legacy; Ch 5 conversation reveals rename to Eli (`WORLD_BIBLE.md` §1a-ii).

**Genre / comps — LOCKED 2026-07-25:** **`55_series_pitch_and_comps.md`** (HIGH PRIORITY). Deep-history conspiracy clue-chain thriller; Charkha = present face of ages-long apparatus. Craft detail also `17` § *Genre comps*. Prologue weaves all three; chapters use one name at a time through documents, checkpoints, or habit.

**Mandate people / field-sail peace — REVISED AND LOCKED 2026-07-21:** The Mandate is faceless only at first because Eli encounters automated war and clinical systems. Book III reveals internal plurality through Commissioner Ma and the joint field-sail negotiation; humanization does not erase state responsibility. The Union holds unfinished field-coupling physics, the Mandate holds indispensable industrial and orbital capacity, and Free Ports/teahouses hold independent verification and consent-bound research. A replicated small effect supports a limited ceasefire and joint civilian program; no crewed starship launches. Full canon: `51_field_sail_and_mandate_peace.md`.
...
- Early consciousness programs studied this population; their signature and integration research was later adapted into the weapon's synthetic Fever payload.
...
- Eli was born around 2018, experienced natural pre-outbreak adolescent threshold symptoms, and is not a post-outbreak gene-drive child. His Fever scar creates no power (`15` § *Eli's Fever scar*).
- Children infected before puberty form the first mass threshold cohort by the novel present; later descendants can inherit the Fever. Adults can also activate less predictably under extreme stress, illness, deliberate induction, charged ground, and—after Book II—Maren's release through the living web.
...
| Shireen (cousin) | Shireen | one Dhaka encrypted exchange |
...
| Wren's formative prior love / Book II west-corridor liaison | **Rowan** | on-page Book II Ch 5–7; renewed Wren/Rowan romance; Eli/Wren also real; Rowan/Eli fall in love during Book III but withhold sex until Eli relinquishes command; Book IV carries family-building and the decision to try for a child (`26`, `27`, `60`) |
...
- **Named male casualty:** **Bima Prasetyo**, a Pelangi harbor electrician and sail-crew rigger established in ordinary work before the war. He dies at the distant holding action; his unfinished repair and empty place in the crew remain visible afterward.
...
**Present-day craft hub (docs 21–27):** `28_present_day_tetralogy_craft_index.md`.

### Rowan — RESOLVED / REOPENED (locked 2026-07-22)
- **Decision — REVISED 2026-08-16; Inana dual-face 2026-08-01:** Rowan appears **on-page in Book II Ch 5–7** as Wren's formative prior love and a present-tense **Weft** / mutual-aid operator. Wren remained a house Weaver and became Knotter; Rowan chose corridor work. Neither woman ran extractions in Book I. Book II is the first time their crafts must solve the same live recovery, and the first time Wren crosses from placement work into clandestine movement. Rowan and Wren renew their romance on-page. Eli/Wren also remains real. Eli and Rowan fall in love during Book III through direct wartime work. They name the love and withhold sex while he holds command. A kiss may follow the handover. Book IV carries consummation and their decision whether to try for a child.
- **Independent apparatus exposure — LOCKED 2026-08-16:** Rowan leads the modern-apparatus exposure from the corridor side: Ch 7 Charkha transfer records discovery; Ch 8 pair-severance ledger identification; Ch 10 Stonehenge psionic seizure witness. Each step is her craft, not Eli’s shadow. Eli’s evidence chain and Rowan’s corridor record should converge, not duplicate — reader learns the apparatus twice through two distinct professional reads.
- **Decision — REVISED 2026-08-16; Inana dual-face 2026-08-01:** Maren uncovers the modern Charkha apparatus and key parts of her own complicity **before Eli does** — sequence locked: Book II Ch 5 suppression scene earns the midpoint; Ch 7 Rowan finds Charkha transfer records; Ch 10 release = comprehension, not rescue. Eli’s role is to catch up, not to be the first to name it. See `32` Ch 5 + Ch 7; `27` § Maren voice + moral wound; `99_open_questions.md` § Maren complicity and release.

- **Decision — REVISED 2026-08-16; Inana dual-face 2026-08-01:** Rowan appears **on-page in Book II Ch 5–7** as Wren's formative prior love and a west-corridor Weaver liaison with her own missing-person/network objective. Wren/Rowan renews romantically; Eli/Wren also remains real. Eli and Rowan fall in love through wartime work during Book III. They acknowledge it while Eli commands and refuse sex, domestic access, and promises about children until he relinquishes authority. Book IV begins with their love established. They consummate the relationship and separately decide whether to build a household and try for a child. Rowan's wish for motherhood predates Eli. Book IV contains three distinct dyads while rival factions try to turn Rowan's pregnancy into succession. **Book II mythic rhyme:** *Inana's Descent* second face = Wren/Rowan gates/attend/return-with-cost (`19`, `35`, `32`). See `19`, `26`, `27`, and `60`.
...
- **"Hardware Recall" retired → Sub-Drone Domestication:** the old term pointed the wrong way (it implies pulling back existing hardware), but the model is about **creating sub-drones for the drones**—a larger, more dexterous workforce beneath the Anunnaki worker caste. Short form: *the Domestication*.
- **0.9-mya mechanism:** Phase II should be treated in outline as **Sub-Drone Domestication / Workforce Multiplication**. The core event is a managed compatibility/breeding project between 24-pair Earth stock / Adamu and 23-pair Anunnaki stock, not simply a direct Earth-stock chromosome-2 fusion.
- **Domestication analogy:** use the logic of later commensal/domesticated animals—pigs, dogs, cats, herd animals—where proximity to settlement and selection for useful traits creates a dependent labor/ecology around a dominant species. The Anunnaki/domesticated-drone caste reproduce that logic one level down by making humans useful hands for field-work, mining, line-mapping, and industrial preparation.
- **Robot analogy:** modern humans understand the logic now because we build robots and AI systems beneath ourselves. The blind spot is recognizing the same relation upward: humans are the robots/sub-drones from the perspective of the Anunnaki worker caste, just as our robots are sub-workers from our perspective.
...
- **Removed:** `36_memory_capsules.md` (deleted); the "memory capsules from stones" framing; the **two registers** (lived-life vs watched-vision); **Aedan routing the cosmology for Eli**; the **resonance braid** label; reincarnation; the **Seven as a numbered carrier roster** Eli "becomes."
- **Retained, reframed:** the historical practitioners are deep human **threads that resolve into people** (grief and first-person immersion both kept, as *full-resolution clarification*); the cosmology is **deep web-structure** clarified late and partially (directly, no intermediary); the firing rule (witness-site trigger + in-scene consequence).
...
### Biological-intervention countermeasures, bioweapon escalation, and what ordinary people see
**Status:** drafted, ready for review/redact.

Your user supplied a full contemporary scenario for how a deployed biological/weaponized Fever payload would trigger geopolitical, regulatory, and societal earthquake, plus a follow-on scenario for how a severe biological conflict escalates toward nuclear exchange.

**Canonical fit — YES, with one correction needed.**
...
- Singapore archive / body-register language = mandatory DNA screening before the crisis.
...
- The reversal-intervention problem = any intervention on the living web that superposes a field on an already-overdriven system; instruments cannot distinguish fault, signal, or cure.
...
- A threshold-house keeper argument that catalogued families are already targeted assets.
- A scene where Eli completes the personal Manual Override under the specific pressure of a use-it-or-lose-it calculus and refuses.

**Do NOT add** a policy lecture, news crawl, or briefing scene. The effect must land through custody language, airport-processing beats, archive scenes, and keeper domesticity.

See `biological_countermeasures_in_world.md` for the full external-world mapping.

### 15. Thailand grounding interval — still open

### 1. Opening causal chain — LOCKED

**Chapter placement — LOCKED:** Chapter 1 establishes and destroys the Pelangi Reach hearth. Chapter 2 carries the entire southern flight—escape, brief Singapore processing and ring photograph, Straits passage, Malacca witness collision, pursuit, and asphyxia—and ends with the receiver opening. Chapter 3 is rescue, overload, local Weaver hospitality, the Babaji archive handoff, and choice. The transit locations do not regain standalone setup chapters.
...
cosmology. The Pelangi squeeze forces Eli out before he has a quest. In Singapore,
...
surviving women, which helps explain the Weavers' female majority and the
threshold-house networks that inherited keeping. Male scarcity then deepens
through sorting, front posts, war losses, and disposability. The imbalance is
biological in origin only for the acute skew; what became cultural was sorting,
not supremacy. `WORLD_BIBLE.md` § *Sex-differential acute mortality / Weaver
female majority*.

**Singapore worker maze — wrong-room overhear — LOCKED 2026-07-24:** at Stack **intake level**, **before the document clerk**, Eli blunders into a **Harbor Thread back room** (Thread ledger meeting — not a lore summit). Fragments only: **Malacca chandlery**, **Hassan**, archive **packet** off Stack soil, **English woman on the file**, *the strait eats what they seal*; *burn the harbor thread*. Someone clocks the **boy on the call sheet**; Eli flees. The ring photograph at the clerk desk **confirms** what his body half-heard. Cube security carries a **Thread corridor flag** (misfiled as harbor-thread ledger) alongside intake resemblance.

**Singapore Circuit contract — LOCKED 2026-07-26 (rev. Z); job/timeline clarified 2026-07-30; race removed 2026-08-12:** **Friday AM** = a sabotaged line fails during Eli's solo sail, forcing a near-miss with Timah/Jul's harvest boat; Suresh, watching from the wall, awards the **Cherry Cube Circuit-weekend facilities contract**: stage/wardrobe/AV for the fictional K-pop-scale idol's **Sunday afternoon concert**, then **afterparty load-in**, then escape cover during **Sunday night Singapore Circuit** street race. Same trade as Foundry (uplinks, power, cable runs, service corridors)—different venue. **Cover paper** says *Foundry contractor / stage crew* (Babaji sponsor clears corridor); **call sheet / what Eli knows** = Cube show, concert before Circuit. **Cash** at intake under **Shireen remittance pressure**. **Wren attests** and prints call sheet; plants tablet pickup (*second set / wardrobe closet*). Suresh holds the transport hull. The Mandate sweep intersects this commute; he burns his Pelangi wage ticket escaping intake and reaches the Cube **from below** (worker maze), late and off the official gate — **on the call sheet but not through the door**. Idol encounter during/after the concert; freight escape during Circuit. Job + recognition, not coincidence.
...
**Eli's Pelangi Reach role — the shell and the core.** *Shell (day-job):* **facilities worker** at the Forest Foundry compound — cables, uplinks, access points, robot routes, the physical layer beneath the founders' pitch decks. Platform wage, no equity; **Babaji's friendship with Rasel** got him the placement, not money. Hard, hot, capable work when junctions run live; his **trajectory sense** belongs in the field but not in the splice — he resets breakers and never quite burns on live hardware. **Leftover fever** breaks under **layered noise** (Singapore Cube / race-night overload on-page; terrace splice calm is refuge). *Daily luck awareness (on-page):* he is **reminded every day** — towers full of worse papers, **Wren's sign-off**, Mei's free-meal list, recognizers who expect him tomorrow — that he should not still be here and is; he does not say *lucky* out loud (sounds like boasting or naïveté) but he **does not forget it**. *Core (private):* he keeps **his father's garden**, badly — grief for a man he **believes dead** (author: **alive in Mandate lab**). His father was a **legendary physicist** and, in Eli's memory, a **gardener**; Eli tries to carry the craft and is **not as good.** This is the book's spine made intimate on page one — *reception without mastery* — and the orphan trying to be the parent and failing. *Gift/craft split between his parents:* the **mother's line** is the involuntary gift (**trajectory sense** through the web — the surges, reception he never chose); the **father** is the chosen ordinary craft (the garden) Eli wants and can't master. He'd trade the gift for his father's plain green hands. *(His first frightened trajectory-read via the web later feels like his father's hands, the ones he never had, briefly arriving — one correct vector at a system threshold: perception that guides ordinary action, never repair, never radiating heat. Eli does not heal — that is Somchai's gift alone.)* Incidental seamanship from refuge life remains a secondary skill for the maritime leg — he is not a sailor by trade. Leaving costs him the compound crew, Mei's terrace, the people who know his name, and the garden.

**The clue:**

- **How it reaches him:** Mandate squeeze at Pelangi Reach forces displacement; the **compound/port network** gets survivors toward Singapore through workers, boats, and food-runs. Eli **holds a sabotaged line through a near-miss on the water** and earns Circuit-weekend Stack work before the sweep hits. In Singapore, an archive worker recognizes Eli's resemblance to Maren, compares his intake record with the Cherry Cube dissident's suppressed evidence packet, and deliberately routes one ring frame through a processing/migrant network. The scheduled **Singapore Circuit**—a Formula One–scale street race—has already sealed central streets and created service corridors, diverted transit, and controlled crowds; Wren uses that infrastructure to get Eli out when the quiet search begins. The clue and escape are both passed through human choices, not delivered by coincidence. The mother's tune may remain as background or keeper-network texture.

- **Singapore idol connection — LOCKED (rev. B — jacket/dance mechanism, 2026-07-30):** the fictional pop star performing at the Cherry Cube knew Maren as a child/young subject of her early protective-integration work. Maren helped him through an episode and refused to let the program classify him as property. A wardrobe accident puts Eli in the star's own signature jacket during the crowd surge; the star pulls him into the number as the fastest available cover (impromptu surprise-guest bit), and **recognizes him mid-performance**, up close, through resemblance, a grounding gesture, and the circulated evidence frame — not backstage, and not through supernatural certainty. He has to finish the number holding that shock under trained composure. Only afterward, backstage, does he act on it: vouches for Eli to security, opens the wardrobe/service escape during the Singapore Circuit, and gives him one personal memory of Maren in the brief window available. He is a person with agency and security obligations, not a secret lore dispenser or convenient permanent ally. Full mechanism: `31_volume_I_beatsheet.md` § *Cherry Cube concert*.
...
### 2. Malacca breach event — LOCKED

**A losing fight that ends in near-death by asphyxia.** The threshold is loss of breath (choke and/or drowning), not a blow to the head.
...
1. **Chase.** A rival team's operators run Eli down during the disorderly Malacca reopening — he's been clocked near their contest over a carrier/route. A scooter flight through the old town / riverside.
2. **Losing fight.** The flight collapses into close-quarters combat — baton, a blade. Eli has **no martial training yet** — late blocks, wrong angles, terror and overwhelm. He is not reading lines; he is drowning in numbers. **Talents may flicker** (charge in palms, hands flare on the roof) — **activation without control**, not skill. (Anti-badass: dominant note terror; breach opens receiver, not prowess.)
3. **The threshold — asphyxia, not a blow to the head.** He is choked down and held under at the river's edge, or driven off a quay into the harbor and pinned/tangled. Near-death by loss of breath. The hypoxia **rings the leftover fever** (names blur, the old bright wire lights) — so the scar is present-tense without being restaged as a new injury.
4. **The plane opens — receiver ON (`36` §3a).** At the edge of death the **psi plane opens to Eli for the first time** — first contact with the sight (`38_psionic_combat.md`): he *sees* the forms as he's dying. **Sensory overload** — too much signal at once; hypoxia and leftover fever ring together. **No identity crisis:** he does not think the dead are him. Catastrophe, not power: he is **exposed and hunted** from this moment (grid flare). One ordered fragment may surface (three concentric circles). **Named historical threads clarify later at charged grounds** under pressure; see § Charged-ground triggers below.
...
Singapore's public machinery, and later stays because she has become responsible
...
network. Wren, not Rowan, guides Eli through Singapore; local Weavers help in
...
**Working name: "the Custodians"** (carrier slang; bland official designation TBD). **Faction:** a national/bloc psion program's deniable field unit, **contracted to and leveraged by the Charkha** — they work with Lang and fear him, but are not his creatures (he holds leverage; he can have any of them harvested once spent). **Cover:** a transnational **biosecurity / quarantine-enforcement** unit — which lets them move through ports, board ships, access health and immigration records, and operate with authority in the reopening world. Perfect for the maritime chase and the outbreak backdrop. **Eli Book I read (LOCKED 2026-07-26, dual-true + costume):** he files them as **Mandate biosecurity / Rasel's son / loose ends** — Charkha **wears Mandate's face** for the Eli/mother hunt. Late Book I: costume seams (*somebody else's leash*), no word **Charkha**. Book II names the apex — **wore the Mandate's face; got Maren; you've been running their map**.
...
- **Anomaly (Thailand):** a **new ley line forming**, which the growers distinguish from irrigation and blight.
- **Border-era spray/burn scars — LOCKED treatment:** cooperative borders or remembers former military herbicide or burn legacy parcels; research before prose. **Not** Vol I climax geography.

### Father's capture, Mandate lab, and Bangladesh flight — LOCKED 2026-07-24 (rev. father alive)

**Rasel Khan** — Eli's Bangladeshi father; full legal name **Rasel Khan** (রাসেল খান). **True name — LOCKED; forms, narration, and every speaker say Rasel.** **Bangladeshi passport.** **Claimed by Eastern Mandate.** **Public legend:** legendary physicist; **private life Eli remembers:** gardener, **Babu**. Not a carrier. **Old friend of Babaji** — Old Pelangi; **work not wealth** for Eli.

**Rasel — name register — LOCKED 2026-07-26, Russell variant retired 2026-08-08.** **Rasel** is the true
name, form spelling, and the only spelling used on the page — no character mishears or anglicizes it. In Book I Ch 11's lab scene, the technician who once mangled the name into *Russell* now flattens Rasel into a case number, *Subject Seven*; Rasel answers, *I have a name.*

**Why they fled Bangladesh:** carrier hunt + **scientist claiming** (post-Turning bloc scramble — Maren a **claimed neuroscientist**, Rasel a **claimed physicist**; Charkha/Mandate both wanted the minds). The Charkha uses local machinery — detention, disappearance, riot cover, checkpoint, file — so the **official story can read as politics** while survivors know they were closing on Maren **and** filing Rasel on the ledger.

**Parental interception — REVISED AND LOCKED 2026-08-11:** Maren and Rasel conceal their flight from Eli as a family holiday. They leave him at Mei's for one night while they check the next route, take their bags toward a rendezvous, and are abducted before they arrive. No keeper witnesses the taking, vehicles, or split. **Passport split:** Maren and Rasel are separated because different citizenship means two claimants. **Rasel** (Bangladeshi passport) → **Eastern Mandate** black-lab custody — **Rasel Khan** on files, claim-category physicist; he later chooses to stay in the program. **Maren** (Albion passport; legacy *British* on custody files) → the **Charkha** chain — claim-category neuroscientist; site unknown to the keeper net. A pair-severance order dated seven days before the rendezvous proves the split was planned. **Eli:** safe at Mei's and physically uninjured; Somchai tends him after his parents fail to return, and the escape net moves him toward Thailand. **No second attack.** Retired: *Rasel killed during extraction*; *single custody chain for both parents*; *Eli present at the interception*; *Mei witnesses separate vans*.

**Passport split — prose lock — REVISED 2026-08-11:** Eli does not know this until Vol II documents. Reader/author fact: **different papers, different organizations** — Mandate claimed the father; the Charkha claimed the mother. No keeper saw the transfers, and the parents did not enter the same custody chain. `40_concepts.md` § Passport split.

**Rasel "dead" vs missing — REVISED 2026-08-11:** Eli remembers Rasel walking out of Mei's with a bag and a promise to return; Babaji later files both parents as dead. **Author fact:** Rasel is abducted before the rendezvous, routed to a Mandate lab as **Rasel Khan**, and later chooses to remain. **Cross-ref:** Maren + orphan reveal locks below.

**Maren alive, location unknown — REVISED 2026-08-11:** author-side truth: Maren survives the interception; **nobody in Eli's world knows where** until the evidence ladder advances. **Albion passport** (legacy **British** on some files) → claimed by the **Charkha**, not Mandate — **passport split** from Rasel. **Maren Holt — neuroscientist — LOCKED 2026-07-24:** Albion-born; natural carrier; early-program work on signature, threshold, and neural integration — **neuroscience first**, not generic "consciousness researcher." **post-Turning scientist claiming — LOCKED 2026-07-24:** after armistice, three-bloc cold war **claims all scientists** as property (ledgered, assigned, seized). Maren and Rasel are **claim-category** captures — high-value minds the blocs will not release; **different orgs because different papers**. Their interception may predate formalization; **post-Turning law** makes the theft permanent and ordinary. `40_concepts.md` § Scientist claiming, § Passport split.

**Eli's ambiguous loss — REVISED AND LOCKED 2026-08-11:** Eli remembers his parents leaving him at Mei's with a promise to return. Their packed bags make the later death story feel like abandonment whenever he stops believing it. At Friday dinner, Mei tells him the holiday was a flight, the parents never reached their guide, and no one witnessed their deaths. He carries grief, anger, and hope until Thailand produces a four-day-old Rasel handshake. Maren remains unresolved through Book I except for Rasel's report that her hand reached him two winters earlier.

**Parent memory as inheritance — LOCKED 2026-08-10:** Ch 1 gives Eli one memory with no forensic payload: rain on a metal roof, a mattress on tile, Maren's palm rising on his sternum, Rasel's cool hand at his neck. In Ch 11 Shireen admits that she remembers family stories more clearly than either missing person. Eli sends her the memory by voice note; she asks for another when he can. Wren supplies power to the phone and never copies the parents' gestures. At Sanxingdui, Rasel gives Eli Maren's two-winters-old correction, carrying *Babu—if this reaches you, ask me why I stayed.* At Avebury, burned toast returns the storm room during Maren's embrace, and Eli places the worn correction beside Rasel's ring before asking the promised question.
...
**Family naming — LOCKED 2026-07-24; father **Rasel Khan** 2026-07-24; **Holt / matrilineal reveal** 2026-07-24:** **Bengali characters do not carry inherited family surnames.** Use **given name + father's name / patronymic** in speech and memory (*Rasel's boy*, *Shireen in Dhaka*). Hostile paperwork may flatten names into fake Western forms — treat as **registry violence**, not culture.

**Eli Holt — why not Khan? — LOCKED 2026-07-24:** **English paperwork: Eli Holt** (mother's surname on passport / keeper file). **Not** Eli Khan. When **European registry, border, or research clerks** ask why his surname is not his father's (**Holt** vs **Khan** / **Rasel Khan** on corridor files), Eli gives the short answer he was raised on: **a Bengali thing — we don't take the father's surname.** **True on the Rasel side; incomplete as a whole answer.** He is not lying; he does not yet know that **Holt** is also **matrilineal custom** on Maren's line.

**Holt / matrilineal reveal — LOCKED 2026-07-24:** **Later (Vol II Europe — Pömmelte Ch 5 and/or Alba Ch 6):** Eli learns **Nephilot / Alba** carrier communities tracked **names and memory through women** — matrilineal line, not patriarchal house-name. **Maren Holt** kept her mother's line; **Holt on Eli's passport** is the same logic under a different language — maternal surname, not random Albion paperwork. **"Elves"** = folklore compression of that **matrilineal hunted line** (`37`, `95` *Alba*). **Reader effect:** the half-answer he gave in Europe **turns out to be doubly true** — Bengali custom explains absence of **Khan**; **matrilineal Alba** explains presence of **Holt**. Do not front-load elf taxonomy; land as kinship/memory practice first, folklore label second.

**On-page placement — LOCKED:** **Vol II Ch 5** (*The Changing Map*) — registry/border **Holt vs Khan** question + *Bengali thing* deflection (one exchange, no lecture). **Vol II Ch 5–6** — Pömmelte registry mark + Alba inference reframes **Holt**. Malacca Ch 2 wage-ticket beat (**Holt** / **Khan** to Hassan) **unchanged** — first honest naming under pressure; Europe beat = Anglo file logic, not repetition.

| Person | Name rule |
|---|---|
| **Eli** | Given name **Eli** (Maren); **dak nam Babu** (বাবু) — Rasel at home, Shireen in Bangla texts; unrelated to *Eli* on paper. **Not** Eli Khan / Eli Rasel. English/maternal paperwork: **Eli Holt** (mother's line surname on passport, Stack contract, intake). **Europe (Vol II Ch 5):** when asked why not **Khan**, Eli says **Bengali thing** — true for father side; **Vol II Ch 5–6:** learns **Holt** = **matrilineal Alba/Nephilot** custom on mother's side (`99` § *Holt / matrilineal reveal*). |
| **Rasel** | Full legal name **Rasel Khan** (রাসেল খান). **Forms, speech, and narration all say Rasel** — no anglicized variant on the page. **Khan on his records only** — not passed to Eli. `95` § Rasel on-page; `14` § Culture. |
| **Maren** | **Maren Holt** — always. Birth name, married name, keeper files, Mandate records. She did **not** take Khan. **Holt** = **matrilineal line** (Alba/Nephilot carrier memory); kept through marriage. Retired misfiles: *Maren Rahman*, *Maren Rasel*. |
| **Shireen** | Cousin **Shireen** — given name; no inherited family surname. |

**Do not use Das.** Retired: **Arif**, **Arif Rahman**, **Eli Rahman**.

**Culture on-page — LOCKED 2026-07-24:** In **prose**, do not label ethnicity/nationality when **language, food, vowels, place-names, remittance, garden, Thread texture** already imply it. **Bangla in dialogue**; **registry labels** only when the system speaks (*South Asian dock queue*). Author docs may still say Bengali/Bangladesh. Full rule: `14` § Culture and language; `95` § Culture and language on-page.

### Eli's upbringing — Bangla, foster parents, worker track, hidden talents — LOCKED 2026-07-24

**Bangla and culture — two teachers, one thread:**
- **Rasel and Maren** (biological parents) — Bangla at table, food, scolding, river names, **Babu**, district memory while Eli was small.
- **Keeper foster parents** (corridor placement after the disappearance) — the people who **raised him** on the move; continued Bangla and culture; **not** Thread initiation. File: orphan/foster/worker — child memory may say *the people who raised me*; **Mei dinner truth:** his parents left him for one night and never reached the guide who would bring them back.

**Raised as a worker — LOCKED:** no elite schooling, no claim-category grooming. Keeper net routed him into **labor placement** — corridor work, later **facilities/platform wage** track (Pelangi Foundry). Ordinary worker identity is **cover and truth at once**.

**Visuo-spatial talent — LOCKED:** exceptional **visuo-spatial memory and skills** — maps a route once, holds cable/robot geometry in head, reads splice paths fast. **Distinct from** carrier/receiver (Maren) and symbolic feeling (Rasel). **Fever scar:** inconsistent — sharp in quiet focus; holes under noise/overload.

**Hide the talent — LOCKED:** post-Turning **capacity claiming** + **staying under the radar** (`40` § Capacity claiming, § Staying under the radar) — ordinary people **try not to be read as too talented**; sandbag tests, slow-walk obvious answers, *adequate is safe*. Foster/worker culture taught Eli the norm: **perform adequate, not exceptional**; don't finish the puzzle where files can see you. Foundry work **uses** the gift sanitized — reliable hand, not prodigy on ledger. **Not foolproof** — someone still clocks you (*call sheet*).

**Thread overlap unchanged:** home tongue **opens** corridor doors; he was **not raised Thread** (no ledgers, badge math, initiation).

**Singapore / Malacca — LOCKED 2026-07-24 (rev. C):** **No Thailand body memory** before Ch 5. Ch 2: **Maren grounding gesture** at Cube overload; **receiver activations** (palms, flags, strait, *lit up*) — **talents turning on, not trained**. **No martial foreshadow.** Malacca fight = **untrained overwhelm**; breach = **receiver ON without discipline**.
...
- **Fugitive Thailand (after the disappearance):** Somchai, **wat breath only** — no martial. The Fever scar occurs later at Pelangi.
...
**How the release works — LOCKED (supersedes the dead-in-body/tethered-spirit version):** Maren is **alive** throughout, kept alive because only she can restore and maintain the model she sabotaged, which makes her the Albion ground's **living operator** rather than one of its harvested dead. The Charkha holds her not with a cell but with **the reunion it keeps almost-happening**, backed by a second lever added 2026-08-10 — a threatened name, used when the reunion-promise alone isn't enough on a given day. She stays at the console because she believes she will get her son back, and she shows the Charkha less capability than she has — the console's failures are managed, not total (`00_NARRATIVE_STRUCTURE.md` § *The mother — the heart of it*; `32` § *Midpoint revelation*). It follows that **no rescue can free her and only Eli can:** he must refuse in person to be what they promised her. She walks out **alive** and does not come home — he does not recover a mother, he meets a woman with her own life. Release still darkens that ground, still scatters the dead threads bound to the wider grid once the practice spreads, still defuels the amplifier, and still costs Eli a usable stabilizing signal. **Grief without a corpse:** release is only a choice because she could have been kept. ⟦Flagged for veto: the no-corpse ending — the earlier version had her ascend and be lost forever.⟧

**Maren "dead" vs alive — prose lock (REVISED 2026-08-11):** Mei knows only that Maren walked away with Rasel and their bags, bound for a rendezvous neither reached. Rasel reports at Sanxingdui that a correction in Maren's hand reached him two winters earlier. Her present condition remains open until Book II. Eli still boards Saturday PM.
...
the Sanxingdui camera gap; and the precise limits of Rasel's Mandate work.
...
**Somchai Vichai** — Thai nurse and field medic who works across corridor clinics, threshold houses, and emergency sites. He tended child-Eli after his parents failed to return to Mei's and passed him into the escape network before they were separated. His exact age and home clinic remain open.
...
- **Hard limits:** cannot cure the engineered outbreak retroactively, restore neural information destroyed by Eli's Fever scar, heal without bodily/metabolic cost, or substitute for diagnostics and ordinary medicine.
...
key at the fox-pillar and counter-image to Sanxingdui. Real object; primary source
Köksal-Schmidt & Schmidt 2007; photo I. Wagner / DAI; DAI inquiry drafted for
inventory/context and image rights. Three stacked readings (terrestrial / guardian /
cosmological); no on-page panspermia certification until Book III.
3. **The Folly** *(scholar: Adapa lacuna)* — **Vol II Ch 2** (Gulf/Mesopotamian archive); **a textual mystery + a missing physical fragment + a forged reconstruction in conflict** (all three at once). Points to inward control and the Human-Design Triad; Dilmun/Qingu memory, not a standing site. *(Corrected 2026-08-10: this entry previously said "Vol I Ch 12" and claimed a "Vol II Mesopotamian leg" note was retired — backwards. `58_sanxingdui_climax_lock.md` moved the Mesopotamian archive, Taş Tepeler circuit, and Göbekli material out of Book I into Book II; the current Book I beatsheet's Ch 12 card contains no Adapa/Folly content, and Book II Ch 2 is titled "The Folly" and carries it on-page, verified directly against the manuscript.)*
...
- **Silurian drone-helpers & the endosymbiosis model (author extension):** the dragons had **drone helpers — the Silurians**. Not subjects they ruled, but a **symbiotic partner-layer** that, over deep time, became inseparable from them.
  ...
  - **Competing accidental-crash domestication reading [SPECULATIVE / UNFALSIFIABLE]:** a minority in-world reading reframes the Silurians not as endosymbionts but as the crew of a crashed craft who stayed and domesticated theropod stock into dragons. **The Silurians are a separate species from the Tier-1 serpents and from the later Anunnaki/gods; they are not divine and do not mix with the god-lineages.** In that gloss dragons retain cryostasis-capable eggs, voltage/fire discharge, and telepathic/empathic projection via the anti-entropic medium. **Status:** competing cosmology only. It does not override the canonical random-rock K-Pg event, the Earth-native Abzu-refinement origin of dragons, or the locked extinction rule that no Silurian trace survives into the present. It is recorded because characters may argue it, and because it shows accidental crashes as a general seeding pattern without breaking existing locks.
  - **Competing amphibious-Leviathan reading [SPECULATIVE / UNFALSIFIABLE]:** a minority reading reframes the dragon line as a two-stage creation: Tiamat created **Leviathan** first as an amphibious prototype, then created dragons as the perfected terrestrial form. In this gloss Leviathan lived in shallow seas and coastal swamps, retaining pressure tolerance, electrocyte discharge, and cryostasis-capable eggs; dragons inherited and overwrote these traits. This explains why dragons retain aquatic adaptations despite their later terrestrial depiction, and gives the Abzu a pre-dragon meaning as the original habitat of the amphibious Leviathan-form. **Status:** competing cosmology only. It does not override the canonical single-origin reptilian drop or the K-Pg Abzu-refinement sequence.
...
**Resolved in design:** the awakening merges signatures into the **one living web**; the bad psions' toolkit needs a discrete point of control, so it collapses **at once** (unplugged, not killed). The **mother's release** demonstrates the way out → trapped-soul **cascade** → amplifier defueled. Good psions **integrate with the earth's grid** (native, free) instead of the trapped-soul machine. Power **disperses** (obsolete machine, not a new owner). Cost/limit/fragility (sparse lattice, not permanent, can't be commanded, re-corruptible) keep it from being a switch-flip; the crux is Eli **refusing** to seize the amplifier when seizing it is the better tactical move. Full design + author-decisions in `41`. Remaining open items now live there (named death, lattice density, Custodian fates, re-corruption seed, seed-pattern sensory form).

Original prompts (still useful as a checklist against `41`): How does Eli make the amplifier worthless in action?
...
**Teahouse pilgrimage addition — LOCKED 2026-07-21:** The final community seeds the distributed system in `50_teahouse_pilgrimage.md`: teahouses are pilgrimage sites; cloisters are voluntary disciplined residences; inner sanctuaries use site- and phenomenon-specific, time-limited research clearance. Health, recovery, ordinary functioning, boundary conduct, and reproducible observation determine practical readiness against personal baselines. AI stays in the background as logistics, safety monitoring, transparent bias/institutional-drift auditing, and statistical support; it does not interpret experience or classify identity. Families and clans emerge through long travel and shared life, never algorithmic assignment or irrevocable heredity. Eli teaches and serves tea at an outer threshold rather than ruling the network.
...
- **Real — deferred to Books V+:** angelic beings (seraphim, archangels) are real discarnate actors on the Unseen. Their cross-plane agency, taxonomy, and relation to guardian caste / jinn / Igigi discarnate / Anu + 26 are locked for Books V+. **Books I–IV rule:** no angelic being manifests, intervenes, or speaks on-page. Michael / Gabriel / Persia-prince remain as human-scale textures — callsigns, iconography, Sora's medal, healer's refusal — not other-plane agents. Do not draft load-bearing angel/seraph appearance scenes until Books V+ unlock.
|- **Locked — Prince callsign / Persia hold (2026-08-01; chapter-pinned 2026-08-08):** Rival team carries **Middle Eastern / Persian Gulf framing** (Persia hold = national *sar* territory, not a demonic seat). **Personal name: author choice** — needs one specific human operator who wears "Prince" as a title borrowed from the territory he commands, not his birth name. Ch 13 seed confirmed; Vol I–III references as callsign only; **resolves to the human operator in Vol III Ch 8**, the distant corridor attack where Sora Vithan also dies. No other-plane backing on-page.
