...
- **Book I ends at Göbekli Tepe.** Pelangi Reach → Melaka → maritime/Gulf evidence → sealed-interface race. Emrys is taken at the climax; Eli chooses people over the complete record.
...
- **Old `31`/`32`/`33` chapter allocations are superseded as spines.** Preserve their scenes as quarry; rebuild chapter beats before drafting beyond the current Pelangi Reach/Melaka manuscript. **Route lock:** after Melaka, use the substantial Mekong/Vietnam agricultural-witness sequence, then the shorter Thailand grounding/memory hinge, then a brief Bangladesh village encounter with living Bengali continuity; Eli leaves through a Bay of Bengal port, crosses the Arabian Sea into the Gulf/Mesopotamian corridor, and travels north through contested land routes to Göbekli. Bangladesh is an emotional home hinge, not a second climax or uncomplicated return.
...
**Canon doc:** `WORLD_BIBLE.md` §1a. **Pelangi Reach** = formally Coalition gray space, economically dependent on Mandate-linked Meridian City, and politically tolerated until the staged attack; it is not Mandate territory. **Melaka** = Coalition port under uneven reopening. Prologue weaves all three; chapters use one name at a time through documents, checkpoints, or habit.
...
- **Locked delivery rule (`36` §3a, §3):** Melaka = **receiver ON** + overload + grid flare — **not** seven lives downloaded, **not** identity crisis. Named threads clarify **at charged grounds** under pressure. **Talking stones** (`36` §7a): local folk memory of charged-ground behavior.
...
- Union quarantine / Custodians / biosecurity cover / staged attack = the geopolitical crisis in embryo.
...
- The Mekong choice and the Göbekli choice = precautionary principle vs. urgency at civilian scale.
...
- **Prize:** Qingu-reserve seal + **selection mark**; founding record of the **Nephilot** (*what the elves are*).
...
- **What survives → Vol II:** partial read + Mekong grower knowledge + network fragment → Europe corridor.

**Mekong Delta agricultural sequence (Ch 5–10) — LOCKED, not climax:** forming ley line, Ila midpoint, Eli recognizes the charge but hesitates over **agricultural** evidence; Wren forces evacuation, a grower is injured, and the documentation is damaged. The personal Manual Override remains incomplete until Göbekli. See `31` Ch 5–10; dioxin/history treatment below retained for that sequence only.

- **Anomaly (Mekong):** a **new ley line forming**, which the growers distinguish from irrigation and blight.
- **Agent Orange / dioxin history — LOCKED treatment:** cooperative borders or remembers former military herbicide handling site; research before prose. **Not** Vol I climax geography.

### Father's death and Bangladesh flight — LOCKED

**Arif Rahman** — Eli's Bangladeshi father; a gardener with real local political commitments (rivers, land, labor, or dissent — exact issue flagged for research). Not a carrier. **Old friend of Babaji** — planted for the island keeper before Pelangi Reach existed; asked Babaji to find Eli **work, not wealth**, when the net broke after Maren's death. His visibility is one reason the family had to move; the Ring was hunting Eli's mother.
...
**Maren "dead" vs missing — prose lock (RESOLVED):** She **disappears** ~ten years before present; the keeper net tells survivors she **did not make it out** — Eli grows up on that grief. **Narrator/Eli POV must not state flat death as fact** in Vol I; it is **believed death**, not confirmed. **Body fact:** dies **later** in captivity (Vol II midpoint region). **Spirit:** tethered west until Book II release. **Vol I arc:** Melaka trail (tune → ring → Hassan: *"Your mother said if this ever found you…"*) is the first **empirical crack** that she may have lived past extraction — Hassan saw her **removed alive** (`26`). Suresh repeats net lore, not eyewitness death (`MANUSCRIPT` Ch 1–2). **Cross-ref:** `WORLD_BIBLE.md` §2; `95` *Maren Rahman*.

**Bangladesh after:** remains **lost home**, not solved graveyard. A brief protected village visit is possible, but political danger, files, surveillance, and surviving kin (e.g. a cousin in Dhaka — **Farida**, name locked from quarry) remain at risk. The visit is a near-miss of home, not a legal or emotional restoration; the Vol I climax remains Göbekli, not Bangladesh.
...
- **Locked — delivery rule:** Melaka = receiver opens + overload + grid flare — **not** identity crisis (`36` §3). First **witness-site contact** = Vol I midpoint (partial **Ila** — pin exact stone below).
...
**Priority 1 is locked (#1–#6) and the Volume I beat sheet exists: `31_volume_I_beatsheet.md`** (**13 chapters**, no prologue; **breach closes Ch 2**; **Göbekli Ch 13 = Vol I climax**; Mekong Ch 5–10 = agricultural witness). **Trilogy plot hub:** `29_trilogy_plot_and_development.md` — act-level Vol II–III, revelation links, and the locked design decisions formerly tracked as #7–#14.
...
**All open questions (#7–#14) are now LOCKED** — the design layer is closed. Vol II drafting may proceed on `32_volume_II_beatsheet.md`; Vol III on `33_volume_III_beatsheet.md` + `41`. Remaining **scene-level choices** are charged-ground staging (Tem, full Ila witness stone, Lovernios, Aedan arc ground, and the precise dig/shrine/military texture at Göbekli) plus Vol I prose Ch 1–5 (Pelangi Reach → Melaka). These choices may shape presentation, but cannot reopen the locked causal decisions.
