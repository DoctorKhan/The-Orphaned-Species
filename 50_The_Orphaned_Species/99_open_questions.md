...
- **Still open:** exact calendar year of Eli's family attack; Somchai primary clinic city (name locked; location: mobile / corridor clinics, provisional flesh in `26_present_day_cast_expanded.md`); **Thailand temple** — specific wat, city, caregiver link, and whether recovery interval is shown in flash or only as Vol I habit leak (`15` § *Eli's meditation seed* — LOCKED in design).
...
**Extraction night — LOCKED:** one attack at a **border / third country / keeper handoff** (not Dhaka on-page). **Passport split — LOCKED 2026-07-24:** Maren and Rasel **separated because different citizenship** — not one chain, **two claimants**. **Rasel** (Bangladeshi passport) → **Eastern Mandate** black-lab custody — **Rasel Khan** on files, claim-category physicist; coerced secret research (registry-adjacent instruments, field coupling, or signature physics — exact program TBD). **Maren** (Albion passport; legacy *British* on extraction files) → the **Charkha** chain — claim-category neuroscientist; **parallel convoy**, site unknown to keeper net. Attack may wound and scatter; **file routing** finishes the split. **Eli:** blast/masonry or vehicle impact → **persistent TBI**; healer stabilizes; escape net splits him from Somchai and moves Eli toward Thailand. **No second attack.** Retired: *Rasel killed during extraction*; *single custody chain for both parents*.

**Passport split — prose lock — LOCKED 2026-07-24:** Eli may not know this until Vol II documents. Reader/author fact: **different papers, different organizations** — Mandate claimed the father; the Charkha claimed the mother. They did not vanish into the same van. `40_concepts.md` § Passport split.

**Rasel "dead" vs captive — prose lock (mirrors Maren):** keeper net and Babaji tell Eli his father **did not make it out** — Eli grows up on **believed death**. **Author fact:** **alive** in Mandate lab — ID **Rasel Khan**. **Cross-ref:** Maren + orphan reveal locks below.

**Maren alive, location unknown — LOCKED 2026-07-24:** **alive** since extraction; **nobody in Eli's world knows where**. **Albion passport** (legacy **British** on some files) → claimed by the **Charkha**, not Mandate — **passport split** from Rasel. **Maren Holt — neuroscientist — LOCKED 2026-07-24:** Albion-born; natural carrier; early-program work on signature, threshold, and neural integration — **neuroscience first**, not generic "consciousness researcher." **post-Turning scientist claiming — LOCKED 2026-07-24:** after armistice, three-bloc cold war **claims all scientists** as property (ledgered, assigned, seized). Maren and Rasel are **claim-category** captures — high-value minds the blocs will not release; **different orgs because different papers**. Extraction may predate formalization; **post-Turning law** makes the theft permanent and ordinary. `40_concepts.md` § Scientist claiming, § Passport split.

**Eli's ambiguous loss — REVISED AND LOCKED 2026-08-10:** net lore says both parents died. At Mei's Friday dinner, Eli learns that both entered separate extraction vans alive. Mei has no later evidence. He carries grief and hope together until Thailand produces a four-day-old Rasel handshake. Maren remains unresolved through Book I except for Rasel's report that her hand reached him two winters earlier.
...
**Child separation — keeper protocol — LOCKED 2026-07-24:** for **claim-category** scientist families, a **child on the linked file** is a **beacon** (hostage, carrier-adjacent, classified inheritance, chase trigger). **Keeper net protocol:** **get the child off the linked file** when possible — split routes in flight; after violence, route through healers/corridors; **orphan on paper** (*parents dead / unlinked*) so the child survives registry and bloc recall. **Not** blanket state camps — one net decision, one file lie. **Stolen child, not orphan** — protective lying, not abandonment. Eli = template: extraction → Somchai → Thailand corridor → **Eli Holt** on passport, not claim-household son. Full lock: `40_concepts.md` § Child separation.

**Ambiguous-loss reveal — Mei Friday dinner — REVISED AND LOCKED 2026-08-10:** Friday after the race, Mei turns the family photograph face-down and repeats what Babaji told her. Both parents were alive when the vans left; Mei cannot promise anything after. She supplies no document, Rootbook, or destination. Eli still leaves Saturday PM. Singapore proves Rasel survived into intake, and Thailand supplies the first current trace. **Retired:** certain-life reveal at dinner; Rootbook at dinner; stairwell or pier reveal; Saturday/Sunday dawn departure.

**Parent rescue schedule — REVISED 2026-08-10:** Friday dinner establishes survival only through the extraction night. Singapore establishes Rasel's historical survival; Thailand gives a current signal; Sanxingdui gives on-page reunion and recovery. Maren's physical two-winters-old correction opens the Book II mother trail by asking Eli to hear why she stayed. Eli finds and releases Maren at Albion in Book II. Book III begins with both parent quests resolved and tests the world their discoveries create.
...
- **Keeper foster parents** (corridor placement after extraction) — the people who **raised him** on the move; continued Bangla and culture; **not** Thread initiation. File: orphan/foster/worker — child memory may say *the people who raised me*; **Mei dinner truth:** **stolen child**, biological parents taken.
...
**Maren "dead" vs alive — prose lock (REVISED 2026-08-10):** Mei knows Maren entered her extraction van alive and knows nothing later. Rasel reports at Sanxingdui that a correction in Maren's hand reached him two winters earlier. Her present condition remains open until Book II. Eli still boards Saturday PM.
