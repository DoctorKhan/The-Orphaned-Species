...
- **Old `31`/`32`/`33` chapter allocations are superseded as spines.** Preserve their scenes as quarry; rebuild chapter beats before drafting beyond the current Forest City/Melaka manuscript. **Route lock:** after Melaka, use the substantial Mekong/Vietnam agricultural-witness sequence, then the shorter Thailand grounding/memory hinge, then a brief Bangladesh village encounter with living Bengali continuity; Eli leaves through a Bay of Bengal port, crosses the Arabian Sea into the Gulf/Mesopotamian corridor, and travels north through contested land routes to Göbekli. Bangladesh is an emotional home hinge, not a second climax or uncomplicated return.
...
**Canon doc:** `WORLD_BIBLE.md` §1a. **Forest City** = formally Coalition gray space, economically dependent on Mandate-linked Singapore, and politically tolerated until the staged attack; it is not Mandate territory. **Melaka** = Coalition port under uneven reopening. Prologue weaves all three; chapters use one name at a time through documents, checkpoints, or habit.
...
**A witness in newly-reopened Melaka who claims to know what happened to Eli's mother — reached through the harbor, carrying one personal detail and her wedding ring. Half-bait.** Not a cosmological artifact (those enter after the breach); human stakes first. Political violence forces Eli out of Forest City before he has a quest. In Singapore, he accidentally sees an ordinary photograph containing Maren's silver-and-brass wedding ring, recognizes the imperfect seam and “same soil” inscription, and follows the image's contact trail north to Melaka. The photograph is not addressed to him; the physical ring remains with Hassan. The mother's tune may recur as atmosphere or keeper-network texture, but it is no longer the inciting lure.
...
- **How it reaches him:** political violence at Forest City forces displacement; the **compound/port network** gets survivors toward Singapore through workers, boats, and food-runs. In Singapore, an ordinary photograph in an archive, processing record, or migrant network shows Maren's ring by accident. Eli recognizes it and follows the contact trail to Melaka. The clue is found in someone else's life, not delivered by a mystical messenger. The mother's tune may remain as background or keeper-network texture.
...
**Mekong Delta agricultural sequence (Ch 9–14) — LOCKED, not climax:** forming ley line, Ila midpoint, personal Manual Override, people over **agricultural** evidence. See `31` Ch 9–14; dioxin/history treatment below retained for that sequence only.
...
**Arif Rahman** — Eli's Bangladeshi father; a gardener with real local political commitments (rivers, land, labor, or dissent — exact issue flagged for research). Not a carrier. **Old friend of Babaji** — planted for the island keeper before Forest City existed; asked Babaji to find Eli **work, not wealth**, when the net broke after Maren's death. His visibility is one reason the family had to move; the Ring was hunting Eli's mother.
...
2. **Göbekli plaquette** (snake/tree/bird grammar) — **Vol I** Ch 17; the selection-mark key at the fox-pillar; points to the sealed interface. Disputed object.
...
- **Locked:** Aru's thread → **Göbekli Tepe (Vol I Ch 17)**, clarified at the fox-pillar Aru carved.
...
**Priority 1 is locked (#1–#6) and the Volume I beat sheet exists: `31_volume_I_beatsheet.md`** (**17 chapters**, no prologue; **Göbekli Ch 17 = Vol I climax**; Mekong Ch 9–14 = agricultural witness). **Trilogy plot hub:** `29_trilogy_plot_and_development.md` — act-level Vol II–III, revelation links, and the locked design decisions formerly tracked as #7–#14.
