...
**Nephilim** — the giant first-generation hybrids of Igigi males and human females (the "liger" case: unchecked paternal growth genes). Enhanced but, by **Haldane's Rule**, the giant males are sterile; the **fertile females** are the only hinge through which Igigi biology keeps moving.

**The 17:1 bottleneck (Seventeen-to-One Ratio)** — the reproductive clamp (~8,000–5,000 years ago) where ~17 women reproduced for every 1 man (Karmin et al. 2015). Sterile Nephilim block ordinary men; a handful of licensed "chosen" fathers carry the Y forward. Released at the Abandonment, when male-line diversity rebounds (~4 kya).

**The 75% rule** — fertile female hybrids bred "up" toward the Igigi (≈75% Igigi) become the guarded **priestess caste**; bred "down" toward humans (≈25% Igigi) they seed nearly-invisible carriers detectable only by their *gifts* — the **Elves** of later memory and the **Albians**.
