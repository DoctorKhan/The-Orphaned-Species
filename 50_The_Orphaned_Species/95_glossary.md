...
**The maintenance protocol / the curriculum** — activation is **epigenetic**, held open by continuous practice and reset to dormant within a few generations without it. The locks = Tree-of-Life genes silenced; the **Fall** = a lineage losing the practice (not its genes); **reawakening** = recreating it. The lost practice itself: `33_the_curriculum.md`.
...
**Reception (the living web)** — Eli is connected to one **living web** and **clarifies** regions of it; what he clarifies, he learns. **Melaka opens the receiver; nodes hold the teachers** — breach = overload + hunted, not seven lives downloaded. Practitioners clarify at **nodes** under pressure; contact is **witness to other people**, not identity crisis (`36` §3). One dial of **depth**: near human threads resolve to full embodied scenes (he stands inside the life), while the faint, old cosmology resolves only as watched-depth shards. No reincarnation; clarity never transfers ownership. See `36_the_living_web.md`.

**Talking stones** — cross-cultural **folk memory** that certain stones and sacred grounds **hold speech, memory, judgment, or witness** — local names and stories (Britain: utterance/judgment stones; South/Southeast Asia: witness seats; Anatolia: oath pillars; Mesopotamia: foundation deposits). In canon these tales point at **real node behavior** in the living web without the grid's vocabulary. Introduce **locally**, from living characters; effects before etiology. See `36_the_living_web.md` §7a.

**The Seven** — **Aru, Daskar, Ila, Tem, Anthea, Cuno, and Lovernios**: distinct historical people who resolve as deep threads in the web at **nodes**. They are not one bloodline, Eli's ancestors, or Eli's past lives, and not a roster downloaded at Melaka. Eli's maternal line explains receptivity; practitioners are **met as other** on the pilgrimage. **Deprecated:** "sevenfold signature" on instruments — no harmonic count on the flare. See `36_the_living_web.md` §2.
