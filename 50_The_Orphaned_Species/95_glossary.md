...
**Göbekli snake/tree/bird plaquette** — real small-find to verify before publication (publicly described with photo credit Irmgard Wagner / DAI). Popular readings treat the symbols as snake, tree, and bird and fold them into Eden arguments. Canon use: a disputed domain diagram where tree/axis marks the living route, serpent marks the Apkallu guardian function, and bird marks the Nephilim guardian function. It explains a split in the old guardian order and becomes the interpretive key for later Tree-of-Life / sacred-tree imagery with guardians around the center: route at the center, guardian functions distributed around it, later compressed into Eden, royal, temple, or protective theology.

**Tree-of-Life guardian grammar** — recurring visual logic in later tablets, seals, reliefs, and amulets: a central tree, plant, pole, route, or life-interface is surrounded by guardian beings. In canon, the Göbekli plaquette teaches the group to ask which guardian functions are present: serpent/Apkallu foundation and under-route guardians; bird/Nephilim sky, high-place, and command guardians; household or protective figures; royal or priestly claimants. The key question is whether the tree is being protected, accessed, withheld, taxed, or weaponized.
...
**Home without ownership** — the trilogy's emotional motor: the longing for a place where body, grief, abnormal capacity, disability, love, privacy, work, and accountability can coexist without state, faction, family myth, prophecy, market, or archive defining the person first. Lost home is Bangladesh, kept emotionally alive but not simply recoverable because of political danger, legal risk, surveillance, surviving enemies, or irreparable loss; made home is Forest City, where Eli has ordinary work shifts and coworkers rather than guest status; mature home is the final coexistence community.
