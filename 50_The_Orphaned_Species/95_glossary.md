...
**The Continental Union** — armistice-era / post-collapse bloc governing the Americas under the People's Party of America (PPA): state-directed capital, digital ledger, party apparatus, carrier registry. Street: *the Union*, *Continental*. Eli has no papers here.
...
**The Free Ports Covenant** — third pole: reopened harbors, special economic zones, and remnant states outside the two giants (Strait ports, SE Asian gray zones, uneven European remnants). Forest City and Melaka live here. Street: *the Covenant*, *the Ports*. The name is aspirational; the ports are improvised, bribed, and watched.
...
**Aedan / the Boy** — the Bronze-Age cave-boy, not Eli's soul-name or former incarnation. An early deep-time receiver — **not a relay routing the cosmology to Eli** (Eli clarifies the deep web directly). *Ember* names him metaphorically; the granary stone **reads live** under him at the return — instrument + song payoff, not present-day palm-heating.
...
**Threshold houses** *(Free Ports Covenant)* — decentralized places for puberty-onset episodes: communal, porous spaces (often above markets or docks), not sterile hospitals. **Keeper knowledge** — grounding through rhythm, proximity, temperature, seasoned guides with second sight — passed harbor to harbor on trade routes; not a cure but safe passage while fever runs. Antifragile adaptation. See `23_2040_present_frame.md` § Threshold architecture.
