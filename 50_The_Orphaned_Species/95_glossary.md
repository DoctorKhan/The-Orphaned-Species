...
**Tiamat & Abzu** — the primordial source (Phase 0). Tiamat is organic creation itself; her murder by **Marduk** (of the Igigi) is the thesis statement — mechanical control killing organic development. Tiamat is "the dragon at the cave's mouth."
...
**The Continental Union** — post-war bloc governing the Americas under the People's Party of America (PPA): state-directed capital, digital ledger, party apparatus, carrier registry. Street: *the Union*, *Continental*. Eli has no papers here.
...
**Maren Rahman** *(birth name **Maren Holt**)* — Eli's English carrier-researcher mother; truly British, haplotype-negative. Married **Arif Rahman**; used **Rahman** in keeper work and regional memory ("the English woman"). Died ~10 years before present, in-region (SE Asia). **Do not use Das** — prior draft error. **Vol II (LOCKED):** suppression scene dramatizing **how she was taken** — courteous Ring machinery; not a Vol I prologue.
