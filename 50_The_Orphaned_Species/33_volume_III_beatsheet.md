...
> **RASEL'S INDEPENDENT STAKE — LOCKED 2026-07-26.** Rasel is neither a rescued
> prize nor Eli's automatic ally. He must publish and testify about the coupling
...
- **Cube/Mei residue seed — LOCKED 2026-07-30 (light touch only):** somewhere in this same conversation, Mei's old line resurfaces on its own — Eli, thinking about his mother in the middle of an unrelated grief, mentions to no one in particular that she used to have work in Singapore. One sentence, unremarked, not investigated. This is the only Book III residue for the Cherry Cube annex/idol connection before its full certification lands with the Forks/Bridge material in Ch 4 — a plant, not a payoff.
...
- **Talking stones:** the stones remain partly unresolved. They may answer through a mixture of field behavior, geology, old technology, local practice, and interpretation. Their value is relational: they teach listening. They do not select Eli as ruler.
