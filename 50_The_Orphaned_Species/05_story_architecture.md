...
**Pelangi development lock:** A hereditary king is building the smaller artificial island into a climate/technology and fintech hub to rival Meridian City. The project brings AI, biotech, desalination, flood control, finance, and high-end infrastructure — **humanoid robotics mostly aspirational** — while accelerating land loss, platform labor, ritual commodification, and generational change on the larger island. Pelangi is a negotiated, incomplete synthesis: culture-first in aspiration, increasingly reshaped by technology in practice.
