...
- **Lost home:** Bangladesh, family, father, mother, language, food, danger, exile, political tension, and the unfinished life Eli was forced to leave. **Rasel** taken at extraction into **Mandate lab custody** (Eli **believes him dead**) — not on a scene young Eli can reliably narrate — so Bangladesh stays **living culture and unreturnable danger**, not only a grave. It should remain emotionally alive but not simply recoverable; return may be unsafe, legally impossible, politically dangerous, or personally unbearable.
...
**Midpoint revelation:** Eli's mother is alive, held somewhere in the western web of charged grounds and wired into one as its operator. There is no usable address. **Maren suppression scene** (how she was taken — Charkha machinery, SE Asia keeper/extraction context) lands here or immediately before; see `99`.
