...
| **The Orphaned Species: The Living World** | **Volume III — Choice** | **Book III — Civilization, species, and coexistence** |
...
| **III — The Living World** | Community construction, federation conflict, Union break, counter-revolution, bounded rule, incomplete handover under war pressure | Liberator → wartime strongman | **Pelangi Reach → Washington, D.C. → Hawaiʻi Island refuge + constituent assembly** | Coexistence survives attack but the compact fractures; Eli holds emergency power; reconstruction passes to Book IV; Rowan/Eli charge remains deniable |
...
**Answerability proved, then tested again — REVISED 2026-08-07:** Eli opens the public inquiry and attempts transfer after the crisis. He does not control the hearing. But the decentralized compact **fractures under war pressure**: Continuity keys, factional mandate, private force, and the temptation to turn emergency command into permanent authority fracture the interregional layer. The volume ends with Eli holding emergency power and the institutions too damaged to receive a clean handover. The first relinquishment is **incomplete** — not because Eli refuses it, but because the compact it required no longer exists intact. Book IV tests whether that broken compact can be rebuilt under scarcity rather than simply restored after war.
