...
- **Made home:** Forest City, ordinary work shifts, training mornings, sailing, meals, privacy norms, neighbors, and the fragile refuge that lets anomalous people remain accountable without becoming public property. Eli's worker role is **teaching beginner sailing/seamanship classes to tourists and keeping the boats** (competent, not master-level — the open-ocean legs still need real sailors). The harbor is also where the opening clue reaches him (the witness; see `99_open_questions.md` #1), so leaving costs him students, crew, and the boats, not only safety.
