...
**Messianic rise — Eli must read as messiah by Book III (LOCKED 2026-07-23).** The two-crowns lock governs **what** each man refuses, not whether the public crowns them. By Volume III Eli **rises in messiah-shape**: Deiwos chalk, healings, war coordination, Crane's throne offer, pilgrim/media projection, *Son of Man* rumor forming against his attempts to stay ordinary, teahouse visitors treating him as sainthood's threshold. The drama is **myth forming against its subject's will** — then **bounded crown and step-down**, not absence of messianic gravity. Full escalation table: `29` § *Messianic rise*; Book III lock: `33`.
...
**Romance (plural V — Rowan on-page in Book II, locked 2026-07-22):** Wren's formative prior love Rowan returns through the west-corridor Weaver network and renews romantically with Wren. Eli/Wren also develops; Rowan/Eli is non-romantic. The architecture refuses a jealousy contest and gives Rowan an independent recovery/network objective. Each bond has separate consent and exit rights; formative durability is gravity, not entitlement. Architecture: `19_romance_and_divine_pairing.md` § Rowan returns; flesh: `26` § Rowan.
...
| **III — The Living World** | Community construction, federation conflict, Union break, counter-revolution, survival without permanent command | Liberator → strongman-by-proximity (real window) → relinquishes → distributed member | **Pelangi Reach → Washington, D.C. → Hawaiʻi Island refuge + federation network** | Coexistence survives; Union outcome is Founders-shaped decentralization (recoverable parts); Hawaiʻi remains temporary refuge, not new capital |
...
3. **Book III — civilization:** freedom produces a real victim. A newly awakened refugee admitted under Eli's sponsorship commits a serious nonconsensual mind-entry, and an ordinary person dies as a direct consequence. The victim is not restored, secretly culpable, or converted into proof that Crane engineered everything. Their survivor remains entitled to anger. Crane's diagnosis—that unregulated psionic capacity can destroy civilians—is thereby proven true even though his permanent registry remains the wrong conclusion. The wider war then reveals civilization's concealed operating logic: it calls populations family while processing bodies, labor, loyalty, and attention into continuity and exporting injury, displacement, disability, grief, and death as acceptable loss. **A family remembers whom it has lost; an engine records what the loss purchased.** Civilization produces real goods, so the answer is not romantic abolition of coordination; the answer is to make institutions carry their own costs through limits, exits, distributed authority, reciprocal obligation, named losses, remedy, and review.
...
- **American sequence — LOCKED; Path A 2026-07-26:** **Hawaiʻi refuge → San Francisco, the new Continental capital → the ruins of Washington, D.C. → San Francisco's fall / Union break → strongman-by-proximity window → relinquish → Hawaiʻi refuge → Hopi visit by invitation → Colorado mountain coda.** The west-to-east passage keeps the American movement expansive. Hawaiʻi establishes relation and obligation without being changed by Eli; San Francisco supplies living civic memory and concentrated power; ruined D.C. exposes the dead capital's broken promise; the fall **breaks the Union** and shows why a single indispensable center fails. Eli does **not** reclaim the capital as throne; power **pours into him by proximity**; he holds real coordinating authority, then relinquishes. Outcome: **what survives collapses** = Founders-shaped decentralization (recoverable parts), not restored throne-capital.
...
**Midpoint revelation:** Eli's mother's body is dead, but something of her is tethered somewhere in the western web of charged grounds. There is no usable address. **Maren suppression scene** (how she was taken — Charkha machinery, SE Asia keeper/extraction context) lands here or immediately before; see `99`.
...
**Two-Tree union act:** Under psionic attack at the stones, Eli **powers up once** by joining **life technology** (native anti-entropic connection, release, collective geometry) with **death technology** (ordinary entropic-plane tech: instruments, chair/key, mother's encoded equations, testable geometry). The reader should feel both trees at once; the **move is release and spreading fire**, not seizing the grid. The label *death technology* pays off the Adapa bread/water of "death" misnaming. Temporary, costly, collective. See `22_life_technology_and_two_trees_spine.md` § Climax.
