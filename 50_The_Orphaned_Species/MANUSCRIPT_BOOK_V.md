# The Orphaned Species Book V: The Court of Threads

> **RENUMBERED 2026-07-29 — formerly Book IV.** See `SERIES_STRUCTURE.md` at the repo root for the full old→new volume map. Content unchanged; only the volume number moved.
