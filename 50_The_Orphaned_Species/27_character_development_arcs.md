...
| **Hạnh** | Cooperative records and land vs factions | Protects mixed Mekong community; proves familiar causes fail; survives Eli's choice |
| **Sol Mendez** | Burned freedom → Eli's anti-mirror | Temptation scene; Eli refuses messiah |
| **Priya Nair** | Facilities authority → worker-status liaison | Uses records to protect workers; allows counter-record when visibility becomes capture |
| **Mei Lin** | Kitchen authority → durable community hearth | Breaks a rule to move Eli; later proves made home survived without becoming an institution |
