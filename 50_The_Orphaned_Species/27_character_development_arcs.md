...
|---|---|---|---|
| **I · Shattering** | Can Eli remain himself long enough to decide whom to trust? | **Remain yourself** | **Personal:** feel charge, recognize autopilot, don't complete the act |
| **II · Descent** | Can the group hold truth under ownership pressure? | **Remain yourself in relationship** | **Relational/collective:** hold fear, loyalty, pain without possession or betrayal |
| **III · Choice** | Can freedom be transmitted without a new cage? | **Give without owning** | **Civilizational:** coexistence survives; fire spreads; mother released |

Romance runs the **same thesis** as cosmology: *clinging = cage; release = adulthood* — mother, Wren, trapped souls, grid.
...
|---|---|---|
| "If I'm useful enough, I won't be abandoned" | Dinner rush break; choosing people over evidence | Vol I climax: **Manual Override** + protect community |
| "The intense feeling must mean destiny" | Sol Mendez; surge on mother's tune | Refuses throne; refuses prophecy role |
| "Finding mother = finding home" | Mother-reveal: tethered, reunion prolongs chain | **Releases her** at Albion — reunion is goodbye |
| "I must become the weapon to save everyone" | Custodians mirror; Crane offer | Two-Tree union **once** — release, not seizure |
...
**Vol III**
- Midpoint temptation: seize amplifier to save mother.
- Climax: release mother; union act; refuse Crane's annihilation.
- Coda: sailboat crew member, not commander; ordinary afternoon.
...
|---|---|---|---|
| **I** | Recognition refused → forced alliance | "Intimacy is trap or tool" | Melaka: folds Eli in at cost to network; stairwell |
...
## Professor Emrys — anti-father → surpassed map

### Arc sentence

> From **map-as-territory** to **territory that no longer needs the map** — fulfilled or lost, not replaced.
...
## Dr. Somchai Vichai (healer) — service vs conscription
...
| **II** | Returns; deeper gift | Eli's cosmic trail swallows ordinary wounded | Still treats non-legend patients |
...
Crane does not arc into ally. Reader understands **why**; Eli still refuses throne and annihilation.
...
## Three Circles — character development lens
...
| Vol I climax | Manual Override in body | Thila's community | Factions denied evidence |
...
- **Vol III:** hold lightly, let two be one, give without score → release at scale.
...
| Romance deferred to epilogue only | Union **earned** mid-III, tested before coda |
...
5. **Romance/fellowship** — trust up or down, proved how?
6. **Past-vs-mask leak** scheduled? (`26` Part V — one habit/object, no exposition)
7. **Trauma pattern** active under stress? (`26` Part VI — behavior, not diagnosis lecture)
...
- Romance curriculum: `19_romance_and_divine_pairing.md`
