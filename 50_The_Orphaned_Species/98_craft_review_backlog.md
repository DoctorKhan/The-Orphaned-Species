...
**Evidence.** `27_character_development_arcs.md` belief→behavior table (every row resolves in a refusal); scene seed "refuses prophecy language once per volume" (`26`); the Vol III double-temptation (`33` Ch 27).
