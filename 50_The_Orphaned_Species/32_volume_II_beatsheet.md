...
> **SUPERSEDED AS A FULL SPINE — 2026-07-12.** Göbekli and Emrys's capture move to the **Book I climax**. Book II now runs from Anatolia through Europe to Stonehenge / Men-an-Tol / Albion and ends with **Maren's release and the spreading awakening**. Hassan's Gulf rescue and Maren-complicity reveal must be reassigned to late Book I or early Book II during reconstruction. Scenes below remain quarry, not current order.
...
### Ch 15 — Bodies and Crossings *(Somchai opening → hard break → Eli · corridor → Gulf approach)*
...
### Ch 17 — What They Took *(Eli · Gulf corridor holding site + recovered record)*
...
- **Revelation — name beat:** **Alba** = the people; **Albion** = refuge; **elf** = folklore compression of hunted **Nephilot/carrier** line — one earned line from place-names, Emrys, or scholar (`37` § *Tracking*). **Albion** becomes likely endpoint when **independent evidence agrees late**.
- **Resolution (VOLUME END):** **relational Manual Override** — charged fear, loyalty, pain, and psychic pressure held **without** possession, worship, obedience, or betrayal. Partial Derw + living network → Vol III coexistence test.
- **Romance cost (LOCK — union at debt):** **Present-tense commitment** — explicit **choice**, not ambush adrenaline only (`00` stage 4). Must cost something **unpaid**: e.g. Wren burns a last clean exit, or Eli promises a limit he fears. **No** destiny language. Creates **wound/obligation** for Vol III (`19` Vol II end state). Physical escalation: **chosen touch with room to refuse** — not reward sex.
