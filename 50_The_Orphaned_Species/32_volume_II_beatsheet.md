...
> **Reveal discipline:** same as Vol I — effects before terminology; historical names only when evidence forces distinction. **Patriarchy chord:** domestic faces only (grain pit, registry, pew-side drain) — never the thesis in dialogue.
...
### Ch 16 — The Old Wound *(ensemble · Persian Gulf / Mesopotamia · Eridu-flats)*
...
### Ch 17 — What They Took *(Eli · mother-reveal region — SE Asia keeper context or reachable record)*
- **Want:** find his mother.
- **Attachment:** Maren as **person**, not plot device — song, harbor chain, research (`26` Maren layer).
- **Obstacle:** courteous **Ring suppression machinery** — clipboards, van, neighbor's light out (`99` #Maren-suppression). Eli finally learns **how she was taken**, not just that she vanished.
- **Choice → Cost:** he receives the record without turning it into destiny fuel. Cost: grief with no rescue fantasy left.
- **Revelation (MIDPOINT):** mother's **body is dead**; something of her is **tethered** in the western web of charged grounds — **no usable address**. Search becomes **release**, not rescue. **Forward clue:** only **living observation** (growth, polarity, song) can triangulate west — old maps fail.
...
### Ch 18 — Göbekli and Loss *(ensemble · Anatolian ground · contested site)*
...
### Ch 19 — The Healer's Kneel *(healer-weighted · Anatolia / medical corridor)*
...
- **SOL — first on-page pass (establishing, so his Vol III Ch 27 temptation isn't cold):** drawn by the healing rumors, **Sol Mendez** makes a soft first approach to Eli — **not** the armed-prophet argument yet (no body count to point at) but **recognition and fellowship**: the man who begged for help and got a pamphlet, offering the understanding no one gave him. **Deliberate mirror to the healer this same chapter** — one refuses the crown deification offers, the other was consumed by it. Eli deflects but can't unsee that Sol is a version of himself; the loneliness lands. Drafted "Establishing" scene in `49_machiavelli_toolkit.md`; keep charisma horrifying, not comic (`26`).
...
### Ch 20 — The Changing Map *(ensemble · continental Europe)*
- **Want:** cross Europe without becoming anyone's registered asset.
...
### Ch 21 — The Riddling Node *(Eli / ensemble · Rollright / Men-an-Tol corridor)*
...
### Ch 22 — The Chair and the Tether *(ensemble · Stonehenge approach · Albion threshold)*
