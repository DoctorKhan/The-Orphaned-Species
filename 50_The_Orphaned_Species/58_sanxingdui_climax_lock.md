...
This is not yet the full plane hierarchy, panspermia account, dragon taxonomy, immortality answer, or Two-Tree union.

## Rasel at Sanxingdui

Rasel Khan is alive in Eastern Mandate research custody. He has been compelled to work on:
...
- He chooses the distributed living route.
...
Book I does not end on the instant Eli recognizes Rasel.

The closing movement must include:

- a physically awkward father-son reunion;
- evidence of what captivity changed in Rasel;
